...
var X = b((hf, Gr) => {
  ...
  Gr.exports = Et(typeof globalThis == "object" && globalThis) || Et(typeof window == "object" && window) || Et(typeof self == "object" && self) || Et(typeof global == "object" && global) || function() {
    return this;
...
var Ct = b((pf, $r) => {
  var Xh = bt(), vt = Function.prototype.call;
  $r.exports = Xh ? vt.bind(vt) : function() {
    return vt.apply(vt, arguments);
  };
});
var ti = b((ei) => {
  "use strict";
  var Qr = {}.propertyIsEnumerable, Zr = Object.getOwnPropertyDescriptor, Jh = Zr && !Qr.call({ 1: 2 }, 1);
  ei.f = Jh ? function(l) {
    var p = Zr(this, l);
...
var le = b((mf, ai) => {
  var ri = bt(), ii = Function.prototype, Yh = ii.bind, ms = ii.call, $h = ri && Yh.bind(ms, ms);
...
var St = b((yf, oi) => {
  var ni = le(), Qh = ni({}.toString), Zh = ni("".slice);
  oi.exports = function(h) {
    return Zh(Qh(h), 8, -1);
  };
});
var li = b((xf, hi) => {
  var el = X(), tl = le(), sl = Ee(), rl = St(), ys = el.Object, il = tl("".split);
...
var xs = b((gf, ui) => {
  var al = X(), nl = al.TypeError;
  ui.exports = function(h) {
    if (h == null)
      throw nl("Can't call method on " + h);
    return h;
  };
});
var wt = b((Af, ci) => {
...
var Ci = b((Cf, vi) => {
  var bi = X(), As = gi(), Ai = bi.process, Pi = bi.Deno, Ti = Ai && Ai.versions || Pi && Pi.version, Ei = Ti && Ti.v8, fe, Nt;
  Ei && (fe = Ei.split("."), Nt = fe[0] > 0 && fe[0] < 4 ? 1 : +(fe[0] + fe[1]));
  !Nt && As && (fe = As.match(/Edge\/(\d+)/), (!fe || fe[1] >= 74) && (fe = As.match(/Chrome\/(\d+)/), fe && (Nt = +fe[1])));
  vi.exports = Nt;
});
var Ps = b((Sf, wi) => {
  var Si = Ci(), dl = Ee();
  wi.exports = !!Object.getOwnPropertySymbols && !dl(function() {
    var h = Symbol();
...
var Es = b((Nf, Ii) => {
  var yl = X(), xl = tt(), gl = ue(), Al = yi(), Pl = Ts(), Tl = yl.Object;
  Ii.exports = Pl ? function(h) {
...
var It = b((kf, Fi) => {
  var vl = X(), Cl = ue(), Sl = Di(), wl = vl.TypeError;
  Fi.exports = function(h) {
    if (Cl(h))
      return h;
...
var Mi = b((Ff, Bi) => {
  var Il = X(), bs = Ct(), vs = ue(), Cs = Me(), kl = Il.TypeError;
  Bi.exports = function(h, l) {
    var p, d;
    if (l === "string" && vs(p = h.toString) && !Cs(d = bs(p, h)) || vs(p = h.valueOf) && !Cs(d = bs(p, h)) || l !== "string" && vs(p = h.toString) && !Cs(d = bs(p, h)))
      return d;
...
var kt = b((Of, Ui) => {
  var qi = X(), Dl = Object.defineProperty;
  Ui.exports = function(h, l) {
    try {
      Dl(qi, h, { value: l, configurable: true, writable: true });
    } catch {
      qi[h] = l;
    }
    return l;
...
var Dt = b((Bf, zi) => {
  var Fl = X(), Ll = kt(), _i = "__core-js_shared__", Ol = Fl[_i] || Ll(_i, {});
  zi.exports = Ol;
});
var Ss = b((Mf, Vi) => {
  var Bl = ji(), Ki = Dt();
  ...
  })("versions", []).push({ version: "3.21.1", mode: Bl ? "pure" : "global", copyright: "\xA9 2014-2022 Denis Pushkarev (zloirock.ru)", license: "https://github.com/zloirock/core-js/blob/v3.21.1/LICENSE", source: "https://github.com/zloirock/core-js" });
});
var ws = b((Rf, Hi) => {
  var Ml = X(), Rl = xs(), jl = Ml.Object;
  Hi.exports = function(h) {
    return jl(Rl(h));
  };
});
var Ne = b((jf, Wi) => {
  var ql = le(), Ul = ws(), _l = ql({}.hasOwnProperty);
  Wi.exports = Object.hasOwn || function(l, p) {
    return _l(Ul(l), p);
  };
});
var Ns = b((qf, Gi) => {
  var zl = le(), Kl = 0, Vl = Math.random(), Hl = zl(1 .toString);
  Gi.exports = function(h) {
    return "Symbol(" + (h === void 0 ? "" : h) + ")_" + Hl(++Kl + Vl, 36);
  };
});
var st = b((Uf, Qi) => {
  var Wl = X(), Gl = Ss(), Xi = Ne(), Xl = Ns(), Ji = Ps(), $i = Ts(), We = Gl("wks"), Re = Wl.Symbol, Yi = Re && Re.for, Jl = $i ? Re : Re && Re.withoutSetter || Xl;
...
var sa = b((_f, ta) => {
  var Yl = X(), $l = Ct(), Zi = Me(), ea = Es(), Ql = Oi(), Zl = Mi(), eu = st(), tu = Yl.TypeError, su = eu("toPrimitive");
  ta.exports = function(h, l) {
    if (!Zi(h) || ea(h))
      return h;
    var p = Ql(h, su), d;
    if (p) {
      if (l === void 0 && (l = "default"), d = $l(p, h, l), !Zi(d) || ea(d))
        return d;
...
var na = b((Kf, aa) => {
  var au = X(), ia = Me(), ks = au.document, nu = ia(ks) && ia(ks.createElement);
  aa.exports = function(h) {
    return nu ? ks.createElement(h) : {};
  };
});
var Ds = b((Vf, oa) => {
  var ou = Be(), hu = Ee(), lu = na();
  oa.exports = !ou && !hu(function() {
    return Object.defineProperty(lu("div"), "a", { get: function() {
      return 7;
    } }).a != 7;
  });
});
var Fs = b((la) => {
  var uu = Be(), cu = Ct(), pu = ti(), fu = ds(), du = wt(), mu = Is(), yu = Ne(), xu = Ds(), ha = Object.getOwnPropertyDescriptor;
  la.f = uu ? ha : function(l, p) {
    if (l = du(l), p = mu(p), xu)
      try {
        return ha(l, p);
      } catch {
    ...
    if (yu(l, p))
      return fu(!cu(pu.f, l, p), l[p]);
  };
});
var ca = b((Wf, ua) => {
  var gu = Be(), Au = Ee();
  ua.exports = gu && Au(function() {
    return Object.defineProperty(function() {
    }, "prototype", { value: 42, writable: false }).prototype != 42;
  });
});
var Ls = b((Gf, fa) => {
  var pa = X(), Pu = Me(), Tu = pa.String, Eu = pa.TypeError;
...
var js = b((ma) => {
  var bu = X(), vu = Be(), Cu = Ds(), Su = ca(), Ft = Ls(), da = Is(), wu = bu.TypeError, Os = Object.defineProperty, Nu = Object.getOwnPropertyDescriptor, Bs = "enumerable", Ms = "configurable", Rs = "writable";
  ma.f = vu ? Su ? function(l, p, d) {
    if (Ft(l), p = da(p), Ft(d), typeof l == "function" && p === "prototype" && "value" in d && Rs in d && !d[Rs]) {
      var m = Nu(l, p);
      m && m[Rs] && (l[p] = d.value, d = { configurable: Ms in d ? d[Ms] : m[Ms], enumerable: Bs in d ? d[Bs] : m[Bs], writable: false });
    }
    return Os(l, p, d);
  } : Os : function(l, p, d) {
    ...
    if ("get" in d || "set" in d)
      throw wu("Accessors not supported");
    return "value" in d && (l[p] = d.value), l;
  };
});
var Lt = b((Jf, ya) => {
  var Iu = Be(), ku = js(), Du = ds();
  ya.exports = Iu ? function(h, l, p) {
...
var Ot = b((Yf, xa) => {
  var Fu = le(), Lu = ue(), qs = Dt(), Ou = Fu(Function.toString);
  Lu(qs.inspectSource) || (qs.inspectSource = function(h) {
    return Ou(h);
  });
  xa.exports = qs.inspectSource;
});
var Pa = b(($f, Aa) => {
  var Bu = X(), Mu = ue(), Ru = Ot(), ga = Bu.WeakMap;
  Aa.exports = Mu(ga) && /native code/.test(Ru(ga));
});
var ba = b((Qf, Ea) => {
  var ju = Ss(), qu = Ns(), Ta = ju("keys");
...
var ka = b((ed, Ia) => {
  var Uu = Pa(), Na = X(), _s = le(), _u = Me(), zu = Lt(), zs = Ne(), Ks = Dt(), Ku = ba(), Vu = Us(), Ca = "Object already initialized", Hs = Na.TypeError, Hu = Na.WeakMap, Bt, rt, Mt, Wu = function(h) {
    return Mt(h) ? rt(h) : Bt(h, {});
  }, Gu = function(h) {
    return function(l) {
      var p;
      if (!_u(l) || (p = rt(l)).type !== h)
        throw Hs("Incompatible receiver, " + h + " required");
      return p;
    };
  };
  Uu || Ks.state ? (Ie = Ks.state || (Ks.state = new Hu()), Sa = _s(Ie.get), Vs = _s(Ie.has), wa = _s(Ie.set), Bt = function(h, l) {
    if (Vs(Ie, h))
      throw new Hs(Ca);
    ...
    return Vs(Ie, h);
  }) : (je = Ku("state"), Vu[je] = true, Bt = function(h, l) {
    if (zs(h, je))
      throw new Hs(Ca);
...
var La = b((td, Fa) => {
  var Ws = Be(), Xu = Ne(), Da = Function.prototype, Ju = Ws && Object.getOwnPropertyDescriptor, Gs = Xu(Da, "name"), Yu = Gs && function() {
  }.name === "something", $u = Gs && (!Ws || Ws && Ju(Da, "name").configurable);
  Fa.exports = { EXISTS: Gs, PROPER: Yu, CONFIGURABLE: $u };
});
var ja = b((sd, Ra) => {
  var Qu = X(), Oa = ue(), Zu = Ne(), Ba = Lt(), ec = kt(), tc = Ot(), Ma = ka(), sc = La().CONFIGURABLE, rc = Ma.get, ic = Ma.enforce, ac = String(String).split("String");
  (Ra.exports = function(h, l, p, d) {
    var m = d ? !!d.unsafe : false, x = d ? !!d.enumerable : false, P = d ? !!d.noTargetGet : false, T = d && d.name !== void 0 ? d.name : l, E;
    if (Oa(p) && (String(T).slice(0, 7) === "Symbol(" && (T = "[" + String(T).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"), (!Zu(p, "name") || sc && p.name !== T) && Ba(p, "name", T), E = ic(p), E.source || (E.source = ac.join(typeof T == "string" ? T : ""))), h === Qu) {
      x ? h[l] = p : ec(l, p);
      return;
    } else
      m ? !P && h[l] && (x = true) : delete h[l];
    x ? h[l] = p : Ba(h, l, p);
...
var Xs = b((rd, qa) => {
  var nc = Math.ceil, oc = Math.floor;
...
var _a = b((id, Ua) => {
  var hc = Xs(), lc = Math.max, uc = Math.min;
...
var Ga = b((od, Wa) => {
  var dc = wt(), mc = _a(), yc = Rt(), Ha = function(h) {
    return function(l, p, d) {
      var m = dc(l), x = yc(m), P = mc(d, x), T;
      if (h && p != p) {
        for (; x > P; )
          if (T = m[P++], T != T)
            return true;
...
var Ya = b((hd, Ja) => {
  var xc = le(), Js = Ne(), gc = wt(), Ac = Ga().indexOf, Pc = Us(), Xa = xc([].push);
  Ja.exports = function(h, l) {
    var p = gc(h), d = 0, m = [], x;
    for (x in p)
      !Js(Pc, x) && Js(p, x) && Xa(m, x);
    for (; l.length > d; )
      Js(p, x = l[d++]) && (~Ac(m, x) || Xa(m, x));
    return m;
  };
});
var Qa = b((ld, $a) => {
...
var en = b((Za) => {
  var Tc = Ya(), Ec = Qa(), bc = Ec.concat("length", "prototype");
  Za.f = Object.getOwnPropertyNames || function(l) {
    return Tc(l, bc);
  };
});
var sn = b((tn) => {
...
var an = b((pd, rn) => {
  var vc = tt(), Cc = le(), Sc = en(), wc = sn(), Nc = Ls(), Ic = Cc([].concat);
  rn.exports = vc("Reflect", "ownKeys") || function(l) {
    var p = Sc.f(Nc(l)), d = wc.f;
    return d ? Ic(p, d(l)) : p;
  };
});
var hn = b((fd, on) => {
  var nn = Ne(), kc = an(), Dc = Fs(), Fc = js();
...
var un = b((dd, ln) => {
  var Lc = Ee(), Oc = ue(), Bc = /#|\.prototype\./, it = function(h, l) {
    var p = Rc[Mc(h)];
    return p == qc ? true : p == jc ? false : Oc(l) ? Lc(l) : !!l;
  }, Mc = it.normalize = function(h) {
    return String(h).replace(Bc, ".").toLowerCase();
  }, Rc = it.data = {}, jc = it.NATIVE = "N", qc = it.POLYFILL = "P";
  ln.exports = it;
});
var $s = b((md, cn) => {
  var Ys = X(), Uc = Fs().f, _c = Lt(), zc = ja(), Kc = kt(), Vc = hn(), Hc = un();
  cn.exports = function(h, l) {
    var p = h.target, d = h.global, m = h.stat, x, P, T, E, k, F;
    if (d ? P = Ys : m ? P = Ys[p] || Kc(p, {}) : P = (Ys[p] || {}).prototype, P)
      for (T in l) {
        if (k = l[T], h.noTargetGet ? (F = Uc(P, T), E = F && F.value) : E = P[T], x = Hc(d ? T : p + (m ? "." : "#") + T, h.forced), !x && E !== void 0) {
          if (typeof k == typeof E)
            continue;
          Vc(k, E);
        }
        (h.sham || E && E.sham) && _c(k, "sham", true), zc(P, T, k, h);
      }
  };
});
var pn = b(() => {
  var Wc = $s(), Gc = X();
  Wc({ global: true }, { globalThis: Gc });
});
var Qs = b((gd, fn) => {
  var Xc = St();
  fn.exports = Array.isArray || function(l) {
    return Xc(l) == "Array";
  };
});
var yn = b((Ad, mn) => {
  var dn = le(), Jc = It(), Yc = bt(), $c = dn(dn.bind);
  mn.exports = function(h, l) {
    return Jc(h), l === void 0 ? h : Yc ? $c(h, l) : function() {
...
var An = b((Pd, gn) => {
  "use strict";
  var Qc = X(), Zc = Qs(), ep = Rt(), tp = yn(), sp = Qc.TypeError, xn = function(h, l, p, d, m, x, P, T) {
    for (var E = m, k = 0, F = P ? tp(P, T) : false, v, O; k < d; ) {
      if (k in p) {
...
var En = b((Td, Tn) => {
  var rp = st(), ip = rp("toStringTag"), Pn = {};
  Pn[ip] = "z";
  Tn.exports = String(Pn) === "[object z]";
});
var vn = b((Ed, bn) => {
  var ap = X(), np = En(), op = ue(), jt = St(), hp = st(), lp = hp("toStringTag"), up = ap.Object, cp = jt(function() {
    return arguments;
  }()) == "Arguments", pp = function(h, l) {
    try {
      return h[l];
    } catch {
    }
  };
  bn.exports = np ? jt : function(h) {
    var l, p, d;
    return h === void 0 ? "Undefined" : h === null ? "Null" : typeof (p = pp(l = up(h), lp)) == "string" ? p : cp ? jt(l) : (d = jt(l)) == "Object" && op(l.callee) ? "Arguments" : d;
  };
});
var kn = b((bd, In) => {
  var fp = le(), dp = Ee(), Cn = ue(), mp = vn(), yp = tt(), xp = Ot(), Sn = function() {
  }, gp = [], wn = yp("Reflect", "construct"), Zs = /^\s*(?:class|function)\b/, Ap = fp(Zs.exec), Pp = !Zs.exec(Sn), at = function(l) {
    if (!Cn(l))
      return false;
    try {
      return wn(Sn, gp, l), true;
    } catch {
      return false;
    }
  }, Nn = function(l) {
...
var On = b((vd, Ln) => {
  var Tp = X(), Dn = Qs(), Ep = kn(), bp = Me(), vp = st(), Cp = vp("species"), Fn = Tp.Array;
  Ln.exports = function(h) {
    var l;
    return Dn(h) && (l = h.constructor, Ep(l) && (l === Fn || Dn(l.prototype)) ? l = void 0 : bp(l) && (l = l[Cp], l === null && (l = void 0))), l === void 0 ? Fn : l;
  };
});
var Mn = b((Cd, Bn) => {
  var Sp = On();
...
var Dp = Rt();
var Fp = Mn();
wp({ target: "Array", proto: true }, { flatMap: function(l) {
  var p = kp(this), d = Dp(p), m;
  return Ip(l), m = Fp(p, 0), m.length = Np(m, p, p, d, 0, 1, l, arguments.length > 1 ? arguments[1] : void 0), m;
} });
var Rn;
var jn;
var qn;
...
var Bp = (h, l) => {
  for (var p in l)
    rr(h, p, { get: l[p], enumerable: true });
};
var Mp = (h, l, p, d) => {
...
var Rp = (h) => Mp(rr({}, "__esModule", { value: true }), h);
var V = zn({ "<define:process>"() {
} });
var jp = H({ "src/utils/try-combinations.js"(h, l) {
  "use strict";
  V();
  function p() {
    let d;
    for (var m = arguments.length, x = new Array(m), P = 0; P < m; P++)
      x[P] = arguments[P];
...
var Kn = H({ "src/language-js/utils/get-shebang.js"(h, l) {
  "use strict";
  V();
  function p(d) {
    if (!d.startsWith("#!"))
...
var qp = H({ "src/utils/text/skip-inline-comment.js"(h, l) {
  "use strict";
  V();
  function p(d, m) {
    if (m === false)
...
var Up = H({ "src/utils/text/skip-newline.js"(h, l) {
  "use strict";
  V();
  function p(d, m, x) {
    let P = x && x.backwards;
...
var Vn = H({ "src/utils/text/skip.js"(h, l) {
  "use strict";
  V();
  function p(T) {
    return (E, k, F) => {
...
var zp = H({ "src/utils/text/get-next-non-space-non-comment-character-index-with-start-index.js"(h, l) {
  "use strict";
  V();
  var p = qp(), d = Up(), m = _p(), { skipSpaces: x } = Vn();
  function P(T, E) {
    let k = null, F = E;
    for (; F !== k; )
      k = F, F = x(T, F), F = p(T, F), F = m(T, F), F = d(T, F);
    return F;
  }
  l.exports = P;
} });
var Hn = {};
Bp(Hn, { EOL: () => sr, arch: () => Kp, cpus: () => Qn, default: () => ro, endianness: () => Wn, freemem: () => Yn, getNetworkInterfaces: () => so, hostname: () => Gn, loadavg: () => Xn, networkInterfaces: () => to, platform: () => Vp, release: () => eo, tmpDir: () => er, tmpdir: () => tr, totalmem: () => $n, type: () => Zn, uptime: () => Jn });
function Wn() {
  if (typeof qt > "u") {
...
var sr;
var ro;
var Hp = zn({ "node-modules-polyfills:os"() {
  V(), tr = er, sr = `
...
var Wp = H({ "node-modules-polyfills-commonjs:os"(h, l) {
  V();
  var p = (Hp(), Rp(Hn));
  if (p && p.default) {
    l.exports = p.default;
...
var Gp = H({ "node_modules/detect-newline/index.js"(h, l) {
  "use strict";
  V();
  var p = (d) => {
    if (typeof d != "string")
...
var Xp = H({ "node_modules/jest-docblock/build/index.js"(h) {
  "use strict";
  V(), Object.defineProperty(h, "__esModule", { value: true }), h.extract = A, h.parse = re, h.parseWithComments = B, h.print = R, h.strip = _;
  function l() {
    let u = Wp();
    return l = function() {
      return u;
  ...
  function B(u) {
    ...
    let ie = "";
    for (; ie !== u; )
      ie = u, u = u.replace(k, "".concat(J, "$1 $2").concat(J));
    u = u.replace(E, "").trimRight();
    let $ = /* @__PURE__ */ Object.create(null), be = u.replace(F, "").replace(E, "").trimRight(), Q;
    for (; Q = F.exec(u); ) {
      let q = Q[2].replace(T, "");
      typeof $[Q[1]] == "string" || Array.isArray($[Q[1]]) ? $[Q[1]] = O.concat($[Q[1]], q) : $[Q[1]] = q;
    }
    return { comments: be, pragmas: $ };
  }
  function R(u) {
    let { comments: J = "", pragmas: ie = {} } = u, $ = (0, p().default)(J) || l().EOL, be = "/**", Q = " *", q = " */", S = Object.keys(ie), g = S.map((G) => W(G, ie[G])).reduce((G, Y) => G.concat(Y), []).map((G) => Q + " " + G + $).join("");
    if (!J) {
      if (S.length === 0)
        return "";
    ...
    let ne = J.split($).map((G) => "".concat(Q, " ").concat(G)).join($) + $;
...
var Jp = H({ "src/common/end-of-line.js"(h, l) {
  "use strict";
  V();
  function p(P) {
    let T = P.indexOf("\r");
    return T >= 0 ? P.charAt(T + 1) === `
` ? "crlf" : "cr" : "lf";
  }
  function d(P) {
    switch (P) {
...
`);
  ...
  l.exports = { guessEndOfLine: p, convertEndOfLineToChars: d, countEndOfLineChars: m, normalizeEndOfLine: x };
} });
var Yp = H({ "src/language-js/pragma.js"(h, l) {
  "use strict";
  V();
  var { parseWithComments: p, strip: d, extract: m, print: x } = Xp(), { normalizeEndOfLine: P } = Jp(), T = Kn();
  function E(v) {
    let O = T(v);
    O && (v = v.slice(O.length + 1));
    let A = m(v), { pragmas: _, comments: re } = p(A);
  ...
  function F(v) {
    let { shebang: O, text: A, pragmas: _, comments: re } = E(v), B = d(A), R = x({ pragmas: Object.assign({ format: "" }, _), comments: re.trimStart() });
    return (O ? "".concat(O, `
`) : "") + P(R) + (B.startsWith(`
`) ? `
` : `
...
var io = H({ "src/utils/is-non-empty-array.js"(h, l) {
  "use strict";
  V();
  function p(d) {
...
var ao = H({ "src/language-js/loc.js"(h, l) {
  "use strict";
  V();
  var p = io();
  function d(E, k) {
...
var no = H({ "src/language-js/parse/utils/create-parser.js"(h, l) {
  "use strict";
  V();
  var { hasPragma: p } = Yp(), { locStart: d, locEnd: m } = ao();
  function x(P) {
    return P = typeof P == "function" ? { parse: P } : P, Object.assign({ astFormat: "estree", hasPragma: p, locStart: d, locEnd: m }, P);
  }
  l.exports = x;
} });
var ar = H({ "src/common/parser-create-error.js"(h, l) {
  "use strict";
  V();
  function p(d, m) {
...
var oo = H({ "src/language-js/parse/utils/create-babel-parse-error.js"(h, l) {
  "use strict";
  V();
  var p = ar();
  function d(m) {
...
var $p = H({ "src/language-js/utils/is-ts-keyword-type.js"(h, l) {
  "use strict";
  V();
  function p(d) {
    let { type: m } = d;
...
var Qp = H({ "src/language-js/utils/is-block-comment.js"(h, l) {
  "use strict";
  V();
  function p(d) {
...
var Zp = H({ "src/language-js/utils/is-type-cast-comment.js"(h, l) {
  "use strict";
  V();
  var p = Qp();
  function d(m) {
...
var ef = H({ "src/utils/get-last.js"(h, l) {
  "use strict";
  V();
  var p = (d) => d[d.length - 1];
  l.exports = p;
} });
var ho = H({ "src/language-js/parse/postprocess/visit-node.js"(h, l) {
  "use strict";
  V();
  function p(d, m) {
    if (Array.isArray(d)) {
...
var tf = H({ "src/language-js/parse/postprocess/typescript.js"(h, l) {
  "use strict";
  V();
  var p = ar(), d = ho();
  function m(E, k) {
    let { start: F, end: v } = E.loc;
    throw p(k, { start: { line: F.line, column: F.column + 1 }, end: { line: v.line, column: v.column + 1 } });
  }
  function x(E, k, F) {
    let v = E.decorators;
    if (!Array.isArray(v))
      return;
    let O = k.decorators;
    (!Array.isArray(O) || O.length !== v.length || v.some((A) => {
      let _ = F.get(A);
      return !_ || !O.includes(_);
    })) && m(k, "Leading decorators must be attached to a class declaration");
  }
  function P(E, k) {
    E.kind !== 166 || E.modifiers && !E.modifiers.some((O) => O.kind === 126) || E.initializer && k.value === null && m(k, "Abstract property cannot have an initializer");
  }
  function T(E, k) {
...
var sf = H({ "src/language-js/parse/postprocess/index.js"(h, l) {
  "use strict";
  V();
  var { locStart: p, locEnd: d } = ao(), m = $p(), x = Zp(), P = ef(), T = ho(), { throwErrorForInvalidNodes: E } = tf();
  function k(A, _) {
    if (_.parser === "typescript" && /@|abstract/.test(_.originalText) && E(A, _), _.parser !== "typescript" && _.parser !== "flow" && _.parser !== "acorn" && _.parser !== "espree" && _.parser !== "meriyah") {
      ...
      A = T(A, (R) => {
        ...
        if (R.type === "ParenthesizedExpression") {
          let { expression: W } = R;
          if (W.type === "TypeCastExpression")
            return W.range = R.range, W;
          let u = p(R);
          if (!B.has(u))
            return W.extra = Object.assign(Object.assign({}, W.extra), {}, { parenthesized: true }), W;
        }
      });
    }
    return A = T(A, (B) => {
      switch (B.type) {
        ...
        case "ExportAllDeclaration": {
          ...
          if (_.parser === "meriyah" && R && R.type === "Identifier") {
            ...
            (W.startsWith('"') || W.startsWith("'")) && (B.exported = Object.assign(Object.assign({}, B.exported), {}, { type: "Literal", value: B.exported.name, raw: W }));
          }
          break;
        }
      }
  ...
  function O(A) {
    return v(A) ? O({ type: "LogicalExpression", operator: A.operator, left: O({ type: "LogicalExpression", operator: A.operator, left: A.left, right: A.right.left, range: [p(A.left), d(A.right.left)] }), right: A.right.right, range: [p(A), d(A)] }) : A;
  }
  l.exports = k;
} });
var lo = H({ "node_modules/@babel/parser/lib/index.js"(h) {
  "use strict";
  ...
  var x = Object.freeze({ SyntaxError: "BABEL_PARSER_SYNTAX_ERROR", SourceTypeModuleError: "BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED" }), P = function(t) {
  ...
  var u = Object.assign({}, W(E), W(v), W(O), W(Rn || (Rn = nt(["pipelineOperator"])))(_)), { defineProperty: J } = Object, ie = (t, e) => J(t, e, { enumerable: false, value: t[e] });
  function $(t) {
  ...
  }, q = { brace: new Q("{"), j_oTag: new Q("<tag"), j_cTag: new Q("</tag"), j_expr: new Q("<tag>...</tag>", true) };
  q.template = new Q("`", true);
  var S = true, g = true, ne = true, G = true, Y = true, qe = true, oe = class {
    constructor(t) {
  ...
  ee[8].updateContext = (t) => {
    t.pop();
  }, ee[5].updateContext = ee[7].updateContext = ee[23].updateContext = (t) => {
    t.push(q.brace);
  ...
  function xe(t) {
    return t < 65 ? t === 36 : t <= 90 ? true : t < 97 ? t === 95 : t <= 122 ? true : t <= 65535 ? t >= 170 && Eo.test(String.fromCharCode(t)) : Ht(t, ur);
  }
  function Ue(t) {
    return t < 48 ? t === 36 : t < 58 ? true : t < 65 ? false : t <= 90 ? true : t < 97 ? t === 95 : t <= 122 ? true : t <= 65535 ? t >= 170 && bo.test(String.fromCharCode(t)) : Ht(t, ur) || Ht(t, vo);
  }
  ...
  var ko = /* @__PURE__ */ new Set(["break", "case", "catch", "continue", "debugger", "default", "do", "else", "finally", "for", "function", "if", "return", "switch", "throw", "try", "var", "const", "while", "with", "new", "this", "super", "class", "extends", "export", "import", "null", "true", "false", "in", "instanceof", "typeof", "void", "delete", "implements", "interface", "let", "package", "private", "protected", "public", "static", "yield", "eval", "arguments", "enum", "await"]);
  function Do(t) {
    return ko.has(t);
  }
  var _e = 0, Je = 1, ge = 2, Gt = 4, mr = 8, lt = 16, yr = 32, De = 64, Xt = 128, ut = 256, ct = Je | ge | ut, Ae = 1, ze = 2, xr = 4, Ce = 8, pt = 16, gr = 64, ft = 128, Jt = 256, Yt = 512, $t = 1024, Qt = 2048, Ar = Ae | ze | Ce | ft, Pe = Ae | 0 | Ce | 0, dt = Ae | 0 | xr | 0, Pr = Ae | 0 | pt | 0, Fo = 0 | ze | 0 | ft, Lo = 0 | ze | 0 | 0, Tr = Ae | ze | Ce | Jt, Er = 0 | $t, Fe = 0 | gr, Oo = Ae | 0 | 0 | gr, Bo = Tr | Yt, Mo = 0 | $t, Ro = Qt, mt = 4, Zt = 2, es = 1, ts = Zt | es, jo = Zt | mt, qo = es | mt, Uo = Zt, _o = es, ss = 0, zo = class {
    constructor() {
  ...
  var Vo = class extends zo {
    ...
    finalizeComment(t) {
      ...
      if (t.leadingNode !== null || t.trailingNode !== null)
        t.leadingNode !== null && br(t.leadingNode, e), t.trailingNode !== null && Ko(t.trailingNode, e);
      else {
  ...
  }, Go = ["at"], Xo = ["at"], Jo = function(e) {
    return e >= 48 && e <= 57;
  }, Yo = /* @__PURE__ */ new Set([103, 109, 115, 105, 121, 117, 100, 118]), Sr = { decBinOct: /* @__PURE__ */ new Set([46, 66, 69, 79, 95, 98, 101, 111]), hex: /* @__PURE__ */ new Set([46, 88, 95, 120]) }, ce = {};
  ce.bin = /* @__PURE__ */ new Set([48, 49]), ce.oct = /* @__PURE__ */ new Set([...ce.bin, 50, 51, 52, 53, 54, 55]), ce.dec = /* @__PURE__ */ new Set([...ce.oct, 56, 57]), ce.hex = /* @__PURE__ */ new Set([...ce.dec, 65, 66, 67, 68, 69, 70, 97, 98, 99, 100, 101, 102]);
  var Se = class {
    constructor(t) {
    ...
    constructor(t, e) {
      super();
      this.isLookahead = void 0, this.tokens = [], this.state = new Cr(), this.state.init(t), this.input = e, this.length = e.length, this.isLookahead = false;
    }
    pushToken(t) {
    ...
    readToken_numberSign() {
      ...
      if (e === 123 || e === 91 && this.hasPlugin("recordAndTuple")) {
        ...
        xe(e) ? (++this.state.pos, this.finishToken(134, this.readWord1(e))) : e === 92 ? (++this.state.pos, this.finishToken(134, this.readWord1())) : this.finishOp(27, 1);
    }
    readToken_dot() {
    ...
    readInt(t, e, s) {
      let r = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : true, i = this.state.pos, a = t === 16 ? Sr.hex : Sr.decBinOct, n = t === 16 ? ce.hex : t === 10 ? ce.dec : t === 8 ? ce.oct : ce.bin, o = false, c = 0;
      for (let f = 0, y = e == null ? 1 / 0 : e; f < y; ++f) {
        let C = this.input.charCodeAt(this.state.pos), w;
        if (C === 95 && r !== "bail") {
        ...
        if (C >= 97 ? w = C - 97 + 10 : C >= 65 ? w = C - 65 + 10 : Jo(C) ? w = C - 48 : w = 1 / 0, w >= t)
...
`;
    ...
    readWord1(t) {
      ...
      for (t !== void 0 && (this.state.pos += t <= 65535 ? 1 : 2); this.state.pos < this.length; ) {
        ...
        if (Ue(i))
          ...
          let a = this.state.curPosition(), n = this.state.pos === s ? xe : Ue;
    ...
    readWord(t) {
      let e = this.readWord1(t), s = he.get(e);
      s !== void 0 ? this.finishToken(s, ve(s)) : this.finishToken(128, e);
    }
    checkKeywordEscapes() {
      let { type: t } = this.state;
      Kt(t) && this.state.containsEsc && this.raise(u.InvalidEscapedReservedWord, { at: this.state.startLoc, reservedWord: ve(t) });
    }
    raise(t, e) {
      let { at: s } = e, r = l(e, Go), i = s instanceof p ? s : s.loc.start, a = t({ loc: i, details: r });
      if (!this.options.errorRecovery)
        throw a;
      return this.isLookahead || this.state.errors.push(a), a;
    }
    raiseOverwrite(t, e) {
      let { at: s } = e, r = l(e, Xo), i = s instanceof p ? s : s.loc.start, a = i.index, n = this.state.errors;
    ...
    unexpected(t, e) {
      throw this.raise(u.UnexpectedToken, { expected: e ? ve(e) : null, at: t != null ? t : this.state.startLoc });
    }
    expectPlugin(t, e) {
      if (this.hasPlugin(t))
        return true;
    ...
    declareName(t, e, s) {
      ...
      if (e & Ce || e & pt)
        this.checkRedeclarationInScope(r, t, e, s), e & pt ? r.functions.add(t) : r.lexical.add(t), e & Ce && this.maybeExportDefined(r, t);
      else if (e & xr)
        for (let i = this.scopeStack.length - 1; i >= 0 && (r = this.scopeStack[i], this.checkRedeclarationInScope(r, t, e, s), r.var.add(t), this.maybeExportDefined(r, t), !(r.flags & ct)); --i)
          ;
    ...
    isRedeclaredInScope(t, e, s) {
      return s & Ae ? s & Ce ? t.lexical.has(e) || t.functions.has(e) || t.var.has(e) : s & pt ? t.lexical.has(e) || !this.treatFunctionsAsVarInScope(t) && t.var.has(e) : t.lexical.has(e) && !(t.flags & mr && t.lexical.values().next().value === e) || !this.treatFunctionsAsVarInScope(t) && t.functions.has(e) : false;
    }
    checkLocalExport(t) {
    ...
    isRedeclaredInScope(t, e, s) {
      return super.isRedeclaredInScope(...arguments) ? true : s & Qt ? !t.declareFunctions.has(e) && (t.lexical.has(e) || t.functions.has(e)) : false;
    }
    checkLocalExport(t) {
    ...
    declarePrivateName(t, e, s) {
      ...
      if (e & ts) {
        let o = n && i.get(t);
        if (o) {
          let c = o & mt, f = e & mt, y = o & ts, C = e & ts;
    ...
    recordAsyncArrowParametersError(t) {
      ...
      for (; i.canBeArrowParameterDeclaration(); )
        i.type === os && i.recordDeclarationError(u.AwaitBindingIdentifier, { at: e }), i = s[--r];
    }
    validateAsPattern() {
  ...
  var Ke = 0, Dr = 1, gt = 2, Fr = 4, Ve = 8, oh = class {
    constructor() {
      this.stacks = [];
    }
    enter(t) {
  ...
  var hh = class extends $o {
    ...
    initializeScopes() {
      ...
      return this.expressionScope = new rh(this), () => {
  ...
  hs.__clone = function() {
    let t = new Tt(), e = Object.keys(this);
  ...
  function Te(t) {
    let { type: e, start: s, end: r, loc: i, range: a, extra: n, name: o } = t, c = Object.create(hs);
  ...
  var dh = { const: "declare export var", let: "declare export var", type: "export type", interface: "export interface" };
  function mh(t, e) {
    let s = [], r = [];
  ...
  var yh = /\*?\s*@((?:no)?flow)\b/, xh = (t) => class extends t {
    constructor() {
      super(...arguments);
    ...
    flowParsePredicate() {
      ...
      return this.next(), this.expectContextual(107), this.state.lastTokStart > s.index + 1 && this.raise(L.UnexpectedSpaceBetweenModuloChecks, { at: s }), this.eat(10) ? (e.value = this.parseExpression(), this.expect(11), this.finishNode(e, "DeclaredPredicate")) : this.finishNode(e, "InferredPredicate");
    }
    ...
    flowParseDeclareFunction(e) {
      ...
      return r.params = a.params, r.rest = a.rest, r.this = a._this, this.expect(11), [r.returnType, e.predicate] = this.flowParseTypeAndPredicateInitialiser(), i.typeAnnotation = this.finishNode(r, "FunctionTypeAnnotation"), s.typeAnnotation = this.finishNode(i, "TypeAnnotation"), this.resetEndLocation(s), this.semicolon(), this.scope.declareName(e.id.name, Ro, e.id.loc.start), this.finishNode(e, "DeclareFunction");
    }
    flowParseDeclare(e, s) {
      ...
      if (this.eatContextual(123))
        return this.match(16) ? this.flowParseDeclareModuleExports(e) : (s && this.raise(L.NestedDeclareModule, { at: this.state.lastTokStartLoc }), this.flowParseDeclareModule(e));
    ...
    flowParseDeclareModule(e) {
      this.scope.enter(_e), this.match(129) ? e.id = this.parseExprAtom() : e.id = this.parseIdentifier();
      let s = e.body = this.startNode(), r = s.body = [];
      for (this.expect(5); !this.match(8); ) {
        let n = this.startNode();
        this.match(83) ? (this.next(), !this.isContextual(126) && !this.match(87) && this.raise(L.InvalidNonTypeImportInDeclareModule, { at: this.state.lastTokStartLoc }), this.parseImport(n)) : (this.expectContextual(121, L.UnsupportedStatementInDeclareModule), n = this.flowParseDeclare(n, true)), r.push(n);
      }
      this.scope.exit(), this.expect(8), this.finishNode(s, "BlockStatement");
      let i = null, a = false;
      return r.forEach((n) => {
        fh(n) ? (i === "CommonJS" && this.raise(L.AmbiguousDeclareModuleKind, { at: n }), i = "ES") : n.type === "DeclareModuleExports" && (a && this.raise(L.DuplicateDeclareModuleExports, { at: n }), i === "ES" && this.raise(L.AmbiguousDeclareModuleKind, { at: n }), i = "CommonJS", a = true);
    ...
    flowParseDeclareExportDeclaration(e, s) {
      ...
      if (this.match(75) || this.isLet() || (this.isContextual(126) || this.isContextual(125)) && !s) {
        ...
        throw this.raise(L.UnsupportedDeclareExportKind, { at: this.state.startLoc, unsupportedExportKind: r, suggestion: dh[r] });
      }
    ...
    flowParseInterfaceish(e) {
      let s = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
      if (e.id = this.flowParseRestrictedIdentifier(!s, true), this.scope.declareName(e.id.name, s ? Pr : Pe, e.id.loc.start), this.match(47) ? e.typeParameters = this.flowParseTypeParameterDeclaration() : e.typeParameters = null, e.extends = [], e.implements = [], e.mixins = [], this.eat(81))
        do
    ...
    checkReservedType(e, s, r) {
      !ph.has(e) || this.raise(r ? L.AssignReservedType : L.UnexpectedReservedType, { at: s, reservedType: e });
    }
    ...
    flowParseTypeAlias(e) {
      return e.id = this.flowParseRestrictedIdentifier(false, true), this.scope.declareName(e.id.name, Pe, e.id.loc.start), this.match(47) ? e.typeParameters = this.flowParseTypeParameterDeclaration() : e.typeParameters = null, e.right = this.flowParseTypeInitialiser(29), this.semicolon(), this.finishNode(e, "TypeAlias");
    }
    flowParseOpaqueType(e, s) {
      return this.expectContextual(126), e.id = this.flowParseRestrictedIdentifier(true, true), this.scope.declareName(e.id.name, Pe, e.id.loc.start), this.match(47) ? e.typeParameters = this.flowParseTypeParameterDeclaration() : e.typeParameters = null, e.supertype = null, this.match(14) && (e.supertype = this.flowParseTypeInitialiser(14)), e.impltype = null, s || (e.impltype = this.flowParseTypeInitialiser(29)), this.semicolon(), this.finishNode(e, "OpaqueType");
    }
    flowParseTypeParameter() {
      ...
      return r.name = a.name, r.variance = i, r.bound = a.typeAnnotation, this.match(29) ? (this.eat(29), r.default = this.flowParseType()) : e && this.raise(L.MissingTypeParamDefault, { at: s }), this.finishNode(r, "TypeParameter");
    }
    ...
    flowParseObjectType(e) {
      ...
      for (r && this.match(6) ? (this.expect(6), f = 9, y = true) : (this.expect(5), f = 8, y = false), c.exact = y; !this.match(f); ) {
        let I = false, M = null, U = null, te = this.startNode();
        if (a && this.isContextual(115)) {
          let pe = this.lookahead();
          pe.type !== 14 && pe.type !== 17 && (this.next(), M = this.state.startLoc, s = false);
        }
        if (s && this.isContextual(104)) {
          let pe = this.lookahead();
          pe.type !== 14 && pe.type !== 17 && (this.next(), I = true);
        }
        let ae = this.flowParseVariance();
        if (this.eat(0))
          M != null && this.unexpected(M), this.eat(0) ? (ae && this.unexpected(ae.loc.start), c.internalSlots.push(this.flowParseObjectTypeInternalSlot(te, I))) : c.indexers.push(this.flowParseObjectTypeIndexer(te, I, ae));
        else if (this.match(10) || this.match(47))
          M != null && this.unexpected(M), ae && this.unexpected(ae.loc.start), c.callProperties.push(this.flowParseObjectTypeCallProperty(te, I));
        else {
          let pe = "init";
          ...
          et === null ? (C = true, U = this.state.lastTokStartLoc) : c.properties.push(et);
        }
        this.flowObjectTypeSemicolon(), U && !this.match(8) && !this.match(9) && this.raise(L.UnexpectedExplicitInexactInObject, { at: U });
      }
    ...
    flowParseObjectTypeProperty(e, s, r, i, a, n, o) {
      if (this.eat(21))
        return this.match(12) || this.match(13) || this.match(8) || this.match(9) ? (n ? o || this.raise(L.InexactInsideExact, { at: this.state.lastTokStartLoc }) : this.raise(L.InexactInsideNonObject, { at: this.state.lastTokStartLoc }), i && this.raise(L.InexactVariance, { at: i }), null) : (n || this.raise(L.UnexpectedSpreadType, { at: this.state.lastTokStartLoc }), r != null && this.unexpected(r), i && this.raise(L.SpreadVariance, { at: i }), e.argument = this.flowParseType(), this.finishNode(e, "ObjectTypeSpreadProperty"));
      {
        e.key = this.flowParseObjectPropertyKey(), e.static = s, e.proto = r != null, e.kind = a;
        let c = false;
        return this.match(47) || this.match(10) ? (e.method = true, r != null && this.unexpected(r), i && this.unexpected(i.loc.start), e.value = this.flowParseObjectTypeMethodish(this.startNodeAt(e.start, e.loc.start)), (a === "get" || a === "set") && this.flowCheckGetterSetterParams(e), !n && e.key.name === "constructor" && e.value.this && this.raise(L.ThisParamBannedInConstructor, { at: e.value.this })) : (a !== "init" && this.unexpected(), e.method = false, this.eat(17) && (c = true), e.value = this.flowParseTypeInitialiser(), e.variance = i), e.optional = c, this.finishNode(e, "ObjectTypeProperty");
      }
    }
    flowCheckGetterSetterParams(e) {
      let s = e.kind === "get" ? 0 : 1, r = e.value.params.length + (e.value.rest ? 1 : 0);
      e.value.this && this.raise(e.kind === "get" ? L.GetterMayNotHaveThisParam : L.SetterMayNotHaveThisParam, { at: e.value.this }), r !== s && this.raise(e.kind === "get" ? u.BadGetterArity : u.BadSetterArity, { at: e }), e.kind === "set" && e.value.rest && this.raise(u.BadSetterRestParameter, { at: e });
    }
    ...
    flowParseFunctionTypeParam(e) {
      ...
      return n.type === 14 || n.type === 17 ? (o && !e && this.raise(L.ThisParamMustBeFirst, { at: a }), s = this.parseIdentifier(o), this.eat(17) && (r = true, o && this.raise(L.ThisParamMayNotBeOptional, { at: a })), i = this.flowParseTypeInitialiser()) : i = this.flowParseType(), a.name = s, a.optional = r, a.typeAnnotation = i, this.finishNode(a, "FunctionTypeParam");
    }
    ...
    shouldParseExportDeclaration() {
      ...
      return hr(e) || this.shouldParseEnums() && e === 122 ? !this.state.containsEsc : super.shouldParseExportDeclaration();
    }
    isExportDefaultSpecifier() {
      let { type: e } = this.state;
      return hr(e) || this.shouldParseEnums() && e === 122 ? this.state.containsEsc : super.isExportDefaultSpecifier();
    }
    ...
    parseConditional(e, s, r, i) {
      ...
      if (f || C.length > 0) {
        ...
        f && y.length > 1 && this.raise(L.AmbiguousConditionalArrow, { at: a.startLoc }), f && y.length === 1 && (this.state = a, w.push(y[0].start), this.state.noArrowAt = w, { consequent: c, failed: f } = this.tryParseConditionalConsequent());
      }
    ...
    getArrowLikeExpressions(e, s) {
      ...
      return s ? (i.forEach((a) => this.finishArrowValidation(a)), [i, []]) : mh(i, (a) => a.params.every((n) => this.isAssignable(n, true)));
    }
    finishArrowValidation(e) {
      var s;
      this.toAssignableList(e.params, (s = e.extra) == null ? void 0 : s.trailingCommaLoc, false), this.scope.enter(ge | Gt), super.checkParams(e, false, true), this.scope.exit();
    }
    ...
    parseClassMember(e, s, r) {
      ...
      super.parseClassMember(e, s, r), s.declare && (s.type !== "ClassProperty" && s.type !== "ClassPrivateProperty" && s.type !== "PropertyDefinition" ? this.raise(L.DeclareClassElement, { at: i }) : s.value && this.raise(L.DeclareClassFieldInitializer, { at: s.value }));
    }
    isIterator(e) {
    ...
    getTokenFromCode(e) {
      ...
      return e === 123 && s === 124 ? this.finishOp(6, 2) : this.state.inType && (e === 62 || e === 60) ? this.finishOp(e === 62 ? 48 : 47, 1) : this.state.inType && e === 63 ? s === 46 ? this.finishOp(18, 2) : this.finishOp(17, 1) : Io(e, s, this.input.charCodeAt(this.state.pos + 2)) ? (this.state.pos += 2, this.readIterator()) : super.getTokenFromCode(e);
    }
    isAssignable(e, s) {
    ...
    toReferencedList(e, s) {
      for (let i = 0; i < e.length; i++) {
        var r;
        let a = e[i];
        a && a.type === "TypeCastExpression" && !((r = a.extra) != null && r.parenthesized) && (e.length > 1 || !s) && this.raise(L.TypeCastInPattern, { at: a.typeAnnotation });
      }
      return e;
    }
    ...
    pushClassMethod(e, s, r, i, a, n) {
      if (s.variance && this.unexpected(s.variance.loc.start), delete s.variance, this.match(47) && (s.typeParameters = this.flowParseTypeParameterDeclaration()), super.pushClassMethod(e, s, r, i, a, n), s.params && a) {
        let o = s.params;
        o.length > 0 && this.isThisParam(o[0]) && this.raise(L.ThisParamBannedInConstructor, { at: s });
    ...
    checkGetterSetterParams(e) {
      ...
      if (s.length > 0) {
        let r = s[0];
        this.isThisParam(r) && e.kind === "get" ? this.raise(L.GetterMayNotHaveThisParam, { at: r }) : this.isThisParam(r) && this.raise(L.SetterMayNotHaveThisParam, { at: r });
      }
    }
    ...
    parseAssignableListItemTypes(e) {
      return this.eat(17) && (e.type !== "Identifier" && this.raise(L.PatternIsOptional, { at: e }), this.isThisParam(e) && this.raise(L.ThisParamMayNotBeOptional, { at: e }), e.optional = true), this.match(14) ? e.typeAnnotation = this.flowParseTypeAnnotation() : this.isThisParam(e) && this.raise(L.ThisParamAnnotationRequired, { at: e }), this.match(29) && this.isThisParam(e) && this.raise(L.ThisParamNoDefault, { at: e }), this.resetEndLocation(e), e;
    }
    parseMaybeDefault(e, s, r) {
      let i = super.parseMaybeDefault(e, s, r);
      return i.type === "AssignmentPattern" && i.typeAnnotation && i.right.start < i.typeAnnotation.start && this.raise(L.TypeBeforeInitializer, { at: i.typeAnnotation }), i;
    }
    shouldParseDefaultImport(e) {
      return ls(e) ? Lr(this.state.type) : super.shouldParseDefaultImport(e);
    }
    parseImportSpecifierLocal(e, s, r) {
      s.local = ls(e) ? this.flowParseRestrictedIdentifier(true, true) : this.parseIdentifier(), e.specifiers.push(this.finishImportSpecifier(s, r));
    }
    maybeParseDefaultImportSpecifier(e) {
      ...
      if (this.match(87) ? s = "typeof" : this.isContextual(126) && (s = "type"), s) {
        ...
        s === "type" && i === 55 && this.unexpected(null, r.type), (Lr(i) || i === 5 || i === 55) && (this.next(), e.importKind = s);
      }
    ...
    parseImportSpecifier(e, s, r, i) {
      ...
      if (this.isContextual(93) && !this.isLookaheadContextual("as")) {
        ...
        n !== null && !me(this.state.type) ? (e.imported = f, e.importKind = n, e.local = Te(f)) : (e.imported = a, e.importKind = null, e.local = this.parseIdentifier());
      } else {
        ...
        this.eatContextual(93) ? e.local = this.parseIdentifier() : (o = true, e.local = Te(e.imported));
      }
      let c = ls(e);
      return r && c && this.raise(L.ImportTypeShorthandOnlyInPureImport, { at: e }), (r || c) && this.checkReservedType(e.local.name, e.local.loc.start, true), o && !r && !c && this.checkReservedWord(e.local.name, e.loc.start, true, true), this.finishImportSpecifier(e, "ImportSpecifier");
    }
    parseBindingAtom() {
      switch (this.state.type) {
        case 78:
      ...
      if ((r = a) != null && r.error || this.match(47)) {
        ...
        if (f.node && this.maybeUnwrapTypeCastExpression(f.node).type === "ArrowFunctionExpression") {
          if (!f.error && !f.aborted)
            return f.node.async && this.raise(L.UnexpectedTypeParameterBeforeAsyncArrowFunction, { at: c }), f.node;
          y = f.node;
        }
        if ((n = a) != null && n.node)
        ...
        throw (o = a) != null && o.thrown ? a.error : f.thrown ? f.error : this.raise(L.UnexpectedTokenAfterTypeParameter, { at: c });
      }
    ...
    checkParams(e, s, r) {
      if (!(r && this.state.noArrowParamsConversionAt.indexOf(e.start) !== -1)) {
        for (let i = 0; i < e.params.length; i++)
          this.isThisParam(e.params[i]) && i > 0 && this.raise(L.ThisParamMustBeFirst, { at: e.params[i] });
    ...
    parseTopLevel(e, s) {
      ...
      return this.state.hasFlowComment && this.raise(L.UnterminatedFlowComment, { at: this.state.curPosition() }), r;
    }
    skipBlockComment() {
    ...
    flowEnumErrorInvalidMemberInitializer(e, s) {
      return this.raise(s.explicitType ? s.explicitType === "symbol" ? L.EnumInvalidMemberInitializerSymbolType : L.EnumInvalidMemberInitializerPrimaryType : L.EnumInvalidMemberInitializerUnknownType, Object.assign({ at: e }, s));
    }
    ...
    flowEnumMembers(e) {
      ...
      for (; !this.match(8); ) {
        ...
        if (y === "")
          continue;
        /^[a-z]/.test(y) && this.raise(L.EnumInvalidMemberName, { at: c, memberName: y, suggestion: y[0].toUpperCase() + y.slice(1), enumName: s }), i.has(y) && this.raise(L.EnumDuplicateMemberName, { at: c, memberName: y, enumName: s }), i.add(y);
    ...
    flowEnumParseExplicitType(e) {
      ...
      if (!K(this.state.type))
        throw this.raise(L.EnumInvalidExplicitTypeUnknownSupplied, { at: this.state.startLoc, enumName: s });
      let { value: r } = this.state;
      return this.next(), r !== "boolean" && r !== "number" && r !== "string" && r !== "symbol" && this.raise(L.EnumInvalidExplicitType, { at: this.state.startLoc, enumName: s, invalidEnumType: r }), r;
    }
    flowEnumBody(e, s) {
      ...
      switch (e.hasUnknownMembers = o, a) {
        ...
        default: {
          ...
          let f = n.booleanMembers.length, y = n.numberMembers.length, C = n.stringMembers.length, w = n.defaultedMembers.length;
          if (!f && !y && !C && !w)
            return c();
          if (!f && !y)
    ...
    jsxReadToken() {
      ...
      for (; ; ) {
        ...
        switch (r) {
          ...
          case 125:
          default:
            Le(r) ? (e += this.input.slice(s, this.state.pos), e += this.jsxReadNewLine(true), s = this.state.pos) : ++this.state.pos;
        }
      }
    }
    jsxReadNewLine(e) {
...
`) : r = String.fromCharCode(s), ++this.state.curLine, this.state.lineStart = this.state.pos, r;
    ...
    jsxReadString(e) {
      ...
      for (; ; ) {
        ...
        if (i === e)
          break;
        i === 38 ? (s += this.input.slice(r, this.state.pos), s += this.jsxReadEntity(), r = this.state.pos) : Le(i) ? (s += this.input.slice(r, this.state.pos), s += this.jsxReadNewLine(false), r = this.state.pos) : ++this.state.pos;
      }
    ...
    jsxReadEntity() {
      ...
      if (this.codePointAtPos(this.state.pos) === 35) {
        ...
        for (; s++ < 10 && this.state.pos < this.length && !(r = this.codePointAtPos(this.state.pos) == 59); )
          ++this.state.pos;
        if (r) {
          let i = this.input.slice(e, this.state.pos), a = gh[i];
          if (++this.state.pos, a)
            return a;
        }
      }
    ...
    jsxParseIdentifier() {
      let e = this.startNode();
      return this.match(136) ? e.name = this.state.value : Kt(this.state.type) ? e.name = ve(this.state.type) : this.unexpected(), this.next(), this.finishNode(e, "JSXIdentifier");
    }
    ...
    jsxParseAttributeValue() {
      ...
      switch (this.state.type) {
        case 5:
          return e = this.startNode(), this.setContext(q.brace), this.next(), e = this.jsxParseExpressionContainer(e, q.j_oTag), e.expression.type === "JSXEmptyExpression" && this.raise(Oe.AttributeIsEmpty, { at: e }), e;
        case 138:
        case 129:
    ...
    jsxParseSpreadChild(e) {
      return this.next(), e.expression = this.parseExpression(), this.setContext(q.j_oTag), this.expect(8), this.finishNode(e, "JSXSpreadChild");
    }
    ...
    jsxParseAttribute() {
      let e = this.startNode();
      return this.match(5) ? (this.setContext(q.brace), this.next(), this.expect(21), e.argument = this.parseMaybeAssignAllowIn(), this.setContext(q.j_oTag), this.expect(8), this.finishNode(e, "JSXSpreadAttribute")) : (e.name = this.jsxParseNamespacedName(), e.value = this.eat(29) ? this.jsxParseAttributeValue() : null, this.finishNode(e, "JSXAttribute"));
    }
          ...
          for (; ; )
            switch (this.state.type) {
              ...
              case 5: {
                ...
                this.setContext(q.brace), this.next(), this.match(21) ? i.push(this.jsxParseSpreadChild(o)) : i.push(this.jsxParseExpressionContainer(o, q.j_expr));
                break;
              }
              default:
                throw this.unexpected();
            }
        we(a) && !we(n) && n !== null ? this.raise(Oe.MissingClosingTagFragment, { at: n }) : !we(a) && we(n) ? this.raise(Oe.MissingClosingTagElement, { at: n, openingTagName: He(a.name) }) : !we(a) && !we(n) && He(n.name) !== He(a.name) && this.raise(Oe.MissingClosingTagElement, { at: n, openingTagName: He(a.name) });
      }
    ...
    updateContext(e) {
      ...
      if (r === 56 && e === 138)
        s.splice(-2, 2, q.j_cTag), this.state.canStartJSXElement = false;
      else if (r === 138)
        s.push(q.j_oTag);
      else if (r === 139) {
        let i = s[s.length - 1];
        i === q.j_oTag && e === 56 || i === q.j_cTag ? (s.pop(), this.state.canStartJSXElement = s[s.length - 1] === q.j_expr) : (this.setContext(q.j_expr), this.state.canStartJSXElement = true);
      } else
        this.state.canStartJSXElement = po(r);
    }
  }, Ph = class extends as {
    constructor() {
      super(...arguments);
    ...
    declareName(t, e, s) {
      ...
      super.declareName(...arguments), e & ze && (e & Ae || (this.checkRedeclarationInScope(r, t, e, s), this.maybeExportDefined(r, t)), r.types.add(t)), e & Jt && r.enums.add(t), e & Yt && r.constEnums.add(t), e & ft && r.classes.add(t);
    }
    isRedeclaredInScope(t, e, s) {
      if (t.enums.has(e)) {
        if (s & Jt) {
          let r = !!(s & Yt), i = t.constEnums.has(e);
          return r !== i;
        }
        return true;
      }
      return s & ft && t.classes.has(e) ? t.lexical.has(e) ? !!(s & Ae) : false : s & ze && t.types.has(e) ? true : super.isRedeclaredInScope(...arguments);
    }
    checkLocalExport(t) {
  ...
  var D = W(Un || (Un = nt(["typescript"])))((t) => ({ AbstractMethodHasImplementation: t((e) => {
    let { methodName: s } = e;
  ...
  var Ch = (t) => class extends t {
    ...
    tsParseModifiers(e) {
      let { modified: s, allowedModifiers: r, disallowedModifiers: i, stopOnStartOfClassStaticBlock: a } = e, n = (c, f, y, C) => {
        f === y && s[C] && this.raise(D.InvalidModifiersOrder, { at: c, orderedModifiers: [y, C] });
      }, o = (c, f, y, C) => {
        (s[y] && f === C || s[C] && f === y) && this.raise(D.IncompatibleModifiers, { at: c, modifiers: [y, C] });
      };
      for (; ; ) {
        let { startLoc: c } = this.state, f = this.tsParseModifier(r.concat(i != null ? i : []), a);
        if (!f)
          break;
        Br(f) ? s.accessibility ? this.raise(D.DuplicateAccessibilityModifier, { at: c, modifier: f }) : (n(c, f, f, "override"), n(c, f, f, "static"), n(c, f, f, "readonly"), s.accessibility = f) : (Object.hasOwnProperty.call(s, f) ? this.raise(D.DuplicateModifier, { at: c, modifier: f }) : (n(c, f, "static", "readonly"), n(c, f, "static", "override"), n(c, f, "override", "readonly"), n(c, f, "abstract", "override"), o(c, f, "declare", "override"), o(c, f, "static", "abstract")), s[f] = true), i != null && i.includes(f) && this.raise(D.InvalidModifierOnTypeMember, { at: c, modifier: f });
      }
    }
    ...
    tsParseDelimitedList(e, s, r) {
      return bh(this.tsParseDelimitedListWorker(e, s, true, r));
    }
    ...
    tsParseImportType() {
      let e = this.startNode();
      return this.expect(83), this.expect(10), this.match(129) || this.raise(D.UnsupportedImportTypeArgument, { at: this.state.startLoc }), e.argument = this.parseExprAtom(), this.expect(11), this.eat(16) && (e.qualifier = this.tsParseEntityName()), this.match(47) && (e.typeParameters = this.tsParseTypeArguments()), this.finishNode(e, "TSImportType");
    }
    tsParseEntityName() {
    ...
    tsParseTypeParameters() {
      ...
      let s = { value: -1 };
      return e.params = this.tsParseBracketedList("TypeParametersOrArguments", this.tsParseTypeParameter.bind(this), false, true, s), e.params.length === 0 && this.raise(D.EmptyTypeParameters, { at: e }), s.value !== -1 && this.addExtra(e, "trailingComma", s.value), this.finishNode(e, "TSTypeParameterDeclaration");
    }
    ...
    tsParseBindingListForSignature() {
      return this.parseBindingList(11, 41).map((e) => (e.type !== "Identifier" && e.type !== "RestElement" && e.type !== "ObjectPattern" && e.type !== "ArrayPattern" && this.raise(D.UnsupportedSignatureParameterKind, { at: e, type: e.type }), e));
    }
    ...
    tsParsePropertyOrMethodSignature(e, s) {
      ...
      if (this.match(10) || this.match(47)) {
        ...
        let i = r;
        i.kind && this.match(47) && this.raise(D.AccesorCannotHaveTypeParameters, { at: this.state.curPosition() }), this.tsFillSignature(14, i), this.tsParseTypeMemberSemicolon();
        let a = "parameters", n = "typeAnnotation";
        if (i.kind === "get")
          i[a].length > 0 && (this.raise(u.BadGetterArity, { at: this.state.curPosition() }), this.isThisParam(i[a][0]) && this.raise(D.AccesorCannotDeclareThisParameter, { at: this.state.curPosition() }));
        else if (i.kind === "set") {
          if (i[a].length !== 1)
            this.raise(u.BadSetterArity, { at: this.state.curPosition() });
          else {
            let o = i[a][0];
            this.isThisParam(o) && this.raise(D.AccesorCannotDeclareThisParameter, { at: this.state.curPosition() }), o.type === "Identifier" && o.optional && this.raise(D.SetAccesorCannotHaveOptionalParameter, { at: this.state.curPosition() }), o.type === "RestElement" && this.raise(D.SetAccesorCannotHaveRestParameter, { at: this.state.curPosition() });
          }
    ...
    tsParseTupleType() {
      ...
      return e.elementTypes.forEach((i) => {
        var a;
        let { type: n } = i;
        s && n !== "TSRestType" && n !== "TSOptionalType" && !(n === "TSNamedTupleMember" && i.optional) && this.raise(D.OptionalTypeBeforeRequired, { at: i }), s = s || n === "TSNamedTupleMember" && i.optional || n === "TSOptionalType", n === "TSRestType" && (i = i.typeAnnotation, n = i.type);
        let o = n === "TSNamedTupleMember";
        r = (a = r) != null ? a : o, r !== o && this.raise(D.MixedLabeledAndUnlabeledElements, { at: i });
    ...
    tsParseTupleElementType() {
      ...
      if (this.eat(14)) {
        ...
        o.optional = a, i.type === "TSTypeReference" && !i.typeParameters && i.typeName.type === "Identifier" ? o.label = i.typeName : (this.raise(D.InvalidTupleMemberLabel, { at: i }), o.label = i), o.elementType = this.tsParseType(), i = this.finishNode(o, "TSNamedTupleMember");
      } else if (a) {
        let o = this.startNodeAtNode(i);
    ...
    tsParseNonArrayType() {
      switch (this.state.type) {
        ...
        default: {
          let { type: e } = this.state;
          if (K(e) || e === 88 || e === 84) {
            let s = e === 88 ? "TSVoidKeyword" : e === 84 ? "TSNullKeyword" : vh(this.state.value);
    ...
    tsParseTypeOperatorOrHigher() {
      return Ao(this.state.type) && !this.state.containsEsc ? this.tsParseTypeOperator() : this.isContextual(112) ? this.tsParseInferType() : this.tsParseArrayTypeOrHigher();
    }
    ...
    tsParseTypeAssertion() {
      this.getPluginOption("typescript", "disallowAmbiguousJSXLike") && this.raise(D.ReservedTypeAssertion, { at: this.state.startLoc });
    ...
    tsParseInterfaceDeclaration(e) {
      ...
      if (this.hasFollowingLineBreak())
        return null;
      this.expectContextual(125), s.declare && (e.declare = true), K(this.state.type) ? (e.id = this.parseIdentifier(), this.checkIdentifier(e.id, Fo)) : (e.id = null, this.raise(D.MissingInterfaceName, { at: this.state.startLoc })), e.typeParameters = this.tsTryParseTypeParameters(), this.eat(81) && (e.extends = this.tsParseHeritageClause("extends"));
      let r = this.startNode();
    ...
    tsParseTypeAliasDeclaration(e) {
      return e.id = this.parseIdentifier(), this.checkIdentifier(e.id, Lo), e.typeParameters = this.tsTryParseTypeParameters(), e.typeAnnotation = this.tsInType(() => {
    ...
    tsParseEnumDeclaration(e) {
      let s = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
      return s.const && (e.const = true), s.declare && (e.declare = true), this.expectContextual(122), e.id = this.parseIdentifier(), this.checkIdentifier(e.id, e.const ? Bo : Tr), this.expect(5), e.members = this.tsParseDelimitedList("EnumMembers", this.tsParseEnumMember.bind(this)), this.expect(8), this.finishNode(e, "TSEnumDeclaration");
    }
    tsParseModuleBlock() {
      let e = this.startNode();
      return this.scope.enter(_e), this.expect(5), this.parseBlockOrModuleBlockBody(e.body = [], void 0, true, 8), this.scope.exit(), this.finishNode(e, "TSModuleBlock");
    }
    tsParseModuleOrNamespaceDeclaration(e) {
      ...
      if (e.id = this.parseIdentifier(), s || this.checkIdentifier(e.id, Mo), this.eat(16)) {
        ...
        this.scope.enter(ut), this.prodParam.enter(Ke), e.body = this.tsParseModuleBlock(), this.prodParam.exit(), this.scope.exit();
      return this.finishNode(e, "TSModuleDeclaration");
    }
    tsParseAmbientExternalModuleDeclaration(e) {
      return this.isContextual(109) ? (e.global = true, e.id = this.parseIdentifier()) : this.match(129) ? e.id = this.parseExprAtom() : this.unexpected(), this.match(5) ? (this.scope.enter(ut), this.prodParam.enter(Ke), e.body = this.tsParseModuleBlock(), this.prodParam.exit(), this.scope.exit()) : this.semicolon(), this.finishNode(e, "TSModuleDeclaration");
    }
    tsParseImportEqualsDeclaration(e, s) {
      e.isExport = s || false, e.id = this.parseIdentifier(), this.checkIdentifier(e.id, Pe), this.expect(29);
      let r = this.tsParseModuleReference();
      return e.importKind === "type" && r.type !== "TSExternalModuleReference" && this.raise(D.ImportAliasHasImportType, { at: r }), e.moduleReference = r, this.semicolon(), this.finishNode(e, "TSImportEqualsDeclaration");
    }
    ...
    tsParseTypeArguments() {
      let e = this.startNode();
      return e.params = this.tsInType(() => this.tsInNoContext(() => (this.expect(47), this.tsParseDelimitedList("TypeParametersOrArguments", this.tsParseType.bind(this))))), e.params.length === 0 && this.raise(D.EmptyTypeArguments, { at: e }), this.expect(48), this.finishNode(e, "TSTypeParameterInstantiation");
    }
    ...
    parseAssignableListItem(e, s) {
      ...
      if (e !== void 0) {
        let y = {};
        this.tsParseModifiers({ modified: y, allowedModifiers: ["public", "private", "protected", "override", "readonly"] }), a = y.accessibility, o = y.override, n = y.readonly, e === false && (a || n || o) && this.raise(D.UnexpectedParameterModifier, { at: i });
      }
      ...
      if (a || n || o) {
        ...
        return s.length && (y.decorators = s), a && (y.accessibility = a), n && (y.readonly = n), o && (y.override = o), f.type !== "Identifier" && f.type !== "AssignmentPattern" && this.raise(D.UnsupportedParameterPropertyKind, { at: y }), y.parameter = f, this.finishNode(y, "TSParameterProperty");
      }
    ...
    parseFunctionBodyAndFinish(e, s) {
      ...
      if (i === "TSDeclareFunction" && this.state.isAmbientContext && (this.raise(D.DeclareFunctionHasImplementation, { at: e }), e.declare)) {
    ...
    registerFunctionStatementId(e) {
      !e.body && e.id ? this.checkIdentifier(e.id, Er) : super.registerFunctionStatementId(...arguments);
    }
    tsCheckForInvalidTypeCasts(e) {
      e.forEach((s) => {
        (s == null ? void 0 : s.type) === "TSTypeCastExpression" && this.raise(D.UnexpectedTypeAnnotation, { at: s.typeAnnotation });
      });
    }
    toReferencedList(e, s) {
    ...
    parseImport(e) {
      ...
      return s.importKind === "type" && s.specifiers.length > 1 && s.specifiers[0].type === "ImportDefaultSpecifier" && this.raise(D.TypeImportCannotSpecifyDefaultAndNamed, { at: s }), s;
    }
    parseExport(e) {
      if (this.match(83))
    ...
    parseVarStatement(e, s) {
      ...
      for (let { id: n, init: o } of a.declarations)
        !o || (s !== "const" || !!n.typeAnnotation ? this.raise(D.InitializerNotAllowedInAmbientContext, { at: o }) : o.type !== "StringLiteral" && o.type !== "BooleanLiteral" && o.type !== "NumericLiteral" && o.type !== "BigIntLiteral" && (o.type !== "TemplateLiteral" || o.expressions.length > 0) && !Sh(o) && this.raise(D.ConstInitiailizerMustBeStringOrNumericLiteralOrLiteralEnumReference, { at: o }));
      return a;
    }
    ...
    parseClassMember(e, s, r) {
      ...
      let a = () => {
        this.tsIsStartOfStaticBlocks() ? (this.next(), this.next(), this.tsHasSomeModifiers(s, i) && this.raise(D.StaticBlockCannotHaveModifier, { at: this.state.curPosition() }), this.parseClassStaticBlock(e, s)) : this.parseClassMemberWithIsStatic(e, s, r, !!s.static);
      };
    ...
    parseClassMemberWithIsStatic(e, s, r, i) {
      ...
      if (a) {
        e.body.push(a), s.abstract && this.raise(D.IndexSignatureHasAbstract, { at: s }), s.accessibility && this.raise(D.IndexSignatureHasAccessibility, { at: s, modifier: s.accessibility }), s.declare && this.raise(D.IndexSignatureHasDeclare, { at: s }), s.override && this.raise(D.IndexSignatureHasOverride, { at: s });
        return;
      }
      !this.state.inAbstractClass && s.abstract && this.raise(D.NonAbstractClassHasAbstractMethod, { at: s }), s.override && (r.hadSuperClass || this.raise(D.OverrideNotInSubClass, { at: s })), super.parseClassMemberWithIsStatic(e, s, r, i);
    }
    parsePostMemberNameModifiers(e) {
      this.eat(17) && (e.optional = true), e.readonly && this.match(10) && this.raise(D.ClassMethodHasReadonly, { at: e }), e.declare && this.match(10) && this.raise(D.ClassMethodHasDeclare, { at: e });
    }
    parseExpressionStatement(e, s) {
    ...
    parseClassProperty(e) {
      if (this.parseClassPropertyAnnotation(e), this.state.isAmbientContext && this.match(29) && this.raise(D.DeclareClassFieldHasInitializer, { at: this.state.startLoc }), e.abstract && this.match(29)) {
        let { key: s } = e;
        this.raise(D.AbstractPropertyHasInitializer, { at: this.state.startLoc, propertyName: s.type === "Identifier" && !e.computed ? s.name : "[".concat(this.input.slice(s.start, s.end), "]") });
      }
      return super.parseClassProperty(e);
    }
    parseClassPrivateProperty(e) {
      return e.abstract && this.raise(D.PrivateElementHasAbstract, { at: e }), e.accessibility && this.raise(D.PrivateElementHasAccessibility, { at: e, modifier: e.accessibility }), this.parseClassPropertyAnnotation(e), super.parseClassPrivateProperty(e);
    }
    pushClassMethod(e, s, r, i, a, n) {
      let o = this.tsTryParseTypeParameters();
      o && a && this.raise(D.ConstructorHasTypeParameters, { at: o });
      let { declare: c = false, kind: f } = s;
      c && (f === "get" || f === "set") && this.raise(D.DeclareAccessor, { at: s, kind: f }), o && (s.typeParameters = o), super.pushClassMethod(e, s, r, i, a, n);
    }
    pushClassPrivateMethod(e, s, r, i) {
    ...
    parseMaybeAssign() {
      ...
      let C, w, I;
      if (this.hasPlugin("jsx") && (this.match(138) || this.match(47))) {
        if (C = this.state.clone(), w = this.tryParse(() => super.parseMaybeAssign(...s), C), !w.error)
          return w.node;
        let { context: te } = this.state, ae = te[te.length - 1];
        (ae === q.j_oTag || ae === q.j_expr) && te.pop();
      }
      if (!((i = w) != null && i.error) && !this.match(47))
      ...
      throw (o = w) != null && o.thrown ? w.error : U.thrown ? U.error : (c = I) != null && c.thrown ? I.error : ((f = w) == null ? void 0 : f.error) || U.error || ((y = I) == null ? void 0 : y.error);
    }
    reportReservedArrowTypeParam(e) {
      var s;
      e.params.length === 1 && !((s = e.extra) != null && s.trailingComma) && this.getPluginOption("typescript", "disallowAmbiguousJSXLike") && this.raise(D.ReservedArrowTypeParam, { at: e });
    }
    parseMaybeUnary(e) {
    ...
    parseAssignableListItemTypes(e) {
      this.eat(17) && (e.type !== "Identifier" && !this.state.isAmbientContext && !this.state.inType && this.raise(D.PatternIsOptional, { at: e }), e.optional = true);
      let s = this.tsTryParseTypeAnnotation();
    ...
    isValidLVal(e, s, r) {
      return Eh({ TSTypeCastExpression: true, TSParameterProperty: "parameter", TSNonNullExpression: "expression", TSAsExpression: (r !== Fe || s) && ["expression", true], TSTypeAssertion: (r !== Fe || s) && ["expression", true] }, e) || super.isValidLVal(e, s, r);
    }
    parseBindingAtom() {
      switch (this.state.type) {
        case 78:
    ...
    parseMaybeDefault() {
      ...
      return e.type === "AssignmentPattern" && e.typeAnnotation && e.right.start < e.typeAnnotation.start && this.raise(D.TypeAnnotationAfterAssign, { at: e.typeAnnotation }), e;
    }
    getTokenFromCode(e) {
      ...
      for (let s = 0; s < e.length; s++) {
        ...
        if (!!r)
          switch (r.type) {
            ...
            case "TSAsExpression":
            case "TSTypeAssertion":
              this.state.maybeInArrowParameters ? this.raise(D.UnexpectedTypeCastInParameter, { at: r }) : e[s] = this.typeCastToParameter(r);
              break;
          }
      }
    ...
    tsParseAbstractDeclaration(e) {
      ...
      if (this.isContextual(125)) {
        if (!this.hasFollowingLineBreak())
          return e.abstract = true, this.raise(D.NonClassMethodPropertyHasAbstractModifer, { at: e }), this.tsParseInterfaceDeclaration(e);
      } else
    ...
    parseMethod() {
      ...
      if (e.abstract && (this.hasPlugin("estree") ? !!e.value.body : !!e.body)) {
        let { key: r } = e;
        this.raise(D.AbstractMethodHasImplementation, { at: e, methodName: r.type === "Identifier" && !e.computed ? r.name : "[".concat(this.input.slice(r.start, r.end), "]") });
      }
      return e;
    }
    ...
    parseTypeOnlyImportExportSpecifier(e, s, r) {
      ...
      if (this.isContextual(93)) {
        ...
        if (this.isContextual(93)) {
          ...
          me(this.state.type) ? (c = true, n = w, o = s ? this.parseIdentifier() : this.parseModuleExportName(), f = false) : (o = I, f = false);
        } else
          me(this.state.type) ? (f = false, o = s ? this.parseIdentifier() : this.parseModuleExportName()) : (c = true, n = w);
      } else
        me(this.state.type) && (c = true, n = s ? this.parseIdentifier() : this.parseModuleExportName());
      c && r && this.raise(s ? D.TypeModifierIsUsedInTypeImports : D.TypeModifierIsUsedInTypeExports, { at: y }), e[i] = n, e[a] = o;
      let C = s ? "importKind" : "exportKind";
      e[C] = c ? "type" : "value", f && this.eatContextual(93) && (e[a] = s ? this.parseIdentifier() : this.parseModuleExportName()), e[a] || (e[a] = Te(e[i])), s && this.checkIdentifier(e[a], Pe);
    }
  };
  function Sh(t) {
    ...
    return e && s.type !== "StringLiteral" && (s.type !== "TemplateLiteral" || s.expressions.length > 0) ? false : Mr(t.object);
  }
  function Mr(t) {
    return t.type === "Identifier" ? true : t.type !== "MemberExpression" || t.computed ? false : Mr(t.object);
  }
  var Rr = W(_n || (_n = nt(["placeholders"])))((t) => ({ ClassNameIsRequired: t("A class name is required."), UnexpectedSpace: t("Unexpected space in placeholder.") })), wh = (t) => class extends t {
    parsePlaceholder(e) {
      if (this.match(140)) {
        let s = this.startNode();
    ...
    assertNoSpace() {
      this.state.start > this.state.lastTokEndLoc.index && this.raise(Rr.UnexpectedSpace, { at: this.state.lastTokEndLoc });
    }
  }, Nh = (t) => class extends t {
    parseV8Intrinsic() {
      if (this.match(54)) {
  ...
  var jr = ["minimal", "fsharp", "hack", "smart"], qr = ["^^", "@@", "^", "%", "#"], Ur = ["hash", "bar"];
  function Ih(t) {
    if (se(t, "decorators")) {
    ...
    if (se(t, "recordAndTuple") && !Ur.includes(Qe(t, "recordAndTuple", "syntaxType")))
      throw new Error("'recordAndTuple' requires 'syntaxType' option whose value should be one of: " + Ur.map((e) => "'".concat(e, "'")).join(", "));
  ...
  var _r = { estree: be, jsx: Ah, flow: xh, typescript: Ch, v8intrinsic: Nh, placeholders: wh }, kh = Object.keys(_r), zr = { sourceType: "script", sourceFilename: void 0, startColumn: 0, startLine: 1, allowAwaitOutsideFunction: false, allowReturnOutsideFunction: false, allowImportExportEverywhere: false, allowSuperOutsideMethod: false, allowUndeclaredExports: false, plugins: [], strictMode: null, ranges: false, tokens: false, createParenthesizedExpressions: false, errorRecovery: false, attachComment: true };
  function Dh(t) {
    let e = {};
    for (let s of Object.keys(zr))
      e[s] = t && t[s] != null ? t[s] : zr[s];
    return e;
  }
  var Fh = (t, e) => Object.hasOwnProperty.call(t, e) && t[e], us = (t) => t.type === "ParenthesizedExpression" ? us(t.expression) : t, Lh = class extends ch {
    toAssignable(t) {
      let e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
      var s, r;
      let i;
      switch ((t.type === "ParenthesizedExpression" || (s = t.extra) != null && s.parenthesized) && (i = us(t), e ? i.type === "Identifier" ? this.expressionScope.recordParenthesizedIdentifierError({ at: t }) : i.type !== "MemberExpression" && this.raise(u.InvalidParenthesizedAssignment, { at: t }) : this.raise(u.InvalidParenthesizedAssignment, { at: t })), t.type) {
        case "Identifier":
        case "ObjectPattern":
        case "ArrayPattern":
    ...
    toAssignableList(t, e, s) {
      ...
      if (r) {
        ...
        if ((i == null ? void 0 : i.type) === "RestElement")
          ...
          i.type = "RestElement";
          let a = i.argument;
          this.toAssignable(a, s), a = us(a), a.type !== "Identifier" && a.type !== "MemberExpression" && a.type !== "ArrayPattern" && a.type !== "ObjectPattern" && this.unexpected(a.start), e && this.raise(u.RestTrailingComma, { at: e }), --r;
        }
      }
      for (let i = 0; i < r; i++) {
        let a = t[i];
    ...
    isValidLVal(t, e, s) {
      return Fh({ AssignmentPattern: "left", RestElement: "argument", ObjectProperty: "value", ParenthesizedExpression: "expression", ArrayPattern: "elements", ObjectPattern: "properties" }, t);
    }
    checkLVal(t, e) {
      let { in: s, binding: r = Fe, checkClashes: i = false, strictModeChanged: a = false, allowingSloppyLetBinding: n = !(r & Ce), hasParenthesizedAncestor: o = false } = e;
      var c;
      let f = t.type;
      ...
      let [C, w] = Array.isArray(y) ? y : [y, f === "ParenthesizedExpression"], I = t.type === "ArrayPattern" || t.type === "ObjectPattern" || t.type === "ParenthesizedExpression" ? t : s;
      for (let M of [].concat(t[C]))
        M && this.checkLVal(M, { in: I, binding: r, checkClashes: i, allowingSloppyLetBinding: n, strictModeChanged: a, hasParenthesizedAncestor: w });
    }
    checkIdentifier(t, e) {
      let s = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false, r = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !(e & Ce);
      this.state.strict && (s ? dr(t.name, this.inModule) : fr(t.name)) && (e === Fe ? this.raise(u.StrictEvalArguments, { at: t, referenceName: t.name }) : this.raise(u.StrictEvalArgumentsBinding, { at: t, bindingName: t.name })), !r && t.name === "let" && this.raise(u.LetInLexicalBinding, { at: t }), e & Fe || this.declareNameFromIdentifier(t, e);
    }
    ...
    parseExprOp(t, e, s, r) {
      if (this.isPrivateName(t)) {
        ...
        (r >= ot(58) || !this.prodParam.hasIn || !this.match(58)) && this.raise(u.PrivateInExpectedIn, { at: t, identifierName: a }), this.classScope.usePrivateName(a, t.loc.start);
      }
      ...
      if (yo(i) && (this.prodParam.hasIn || !this.match(58))) {
        ...
        if (a > r) {
          ...
          if (c && (a = ot(42)), this.next(), i === 39 && this.hasPlugin(["pipelineOperator", { proposal: "minimal" }]) && this.state.type === 96 && this.prodParam.hasAwait)
    ...
    parseHackPipeBody() {
      ...
      return A.has(s.type) && !((t = s.extra) != null && t.parenthesized) && this.raise(u.PipeUnparenthesizedBody, { at: e, type: s.type }), this.topicReferenceWasUsedInCurrentContext() || this.raise(u.PipeTopicUnused, { at: e }), s;
    }
    ...
    parseMaybeUnary(t, e) {
      ...
      if (i) {
        ...
        if ((this.hasPlugin("v8intrinsic") ? or(c) : or(c) && !this.match(54)) && !this.isAmbiguousAwait())
    ...
    finishTopicReference(t, e, s, r) {
      if (this.testTopicReferenceConfiguration(s, e, r)) {
        ...
        throw this.raise(u.PipeTopicUnconfiguredToken, { at: e, token: ve(r) });
    }
    ...
    parseAsyncArrowUnaryFunction(t) {
      this.prodParam.enter(At(true, this.prodParam.hasYield));
      let e = [this.parseIdentifier()];
    ...
    parseDo(t, e) {
      ...
      return this.state.labels = [], e ? (this.prodParam.enter(gt), t.body = this.parseBlock(), this.prodParam.exit()) : t.body = this.parseBlock(), this.state.labels = s, this.finishNode(t, "DoExpression");
    }
    parseSuper() {
      let t = this.startNode();
    ...
    parseParenAndDistinguishExpression(t) {
      ...
      let n = this.state.start, o = this.state.startLoc, c = [], f = new Pt(), y = true, C, w;
      for (; !this.match(11); ) {
        if (y)
          y = false;
        ...
        if (this.match(21)) {
          let te = this.state.start, ae = this.state.startLoc;
          if (C = this.state.startLoc, c.push(this.parseParenItem(this.parseRestBinding(), te, ae)), !this.checkCommaAfterRest(41))
            break;
        } else
...
`), cooked: i === null ? null : i.slice(1, c) }, n.tail = o, this.next(), this.finishNode(n, "TemplateElement"), this.resetEndLocation(n, m(this.state.lastTokEndLoc, c)), n;
    ...
    parseObjectProperty(t, e, s, r, i) {
      ...
      if (!t.computed && t.key.type === "Identifier") {
        if (this.checkReservedWord(t.key.name, t.key.loc.start, true, false), r)
          ...
          i != null ? i.shorthandAssignLoc === null && (i.shorthandAssignLoc = a) : this.raise(u.InvalidCoverInitializedName, { at: a }), t.value = this.parseMaybeDefault(e, s, Te(t.key));
        } else
          t.value = Te(t.key);
    ...
    parseMethod(t, e, s, r, i, a) {
      ...
      let o = r;
      return this.scope.enter(ge | lt | (n ? De : 0) | (i ? yr : 0)), this.prodParam.enter(At(s, t.generator)), this.parseFunctionParams(t, o), this.parseFunctionBodyAndFinish(t, a, true), this.prodParam.exit(), this.scope.exit(), t;
    }
    ...
    parseArrowExpression(t, e, s, r) {
      ...
      let i = At(s, false);
      !this.match(5) && this.prodParam.hasIn && (i |= Ve), this.prodParam.enter(i), this.initFunction(t, s);
    ...
    parseFunctionBody(t, e) {
      ...
      if (this.expressionScope.enter(kr()), r)
        ...
        this.state.labels = [], this.prodParam.enter(this.prodParam.currentFlags() | Fr), t.body = this.parseBlock(true, false, (n) => {
          ...
          this.checkParams(t, !this.state.strict && !e && !s && !o, e, c), this.state.strict && t.id && this.checkIdentifier(t.id, Oo, c);
    ...
    checkReservedWord(t, e, s, r) {
      ...
      (this.state.strict ? r ? dr : pr : cr)(t, this.inModule) && this.raise(u.UnexpectedReservedWord, { at: e, reservedWord: t });
    }
    isAwaitAllowed() {
    ...
    isAmbiguousAwait() {
      if (this.hasPrecedingLineBreak())
        return true;
      let { type: t } = this.state;
      return t === 53 || t === 10 || t === 0 || ht(t) || t === 133 || t === 56 || this.hasPlugin("v8intrinsic") && t === 54;
    }
    parseYield() {
      let t = this.startNode();
  ...
  }, cs = { kind: "loop" }, Bh = { kind: "switch" }, Mh = 0, ps = 1, Kr = 2, Vr = 4, Rh = /[\uD800-\uDFFF]/u, fs = /in(?:stanceof)?/y;
  function jh(t, e) {
      ...
      if (typeof i == "number") {
        {
          if (i === 134) {
            ...
            t.splice(s, 1, new Se({ type: ye(27), value: "#", start: n, end: f, startLoc: a.start, endLoc: y }), new Se({ type: ye(128), value: o, start: f, end: c, startLoc: y, endLoc: a.end })), s++;
            continue;
          }
          if (ht(i)) {
            let { loc: a, start: n, value: o, end: c } = r, f = n + 1, y = m(a.start, 1), C;
            e.charCodeAt(n) === 96 ? C = new Se({ type: ye(22), value: "`", start: n, end: f, startLoc: a.start, endLoc: y }) : C = new Se({ type: ye(8), value: "}", start: n, end: f, startLoc: a.start, endLoc: y });
            let w, I, M, U;
            i === 24 ? (I = c - 1, M = m(a.end, -1), w = o === null ? null : o.slice(1, -1), U = new Se({ type: ye(22), value: "`", start: I, end: c, startLoc: M, endLoc: a.end })) : (I = c - 2, M = m(a.end, -2), w = o === null ? null : o.slice(1, -2), U = new Se({ type: ye(23), value: "${", start: I, end: c, startLoc: M, endLoc: a.end })), t.splice(s, 1, C, new Se({ type: ye(20), value: w, start: f, end: I, startLoc: y, endLoc: M }), U), s += 2;
            continue;
          }
        }
        r.type = ye(i);
  ...
  var qh = class extends Oh {
    ...
    parseForStatement(t) {
      ...
      let e = null;
      if (this.isAwaitAllowed() && this.eatContextual(96) && (e = this.state.lastTokStartLoc), this.scope.enter(_e), this.expect(10), this.match(13))
      ...
      let i = this.isContextual(95), a = new Pt(), n = this.parseExpression(true, a), o = this.isContextual(101);
    ...
    parseCatchClauseParam() {
      ...
      return this.scope.enter(e ? mr : 0), this.checkLVal(t, { in: { type: "CatchClause" }, binding: Pe, allowingSloppyLetBinding: true }), t;
    }
    parseTryStatement(t) {
      if (this.next(), t.block = this.parseBlock(), t.handler = null, this.match(62)) {
        let e = this.startNode();
        this.next(), this.match(10) ? (this.expect(10), e.param = this.parseCatchClauseParam(), this.expect(11)) : (e.param = null, this.scope.enter(_e)), e.body = this.withSmartMixTopicForbiddingContext(() => this.parseBlock(false, false)), this.scope.exit(), t.handler = this.finishNode(e, "CatchClause");
      }
    ...
    parseBlock() {
      ...
      return t && this.state.strictErrors.clear(), this.expect(5), e && this.scope.enter(_e), this.parseBlockBody(r, t, false, 8, s), e && this.scope.exit(), this.finishNode(r, "BlockStatement");
    }
    isValidDirective(t) {
    ...
    parseVarId(t, e) {
      t.id = this.parseBindingAtom(), this.checkLVal(t.id, { in: { type: "VariableDeclarator" }, binding: e === "var" ? dt : Pe });
    }
    parseFunction(t) {
      let e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Mh, s = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false, r = e & ps, i = e & Kr, a = !!r && !(e & Vr);
      ...
      return this.state.maybeInArrowParameters = false, this.scope.enter(ge), this.prodParam.enter(At(s, t.generator)), r || (t.id = this.parseFunctionId()), this.parseFunctionParams(t, false), this.withSmartMixTopicForbiddingContext(() => {
    ...
    parseFunctionParams(t, e) {
      this.expect(10), this.expressionScope.enter(ih()), t.params = this.parseBindingList(11, 41, false, e), this.expressionScope.exit();
    }
    registerFunctionStatementId(t) {
      !t.id || this.scope.declareName(t.id.name, this.state.strict || t.generator || t.async ? this.scope.treatFunctionsAsVar ? dt : Pe : Pr, t.id.loc.start);
    }
    parseClass(t, e, s) {
    ...
    parseClassMemberWithIsStatic(t, e, s, r) {
      ...
      let C = K(this.state.type) && !this.state.containsEsc, w = this.match(134), I = this.parseClassElementName(e), M = this.state.startLoc;
      if (this.parsePostMemberNameModifiers(y), this.isClassMethod()) {
        if (f.kind = "method", w) {
          this.pushClassPrivateMethod(t, a, false, false);
          return;
        }
        let U = this.isNonstaticConstructor(i), te = false;
        U && (i.kind = "constructor", s.hadConstructor && !this.hasPlugin("typescript") && this.raise(u.DuplicateConstructor, { at: I }), U && this.hasPlugin("typescript") && e.override && this.raise(u.OverrideOnConstructor, { at: I }), s.hadConstructor = true, te = s.hadSuperClass), this.pushClassMethod(t, i, false, false, U, te);
      } else if (this.isClassProperty())
        ...
        this.parseClassElementName(f), this.parsePostMemberNameModifiers(y), te ? this.pushClassPrivateMethod(t, a, U, true) : (this.isNonstaticConstructor(i) && this.raise(u.ConstructorIsAsync, { at: i.key }), this.pushClassMethod(t, i, U, true, false, false));
        ...
        let U = this.match(134);
        this.parseClassElementName(i), U ? this.pushClassPrivateMethod(t, a, false, false) : (this.isNonstaticConstructor(i) && this.raise(u.ConstructorIsAccessor, { at: i.key }), this.pushClassMethod(t, i, false, false, false, false)), this.checkGetterSetterParams(i);
        ...
        this.isLineTerminator() ? w ? this.pushClassPrivateProperty(t, o) : this.pushClassProperty(t, n) : this.unexpected();
    }
    ...
    pushClassPrivateProperty(t, e) {
      ...
      t.body.push(s), this.classScope.declarePrivateName(this.getPrivateNameSV(s.key), ss, s.key.loc.start);
    }
    pushClassAccessorProperty(t, e, s) {
      ...
      t.body.push(r), s && this.classScope.declarePrivateName(this.getPrivateNameSV(r.key), ss, r.key.loc.start);
    }
    ...
    parseInitializer(t) {
      this.scope.enter(De | lt), this.expressionScope.enter(kr()), this.prodParam.enter(Ke), t.value = this.eat(29) ? this.parseMaybeAssignAllowIn() : null, this.expressionScope.exit(), this.prodParam.exit(), this.scope.exit();
    }
    parseClassId(t, e, s) {
    ...
    isAsyncFunction() {
      ...
      return !rs.test(this.input.slice(this.state.pos, t)) && this.isUnparsedContextual(t, "function");
    }
    parseExportDefaultExpression() {
    ...
    parseExportSpecifier(t, e, s, r) {
      return this.eatContextual(93) ? t.exported = this.parseModuleExportName() : e ? t.exported = uh(t.local) : t.exported || (t.exported = Te(t.local)), this.finishNode(t, "ExportSpecifier");
    }
    parseModuleExportName() {
      if (this.match(129)) {
        let t = this.parseStringLiteral(this.state.value), e = t.value.match(Rh);
    ...
    parseImportSpecifier(t, e, s, r) {
      if (this.eatContextual(93))
        ...
        this.checkReservedWord(i.name, t.loc.start, true, true), t.local || (t.local = Te(i));
      }
    ...
    constructor(t, e) {
      t = Dh(t);
      super(t, e);
      this.options = t, this.initializeScopes(), this.plugins = Uh(this.options.plugins), this.filename = t.sourceFilename;
    }
    getScopeHandler() {
      return ns;
    }
  ...
  var Wr = {};
  function Hh(t) {
    let e = kh.filter((i) => se(t, i)), s = e.join("/"), r = Wr[s];
    if (!r) {
      r = Hr;
      for (let i of e)
        r = _r[i](r);
...
var rf = H({ "src/language-js/parse/json.js"(h, l) {
  "use strict";
  V();
  var p = io(), d = ar(), m = no(), x = oo();
  function P() {
    let v = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, { allowComments: O = true } = v;
    return function(_) {
      let { parseExpression: re } = lo(), B;
      try {
        B = re(_, { tokens: true, ranges: true });
      } catch (R) {
        throw x(R);
      }
      if (!O && p(B.comments))
        throw T(B.comments[0], "Comment");
      return E(B), B;
    };
  }
  function T(v, O) {
  ...
  function E(v) {
    switch (v.type) {
      case "ArrayExpression":
        for (let O of v.elements)
          O !== null && E(O);
        return;
      case "ObjectExpression":
        for (let O of v.properties)
          E(O);
        return;
      case "ObjectProperty":
        if (v.computed)
          throw T(v.key, "Computed key");
        if (v.shorthand)
          throw T(v.key, "Shorthand property");
        v.key.type !== "Identifier" && E(v.key), E(v.value);
        return;
      case "UnaryExpression": {
        let { operator: O, argument: A } = v;
        if (O !== "+" && O !== "-")
          throw T(v, "Operator '".concat(v.operator, "'"));
      ...
      case "TemplateLiteral":
        if (p(v.expressions))
          throw T(v.expressions[0], "'TemplateLiteral' with expression");
        for (let O of v.quasis)
          E(O);
        return;
      case "NullLiteral":
      case "BooleanLiteral":
  ...
  var k = P(), F = { json: m({ parse: k, hasPragma() {
    return true;
  } }), json5: m(k), "json-stringify": m({ parse: P({ allowComments: false }), astFormat: "estree-json" }) };
  l.exports = F;
} });
var af = H({ "src/language-js/parse/babel.js"(h, l) {
  V();
  var p = jp(), d = Kn(), m = zp(), x = no(), P = oo(), T = sf(), E = rf(), k = { sourceType: "module", allowImportExportEverywhere: true, allowReturnOutsideFunction: true, allowSuperOutsideMethod: true, allowUndeclaredExports: true, errorRecovery: true, createParenthesizedExpressions: true, plugins: ["doExpressions", "exportDefaultFrom", "functionBind", "functionSent", "throwExpressions", "partialApplication", ["decorators", { decoratorsBeforeExport: false }], "importAssertions", "decimal", "moduleBlocks", "asyncDoExpressions", "regexpUnicodeSets", "destructuringPrivate", "decoratorAutoAccessors"], tokens: true, ranges: true }, F = ["recordAndTuple", { syntaxType: "hash" }], v = "v8intrinsic", O = [["pipelineOperator", { proposal: "hack", topicToken: "%" }], ["pipelineOperator", { proposal: "minimal" }], ["pipelineOperator", { proposal: "fsharp" }]], A = function(S) {
    let g = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : k;
    return Object.assign(Object.assign({}, g), {}, { plugins: [...g.plugins, ...S] });
  }, _ = /@(?:no)?flow\b/;
  function re(S, g) {
    if (g.filepath && g.filepath.endsWith(".js.flow"))
      return true;
    let ne = d(S);
    ne && (S = S.slice(ne.length));
    let G = m(S, 0);
    return G !== false && (S = S.slice(0, G)), _.test(S);
  }
  function B(S, g, ne) {
    let Y = lo()[S](g, ne), qe = Y.errors.find((oe) => !be.has(oe.reasonCode));
    if (qe)
      throw qe;
    return Y;
  }
  function R(S) {
    ...
    return function(Y, qe) {
      ...
      let he = ne;
      oe.__babelSourceType === "script" && (he = he.map((ee) => Object.assign(Object.assign({}, ee), {}, { sourceType: "script" }))), /#[[{]/.test(Y) && (he = he.map((ee) => A([F], ee)));
      let j = /%[A-Z]/.test(Y);
      Y.includes("|>") ? he = (j ? [...O, v] : O).flatMap((Ge) => he.map((Xe) => A([Ge], Xe))) : j && (he = he.map((ee) => A([v], ee)));
  ...
  var W = R("parse", A(["jsx", "flow"])), u = R("parse", A(["jsx", ["flow", { all: true, enums: true }]])), J = R("parse", A(["jsx", "typescript"]), A(["typescript"])), ie = R("parse", A(["jsx", "flow", "estree"])), $ = R("parseExpression", A(["jsx"])), be = /* @__PURE__ */ new Set(["StrictNumericEscape", "StrictWith", "StrictOctalLiteral", "StrictDelete", "StrictEvalArguments", "StrictEvalArgumentsBinding", "StrictFunction", "EmptyTypeArguments", "EmptyTypeParameters", "ConstructorHasTypeParameters", "UnsupportedParameterPropertyKind", "UnexpectedParameterModifier", "MixedLabeledAndUnlabeledElements", "InvalidTupleMemberLabel", "NonClassMethodPropertyHasAbstractModifer", "ReadonlyForMethodSignature", "ClassMethodHasDeclare", "ClassMethodHasReadonly", "InvalidModifierOnTypeMember", "DuplicateAccessibilityModifier", "IndexSignatureHasDeclare", "DecoratorExportClass", "ParamDupe", "InvalidDecimal", "RestTrailingComma", "UnsupportedParameterDecorator", "UnterminatedJsxContent", "UnexpectedReservedWord", "ModuleAttributesWithDuplicateKeys", "LineTerminatorBeforeArrow", "InvalidEscapeSequenceTemplate", "NonAbstractClassHasAbstractMethod", "UnsupportedPropertyDecorator", "OptionalTypeBeforeRequired", "PatternIsOptional", "OptionalBindingPattern", "DeclareClassFieldHasInitializer", "TypeImportCannotSpecifyDefaultAndNamed", "DeclareFunctionHasImplementation", "ConstructorClassField", "VarRedeclaration", "InvalidPrivateFieldResolution", "DuplicateExport"]), Q = x(W), q = x($);
  l.exports = { parsers: Object.assign(Object.assign({ babel: Q, "babel-flow": x(u), "babel-ts": x(J) }, E), {}, { __js_expression: q, __vue_expression: q, __vue_event_binding: Q, __babel_estree: x(ie) }) };
} });
var Nd = af();

// dep:prettier_esm_parser-babel
var prettier_esm_parser_babel_default = Nd;
export {
