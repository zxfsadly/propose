...
var require_standalone = __commonJS({
  "node_modules/prettier/standalone.js"(exports, module) {
    (function(e) {
      ...
      var hu = be((bg, yu) => {
        var No = Ye(), wo = at(), Po = ft(), _o = ur(), Or = No.Object, Io = wo("".split);
        yu.exports = Po(function() {
          return !Or("z").propertyIsEnumerable(0);
        }) ? function(e) {
          return _o(e) == "String" ? Io(e, "") : Or(e);
        } : Or;
      });
      var jr = be((Tg, Cu) => {
      ...
      var Iu = be((kg, _u) => {
        var Pu = Ye(), Rr = bu(), Tu = Pu.process, Bu = Pu.Deno, Nu = Tu && Tu.versions || Bu && Bu.version, wu = Nu && Nu.v8, lt, ar;
      ...
      var os = be((Kg, is) => {
        var xc = Ye(), bc = Ct(), ss = Et(), as = $r(), Tc = or(), Bc = Wu(), Nc = Ft(), wc = xc.TypeError, Pc = Nc("toPrimitive");
      ...
      var Os = be((c0, Ls) => {
        var dl = bs(), ks = Ye(), un = at(), gl = Et(), yl = dr(), sn = mt(), an = lr(), hl = Ns(), Cl = nn(), Ps = "Object already initialized", cn = ks.TypeError, El = ks.WeakMap, yr, Vt, hr, vl = function(e) {
        ...
        dl || an.state ? (dt = an.state || (an.state = new El()), _s = un(dt.get), on = un(dt.has), Is = un(dt.set), yr = function(e, n) {
          if (on(dt, e))
            throw new cn(Ps);
      ...
      var Hs = be((p0, $s) => {
        var Tl = Ye(), Rs = it(), Bl = mt(), Vs = dr(), Nl = cr(), wl = gr(), Ws = Os(), Pl = Ms().CONFIGURABLE, _l = Ws.get, Il = Ws.enforce, kl = String(String).split("String");
        ($s.exports = function(e, n, t, s) {
          ...
          if (Rs(t) && (String(a).slice(0, 7) === "Symbol(" && (a = "[" + String(a).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"), (!Bl(t, "name") || Pl && t.name !== a) && Vs(t, "name", a), c = Il(t), c.source || (c.source = kl.join(typeof a == "string" ? a : ""))), e === Tl) {
            r ? e[n] = t : Nl(n, t);
            return;
          } else
          ...
          return Rs(this) && _l(this).source || wl(this);
        });
      });
      var Cr = be((f0, Gs) => {
      ...
      var $t = be((S0, ga) => {
        ...
        ga.exports = function(e, n) {
          var t = e.target, s = e.global, i = e.stat, r, u, a, c, l, h;
          if (s ? u = Dn : i ? u = Dn[t] || hp(t, {}) : u = (Dn[t] || {}).prototype, u)
            for (a in n) {
              if (l = n[a], e.noTargetGet ? (h = dp(u, a), c = h && h.value) : c = u[a], r = Ep(s ? a : t + (i ? "." : "#") + a, e.forced), !r && c !== void 0) {
      ...
      var gn = be((T0, va) => {
        ...
        var xp = Ye(), bp = mn(), Tp = Nt(), Bp = dn(), Np = xp.TypeError, Ea = function(e, n, t, s, i, r, u, a) {
          for (var c = i, l = 0, h = u ? Bp(u, a) : false, g, y; l < s; ) {
            if (l in t) {
              if (g = h ? h(t[l], l, n) : t[l], r > 0 && bp(g))
                y = Tp(g), c = Ea(e, n, g, y, c, r - 1) - 1;
              else {
      ...
      var Sa = be((B0, Aa) => {
        var wp = Ft(), Pp = wp("toStringTag"), Fa = {};
        Fa[Pp] = "z";
        Aa.exports = String(Fa) === "[object z]";
      });
      var yn = be((N0, xa) => {
        var _p = Ye(), Ip = Sa(), kp = it(), Er = ur(), Lp = Ft(), Op = Lp("toStringTag"), jp = _p.Object, qp = Er(function() {
          return arguments;
      ...
      var La = be((P0, ka) => {
        var zp = Ye(), _a = mn(), Xp = Pa(), Kp = Et(), Yp = Ft(), Qp = Yp("species"), Ia = zp.Array;
        ka.exports = function(e) {
          var n;
          return _a(e) && (n = e.constructor, Xp(n) && (n === Ia || _a(n.prototype)) ? n = void 0 : Kp(n) && (n = n[Qp], n === null && (n = void 0))), n === void 0 ? Ia : n;
        };
      });
      var Cn = be((_0, Oa) => {
        var Zp = La();
      ...
      var Qa = be((R0, Ya) => {
        var Sf = Ye(), xf = dn(), bf = Ct(), Tf = Bt(), Bf = ir(), Nf = Ra(), wf = Nt(), za = Mr(), Pf = Ha(), _f = vn(), Xa = Ua(), If = Sf.TypeError, vr = function(e, n) {
          this.stopped = e, this.result = n;
        }, Ka = vr.prototype;
        Ya.exports = function(e, n, t) {
          var s = t && t.that, i = !!(t && t.AS_ENTRIES), r = !!(t && t.IS_ITERATOR), u = !!(t && t.INTERRUPTED), a = xf(n, s), c, l, h, g, y, p, f, C = function(T) {
            return c && Xa(c, "normal", T), new vr(true, T);
          }, N = function(T) {
            return i ? (Tf(T), u ? a(T[0], T[1], C) : a(T[0], T[1])) : u ? a(T, C) : a(T);
          };
          if (r)
            c = e;
          else {
            ...
            if (Nf(l)) {
              for (h = 0, g = wf(e); g > h; h++)
                if (y = N(e[h]), y && za(Ka, y))
                  return y;
              return new vr(false);
            }
            c = Pf(e, l);
      ...
      var dg = be((Y0, yo) => {
        ...
        var _n = Object.defineProperty, Qf = Object.getOwnPropertyDescriptor, In = Object.getOwnPropertyNames, Zf = Object.prototype.hasOwnProperty, br = (e, n) => function() {
          return e && (n = (0, e[In(e)[0]])(e = 0)), n;
        }, Z = (e, n) => function() {
          return n || (0, e[In(e)[0]])((n = { exports: {} }).exports, n), n.exports;
        }, kn = (e, n) => {
          for (var t in n)
            _n(e, t, { get: n[t], enumerable: true });
        }, eD = (e, n, t, s) => {
          if (n && typeof n == "object" || typeof n == "function")
            for (let i of In(n))
              !Zf.call(e, i) && i !== t && _n(e, i, { get: () => n[i], enumerable: !(s = Qf(n, i)) || s.enumerable });
          return e;
        }, pt = (e) => eD(_n({}, "__esModule", { value: true }), e), pi, fi, xt, ae = br({ "<define:process>"() {
          pi = {}, fi = [], xt = { env: pi, argv: fi };
        } }), gi = Z({ "package.json"(e, n) {
          n.exports = { version: "2.6.1" };
          ...
          n.prototype = { diff: function(r, u) {
            ...
            var g = u.length, y = r.length, p = 1, f = g + y, C = [{ newPos: -1, components: [] }], N = this.extractCommon(C[0], u, r, 0);
            if (C[0].newPos + 1 >= g && N + 1 >= y)
              return h([{ value: this.join(u), count: u.length }]);
            function T() {
              for (var b = -1 * p; b <= p; b += 2) {
                var v = void 0, B = C[b - 1], w = C[b + 1], I = (w ? w.newPos : 0) - b;
                B && (C[b - 1] = void 0);
                var E = B && B.newPos + 1 < g, D = w && 0 <= I && I < y;
                if (!E && !D) {
                  C[b] = void 0;
                  continue;
                }
                if (!E || D && B.newPos < w.newPos ? (v = s(w), l.pushComponent(v.components, void 0, true)) : (v = B, v.newPos++, l.pushComponent(v.components, true, void 0)), I = l.extractCommon(v, u, r, b), v.newPos + 1 >= g && I + 1 >= y)
            ...
            for (var l = u.length, h = a.length, g = r.newPos, y = g - c, p = 0; g + 1 < l && y + 1 < h && this.equals(u[g + 1], a[y + 1]); )
              g++, y++, p++;
            return p && r.components.push({ count: p }), r.newPos = g, y;
          }, equals: function(r, u) {
          ...
          function t(i, r, u, a, c) {
            for (var l = 0, h = r.length, g = 0, y = 0; l < h; l++) {
              var p = r[l];
              if (p.removed) {
                if (p.value = i.join(a.slice(y, y + p.count)), y += p.count, l && r[l - 1].added) {
                  var C = r[l - 1];
                  r[l - 1] = r[l], r[l] = C;
                }
              } else {
                if (!p.added && c) {
                  var f = u.slice(g, g + p.count);
                  f = f.map(function(T, A) {
                    var b = a[y + A];
                    return b.length > T.length ? b : T;
                  }), p.value = i.join(f);
                } else
                  p.value = i.join(u.slice(g, g + p.count));
                g += p.count, p.added || (y += p.count);
              }
            }
            var N = r[h - 1];
            return h > 1 && typeof N.value == "string" && (N.added || N.removed) && i.equals("", N.value) && (r[h - 2].value += N.value, r.pop()), r;
          }
          function s(i) {
          ...
          ae();
          function t(d) {
            return { type: "concat", parts: d };
          }
          function s(d) {
            return { type: "indent", contents: d };
          }
          function i(d, o) {
            return { type: "align", contents: o, n: d };
          }
          function r(d) {
            let o = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return { type: "group", id: o.id, contents: d, break: Boolean(o.shouldBreak), expandedStates: o.expandedStates };
          }
          function u(d) {
            return i(Number.NEGATIVE_INFINITY, d);
          }
          function a(d) {
            return i({ type: "root" }, d);
          }
          function c(d) {
            return i(-1, d);
          }
          function l(d, o) {
            return r(d[0], Object.assign(Object.assign({}, o), {}, { expandedStates: d }));
          }
          function h(d) {
            return { type: "fill", parts: d };
          }
          function g(d, o) {
            let x = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            return { type: "if-break", breakContents: d, flatContents: o, groupId: x.groupId };
          }
          function y(d, o) {
            return { type: "indent-if-break", contents: d, groupId: o.groupId, negate: o.negate };
          }
          function p(d) {
            return { type: "line-suffix", contents: d };
          }
          var f = { type: "line-suffix-boundary" }, C = { type: "break-parent" }, N = { type: "trim" }, T = { type: "line", hard: true }, A = { type: "line", hard: true, literal: true }, b = { type: "line" }, v = { type: "line", soft: true }, B = t([T, C]), w = t([A, C]), I = { type: "cursor", placeholder: Symbol("cursor") };
          function E(d, o) {
            let x = [];
            for (let F = 0; F < o.length; F++)
              F !== 0 && x.push(d), x.push(o[F]);
            return t(x);
          }
          function D(d, o, x) {
            let F = d;
          ...
          function m(d, o) {
            return { type: "label", label: d, contents: o };
          }
          n.exports = { concat: t, join: E, line: b, softline: v, hardline: B, literalline: w, group: r, conditionalGroup: l, fill: h, lineSuffix: p, lineSuffixBoundary: f, cursor: I, breakParent: C, ifBreak: g, trim: N, indent: s, indentIfBreak: y, align: i, addAlignmentToDoc: D, markAsRoot: a, dedentToRoot: u, dedent: c, hardlineWithoutBreakParent: T, literallineWithoutBreakParent: A, label: m };
...
`);
          ...
          var t = Object.create, s = Object.defineProperty, i = Object.getOwnPropertyDescriptor, r = Object.getOwnPropertyNames, u = Object.getPrototypeOf, a = Object.prototype.hasOwnProperty, c = (v, B) => function() {
            ...
            return v;
          }, g = (v, B, w) => (w = v != null ? t(u(v)) : {}, h(B || !v || !v.__esModule ? s(w, "default", { value: v, enumerable: true }) : w, v)), y = (v) => h(s({}, "__esModule", { value: true }), v), p = c({ "node_modules/emoji-regex/index.js"(v, B) {
            "use strict";
            B.exports = function() {
              return /\uD83C\uDFF4\uDB40\uDC67\uDB40\uDC62(?:\uDB40\uDC77\uDB40\uDC6C\uDB40\uDC73|\uDB40\uDC73\uDB40\uDC63\uDB40\uDC74|\uDB40\uDC65\uDB40\uDC6E\uDB40\uDC67)\uDB40\uDC7F|(?:\uD83E\uDDD1\uD83C\uDFFF\u200D\u2764\uFE0F\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1|\uD83D\uDC69\uD83C\uDFFF\u200D\uD83E\uDD1D\u200D(?:\uD83D[\uDC68\uDC69]))(?:\uD83C[\uDFFB-\uDFFE])|(?:\uD83E\uDDD1\uD83C\uDFFE\u200D\u2764\uFE0F\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1|\uD83D\uDC69\uD83C\uDFFE\u200D\uD83E\uDD1D\u200D(?:\uD83D[\uDC68\uDC69]))(?:\uD83C[\uDFFB-\uDFFD\uDFFF])|(?:\uD83E\uDDD1\uD83C\uDFFD\u200D\u2764\uFE0F\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1|\uD83D\uDC69\uD83C\uDFFD\u200D\uD83E\uDD1D\u200D(?:\uD83D[\uDC68\uDC69]))(?:\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF])|(?:\uD83E\uDDD1\uD83C\uDFFC\u200D\u2764\uFE0F\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1|\uD83D\uDC69\uD83C\uDFFC\u200D\uD83E\uDD1D\u200D(?:\uD83D[\uDC68\uDC69]))(?:\uD83C[\uDFFB\uDFFD-\uDFFF])|(?:\uD83E\uDDD1\uD83C\uDFFB\u200D\u2764\uFE0F\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1|\uD83D\uDC69\uD83C\uDFFB\u200D\uD83E\uDD1D\u200D(?:\uD83D[\uDC68\uDC69]))(?:\uD83C[\uDFFC-\uDFFF])|\uD83D\uDC68(?:\uD83C\uDFFB(?:\u200D(?:\u2764\uFE0F\u200D(?:\uD83D\uDC8B\u200D\uD83D\uDC68(?:\uD83C[\uDFFB-\uDFFF])|\uD83D\uDC68(?:\uD83C[\uDFFB-\uDFFF]))|\uD83E\uDD1D\u200D\uD83D\uDC68(?:\uD83C[\uDFFC-\uDFFF])|[\u2695\u2696\u2708]\uFE0F|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD]))?|(?:\uD83C[\uDFFC-\uDFFF])\u200D\u2764\uFE0F\u200D(?:\uD83D\uDC8B\u200D\uD83D\uDC68(?:\uD83C[\uDFFB-\uDFFF])|\uD83D\uDC68(?:\uD83C[\uDFFB-\uDFFF]))|\u200D(?:\u2764\uFE0F\u200D(?:\uD83D\uDC8B\u200D)?\uD83D\uDC68|(?:\uD83D[\uDC68\uDC69])\u200D(?:\uD83D\uDC66\u200D\uD83D\uDC66|\uD83D\uDC67\u200D(?:\uD83D[\uDC66\uDC67]))|\uD83D\uDC66\u200D\uD83D\uDC66|\uD83D\uDC67\u200D(?:\uD83D[\uDC66\uDC67])|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFF\u200D(?:\uD83E\uDD1D\u200D\uD83D\uDC68(?:\uD83C[\uDFFB-\uDFFE])|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFE\u200D(?:\uD83E\uDD1D\u200D\uD83D\uDC68(?:\uD83C[\uDFFB-\uDFFD\uDFFF])|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFD\u200D(?:\uD83E\uDD1D\u200D\uD83D\uDC68(?:\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF])|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFC\u200D(?:\uD83E\uDD1D\u200D\uD83D\uDC68(?:\uD83C[\uDFFB\uDFFD-\uDFFF])|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|(?:\uD83C\uDFFF\u200D[\u2695\u2696\u2708]|\uD83C\uDFFE\u200D[\u2695\u2696\u2708]|\uD83C\uDFFD\u200D[\u2695\u2696\u2708]|\uD83C\uDFFC\u200D[\u2695\u2696\u2708]|\u200D[\u2695\u2696\u2708])\uFE0F|\u200D(?:(?:\uD83D[\uDC68\uDC69])\u200D(?:\uD83D[\uDC66\uDC67])|\uD83D[\uDC66\uDC67])|\uD83C\uDFFF|\uD83C\uDFFE|\uD83C\uDFFD|\uD83C\uDFFC)?|(?:\uD83D\uDC69(?:\uD83C\uDFFB\u200D\u2764\uFE0F\u200D(?:\uD83D\uDC8B\u200D(?:\uD83D[\uDC68\uDC69])|\uD83D[\uDC68\uDC69])|(?:\uD83C[\uDFFC-\uDFFF])\u200D\u2764\uFE0F\u200D(?:\uD83D\uDC8B\u200D(?:\uD83D[\uDC68\uDC69])|\uD83D[\uDC68\uDC69]))|\uD83E\uDDD1(?:\uD83C[\uDFFB-\uDFFF])\u200D\uD83E\uDD1D\u200D\uD83E\uDDD1)(?:\uD83C[\uDFFB-\uDFFF])|\uD83D\uDC69\u200D\uD83D\uDC69\u200D(?:\uD83D\uDC66\u200D\uD83D\uDC66|\uD83D\uDC67\u200D(?:\uD83D[\uDC66\uDC67]))|\uD83D\uDC69(?:\u200D(?:\u2764\uFE0F\u200D(?:\uD83D\uDC8B\u200D(?:\uD83D[\uDC68\uDC69])|\uD83D[\uDC68\uDC69])|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFF\u200D(?:\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFE\u200D(?:\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFD\u200D(?:\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFC\u200D(?:\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFB\u200D(?:\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD]))|\uD83E\uDDD1(?:\u200D(?:\uD83E\uDD1D\u200D\uD83E\uDDD1|\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFF\u200D(?:\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFE\u200D(?:\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFD\u200D(?:\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFC\u200D(?:\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFB\u200D(?:\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD]))|\uD83D\uDC69\u200D\uD83D\uDC66\u200D\uD83D\uDC66|\uD83D\uDC69\u200D\uD83D\uDC69\u200D(?:\uD83D[\uDC66\uDC67])|\uD83D\uDC69\u200D\uD83D\uDC67\u200D(?:\uD83D[\uDC66\uDC67])|(?:\uD83D\uDC41\uFE0F\u200D\uD83D\uDDE8|\uD83E\uDDD1(?:\uD83C\uDFFF\u200D[\u2695\u2696\u2708]|\uD83C\uDFFE\u200D[\u2695\u2696\u2708]|\uD83C\uDFFD\u200D[\u2695\u2696\u2708]|\uD83C\uDFFC\u200D[\u2695\u2696\u2708]|\uD83C\uDFFB\u200D[\u2695\u2696\u2708]|\u200D[\u2695\u2696\u2708])|\uD83D\uDC69(?:\uD83C\uDFFF\u200D[\u2695\u2696\u2708]|\uD83C\uDFFE\u200D[\u2695\u2696\u2708]|\uD83C\uDFFD\u200D[\u2695\u2696\u2708]|\uD83C\uDFFC\u200D[\u2695\u2696\u2708]|\uD83C\uDFFB\u200D[\u2695\u2696\u2708]|\u200D[\u2695\u2696\u2708])|\uD83D\uDE36\u200D\uD83C\uDF2B|\uD83C\uDFF3\uFE0F\u200D\u26A7|\uD83D\uDC3B\u200D\u2744|(?:(?:\uD83C[\uDFC3\uDFC4\uDFCA]|\uD83D[\uDC6E\uDC70\uDC71\uDC73\uDC77\uDC81\uDC82\uDC86\uDC87\uDE45-\uDE47\uDE4B\uDE4D\uDE4E\uDEA3\uDEB4-\uDEB6]|\uD83E[\uDD26\uDD35\uDD37-\uDD39\uDD3D\uDD3E\uDDB8\uDDB9\uDDCD-\uDDCF\uDDD4\uDDD6-\uDDDD])(?:\uD83C[\uDFFB-\uDFFF])|\uD83D\uDC6F|\uD83E[\uDD3C\uDDDE\uDDDF])\u200D[\u2640\u2642]|(?:\u26F9|\uD83C[\uDFCB\uDFCC]|\uD83D\uDD75)(?:\uFE0F|\uD83C[\uDFFB-\uDFFF])\u200D[\u2640\u2642]|\uD83C\uDFF4\u200D\u2620|(?:\uD83C[\uDFC3\uDFC4\uDFCA]|\uD83D[\uDC6E\uDC70\uDC71\uDC73\uDC77\uDC81\uDC82\uDC86\uDC87\uDE45-\uDE47\uDE4B\uDE4D\uDE4E\uDEA3\uDEB4-\uDEB6]|\uD83E[\uDD26\uDD35\uDD37-\uDD39\uDD3D\uDD3E\uDDB8\uDDB9\uDDCD-\uDDCF\uDDD4\uDDD6-\uDDDD])\u200D[\u2640\u2642]|[\xA9\xAE\u203C\u2049\u2122\u2139\u2194-\u2199\u21A9\u21AA\u2328\u23CF\u23ED-\u23EF\u23F1\u23F2\u23F8-\u23FA\u24C2\u25AA\u25AB\u25B6\u25C0\u25FB\u25FC\u2600-\u2604\u260E\u2611\u2618\u2620\u2622\u2623\u2626\u262A\u262E\u262F\u2638-\u263A\u2640\u2642\u265F\u2660\u2663\u2665\u2666\u2668\u267B\u267E\u2692\u2694-\u2697\u2699\u269B\u269C\u26A0\u26A7\u26B0\u26B1\u26C8\u26CF\u26D1\u26D3\u26E9\u26F0\u26F1\u26F4\u26F7\u26F8\u2702\u2708\u2709\u270F\u2712\u2714\u2716\u271D\u2721\u2733\u2734\u2744\u2747\u2763\u27A1\u2934\u2935\u2B05-\u2B07\u3030\u303D\u3297\u3299]|\uD83C[\uDD70\uDD71\uDD7E\uDD7F\uDE02\uDE37\uDF21\uDF24-\uDF2C\uDF36\uDF7D\uDF96\uDF97\uDF99-\uDF9B\uDF9E\uDF9F\uDFCD\uDFCE\uDFD4-\uDFDF\uDFF5\uDFF7]|\uD83D[\uDC3F\uDCFD\uDD49\uDD4A\uDD6F\uDD70\uDD73\uDD76-\uDD79\uDD87\uDD8A-\uDD8D\uDDA5\uDDA8\uDDB1\uDDB2\uDDBC\uDDC2-\uDDC4\uDDD1-\uDDD3\uDDDC-\uDDDE\uDDE1\uDDE3\uDDE8\uDDEF\uDDF3\uDDFA\uDECB\uDECD-\uDECF\uDEE0-\uDEE5\uDEE9\uDEF0\uDEF3])\uFE0F|\uD83C\uDFF3\uFE0F\u200D\uD83C\uDF08|\uD83D\uDC69\u200D\uD83D\uDC67|\uD83D\uDC69\u200D\uD83D\uDC66|\uD83D\uDE35\u200D\uD83D\uDCAB|\uD83D\uDE2E\u200D\uD83D\uDCA8|\uD83D\uDC15\u200D\uD83E\uDDBA|\uD83E\uDDD1(?:\uD83C\uDFFF|\uD83C\uDFFE|\uD83C\uDFFD|\uD83C\uDFFC|\uD83C\uDFFB)?|\uD83D\uDC69(?:\uD83C\uDFFF|\uD83C\uDFFE|\uD83C\uDFFD|\uD83C\uDFFC|\uD83C\uDFFB)?|\uD83C\uDDFD\uD83C\uDDF0|\uD83C\uDDF6\uD83C\uDDE6|\uD83C\uDDF4\uD83C\uDDF2|\uD83D\uDC08\u200D\u2B1B|\u2764\uFE0F\u200D(?:\uD83D\uDD25|\uD83E\uDE79)|\uD83D\uDC41\uFE0F|\uD83C\uDFF3\uFE0F|\uD83C\uDDFF(?:\uD83C[\uDDE6\uDDF2\uDDFC])|\uD83C\uDDFE(?:\uD83C[\uDDEA\uDDF9])|\uD83C\uDDFC(?:\uD83C[\uDDEB\uDDF8])|\uD83C\uDDFB(?:\uD83C[\uDDE6\uDDE8\uDDEA\uDDEC\uDDEE\uDDF3\uDDFA])|\uD83C\uDDFA(?:\uD83C[\uDDE6\uDDEC\uDDF2\uDDF3\uDDF8\uDDFE\uDDFF])|\uD83C\uDDF9(?:\uD83C[\uDDE6\uDDE8\uDDE9\uDDEB-\uDDED\uDDEF-\uDDF4\uDDF7\uDDF9\uDDFB\uDDFC\uDDFF])|\uD83C\uDDF8(?:\uD83C[\uDDE6-\uDDEA\uDDEC-\uDDF4\uDDF7-\uDDF9\uDDFB\uDDFD-\uDDFF])|\uD83C\uDDF7(?:\uD83C[\uDDEA\uDDF4\uDDF8\uDDFA\uDDFC])|\uD83C\uDDF5(?:\uD83C[\uDDE6\uDDEA-\uDDED\uDDF0-\uDDF3\uDDF7-\uDDF9\uDDFC\uDDFE])|\uD83C\uDDF3(?:\uD83C[\uDDE6\uDDE8\uDDEA-\uDDEC\uDDEE\uDDF1\uDDF4\uDDF5\uDDF7\uDDFA\uDDFF])|\uD83C\uDDF2(?:\uD83C[\uDDE6\uDDE8-\uDDED\uDDF0-\uDDFF])|\uD83C\uDDF1(?:\uD83C[\uDDE6-\uDDE8\uDDEE\uDDF0\uDDF7-\uDDFB\uDDFE])|\uD83C\uDDF0(?:\uD83C[\uDDEA\uDDEC-\uDDEE\uDDF2\uDDF3\uDDF5\uDDF7\uDDFC\uDDFE\uDDFF])|\uD83C\uDDEF(?:\uD83C[\uDDEA\uDDF2\uDDF4\uDDF5])|\uD83C\uDDEE(?:\uD83C[\uDDE8-\uDDEA\uDDF1-\uDDF4\uDDF6-\uDDF9])|\uD83C\uDDED(?:\uD83C[\uDDF0\uDDF2\uDDF3\uDDF7\uDDF9\uDDFA])|\uD83C\uDDEC(?:\uD83C[\uDDE6\uDDE7\uDDE9-\uDDEE\uDDF1-\uDDF3\uDDF5-\uDDFA\uDDFC\uDDFE])|\uD83C\uDDEB(?:\uD83C[\uDDEE-\uDDF0\uDDF2\uDDF4\uDDF7])|\uD83C\uDDEA(?:\uD83C[\uDDE6\uDDE8\uDDEA\uDDEC\uDDED\uDDF7-\uDDFA])|\uD83C\uDDE9(?:\uD83C[\uDDEA\uDDEC\uDDEF\uDDF0\uDDF2\uDDF4\uDDFF])|\uD83C\uDDE8(?:\uD83C[\uDDE6\uDDE8\uDDE9\uDDEB-\uDDEE\uDDF0-\uDDF5\uDDF7\uDDFA-\uDDFF])|\uD83C\uDDE7(?:\uD83C[\uDDE6\uDDE7\uDDE9-\uDDEF\uDDF1-\uDDF4\uDDF6-\uDDF9\uDDFB\uDDFC\uDDFE\uDDFF])|\uD83C\uDDE6(?:\uD83C[\uDDE8-\uDDEC\uDDEE\uDDF1\uDDF2\uDDF4\uDDF6-\uDDFA\uDDFC\uDDFD\uDDFF])|[#\*0-9]\uFE0F\u20E3|\u2764\uFE0F|(?:\uD83C[\uDFC3\uDFC4\uDFCA]|\uD83D[\uDC6E\uDC70\uDC71\uDC73\uDC77\uDC81\uDC82\uDC86\uDC87\uDE45-\uDE47\uDE4B\uDE4D\uDE4E\uDEA3\uDEB4-\uDEB6]|\uD83E[\uDD26\uDD35\uDD37-\uDD39\uDD3D\uDD3E\uDDB8\uDDB9\uDDCD-\uDDCF\uDDD4\uDDD6-\uDDDD])(?:\uD83C[\uDFFB-\uDFFF])|(?:\u26F9|\uD83C[\uDFCB\uDFCC]|\uD83D\uDD75)(?:\uFE0F|\uD83C[\uDFFB-\uDFFF])|\uD83C\uDFF4|(?:[\u270A\u270B]|\uD83C[\uDF85\uDFC2\uDFC7]|\uD83D[\uDC42\uDC43\uDC46-\uDC50\uDC66\uDC67\uDC6B-\uDC6D\uDC72\uDC74-\uDC76\uDC78\uDC7C\uDC83\uDC85\uDC8F\uDC91\uDCAA\uDD7A\uDD95\uDD96\uDE4C\uDE4F\uDEC0\uDECC]|\uD83E[\uDD0C\uDD0F\uDD18-\uDD1C\uDD1E\uDD1F\uDD30-\uDD34\uDD36\uDD77\uDDB5\uDDB6\uDDBB\uDDD2\uDDD3\uDDD5])(?:\uD83C[\uDFFB-\uDFFF])|(?:[\u261D\u270C\u270D]|\uD83D[\uDD74\uDD90])(?:\uFE0F|\uD83C[\uDFFB-\uDFFF])|[\u270A\u270B]|\uD83C[\uDF85\uDFC2\uDFC7]|\uD83D[\uDC08\uDC15\uDC3B\uDC42\uDC43\uDC46-\uDC50\uDC66\uDC67\uDC6B-\uDC6D\uDC72\uDC74-\uDC76\uDC78\uDC7C\uDC83\uDC85\uDC8F\uDC91\uDCAA\uDD7A\uDD95\uDD96\uDE2E\uDE35\uDE36\uDE4C\uDE4F\uDEC0\uDECC]|\uD83E[\uDD0C\uDD0F\uDD18-\uDD1C\uDD1E\uDD1F\uDD30-\uDD34\uDD36\uDD77\uDDB5\uDDB6\uDDBB\uDDD2\uDDD3\uDDD5]|\uD83C[\uDFC3\uDFC4\uDFCA]|\uD83D[\uDC6E\uDC70\uDC71\uDC73\uDC77\uDC81\uDC82\uDC86\uDC87\uDE45-\uDE47\uDE4B\uDE4D\uDE4E\uDEA3\uDEB4-\uDEB6]|\uD83E[\uDD26\uDD35\uDD37-\uDD39\uDD3D\uDD3E\uDDB8\uDDB9\uDDCD-\uDDCF\uDDD4\uDDD6-\uDDDD]|\uD83D\uDC6F|\uD83E[\uDD3C\uDDDE\uDDDF]|[\u231A\u231B\u23E9-\u23EC\u23F0\u23F3\u25FD\u25FE\u2614\u2615\u2648-\u2653\u267F\u2693\u26A1\u26AA\u26AB\u26BD\u26BE\u26C4\u26C5\u26CE\u26D4\u26EA\u26F2\u26F3\u26F5\u26FA\u26FD\u2705\u2728\u274C\u274E\u2753-\u2755\u2757\u2795-\u2797\u27B0\u27BF\u2B1B\u2B1C\u2B50\u2B55]|\uD83C[\uDC04\uDCCF\uDD8E\uDD91-\uDD9A\uDE01\uDE1A\uDE2F\uDE32-\uDE36\uDE38-\uDE3A\uDE50\uDE51\uDF00-\uDF20\uDF2D-\uDF35\uDF37-\uDF7C\uDF7E-\uDF84\uDF86-\uDF93\uDFA0-\uDFC1\uDFC5\uDFC6\uDFC8\uDFC9\uDFCF-\uDFD3\uDFE0-\uDFF0\uDFF8-\uDFFF]|\uD83D[\uDC00-\uDC07\uDC09-\uDC14\uDC16-\uDC3A\uDC3C-\uDC3E\uDC40\uDC44\uDC45\uDC51-\uDC65\uDC6A\uDC79-\uDC7B\uDC7D-\uDC80\uDC84\uDC88-\uDC8E\uDC90\uDC92-\uDCA9\uDCAB-\uDCFC\uDCFF-\uDD3D\uDD4B-\uDD4E\uDD50-\uDD67\uDDA4\uDDFB-\uDE2D\uDE2F-\uDE34\uDE37-\uDE44\uDE48-\uDE4A\uDE80-\uDEA2\uDEA4-\uDEB3\uDEB7-\uDEBF\uDEC1-\uDEC5\uDED0-\uDED2\uDED5-\uDED7\uDEEB\uDEEC\uDEF4-\uDEFC\uDFE0-\uDFEB]|\uD83E[\uDD0D\uDD0E\uDD10-\uDD17\uDD1D\uDD20-\uDD25\uDD27-\uDD2F\uDD3A\uDD3F-\uDD45\uDD47-\uDD76\uDD78\uDD7A-\uDDB4\uDDB7\uDDBA\uDDBC-\uDDCB\uDDD0\uDDE0-\uDDFF\uDE70-\uDE74\uDE78-\uDE7A\uDE80-\uDE86\uDE90-\uDEA8\uDEB0-\uDEB6\uDEC0-\uDEC2\uDED0-\uDED6]|(?:[\u231A\u231B\u23E9-\u23EC\u23F0\u23F3\u25FD\u25FE\u2614\u2615\u2648-\u2653\u267F\u2693\u26A1\u26AA\u26AB\u26BD\u26BE\u26C4\u26C5\u26CE\u26D4\u26EA\u26F2\u26F3\u26F5\u26FA\u26FD\u2705\u270A\u270B\u2728\u274C\u274E\u2753-\u2755\u2757\u2795-\u2797\u27B0\u27BF\u2B1B\u2B1C\u2B50\u2B55]|\uD83C[\uDC04\uDCCF\uDD8E\uDD91-\uDD9A\uDDE6-\uDDFF\uDE01\uDE1A\uDE2F\uDE32-\uDE36\uDE38-\uDE3A\uDE50\uDE51\uDF00-\uDF20\uDF2D-\uDF35\uDF37-\uDF7C\uDF7E-\uDF93\uDFA0-\uDFCA\uDFCF-\uDFD3\uDFE0-\uDFF0\uDFF4\uDFF8-\uDFFF]|\uD83D[\uDC00-\uDC3E\uDC40\uDC42-\uDCFC\uDCFF-\uDD3D\uDD4B-\uDD4E\uDD50-\uDD67\uDD7A\uDD95\uDD96\uDDA4\uDDFB-\uDE4F\uDE80-\uDEC5\uDECC\uDED0-\uDED2\uDED5-\uDED7\uDEEB\uDEEC\uDEF4-\uDEFC\uDFE0-\uDFEB]|\uD83E[\uDD0C-\uDD3A\uDD3C-\uDD45\uDD47-\uDD78\uDD7A-\uDDCB\uDDCD-\uDDFF\uDE70-\uDE74\uDE78-\uDE7A\uDE80-\uDE86\uDE90-\uDEA8\uDEB0-\uDEB6\uDEC0-\uDEC2\uDED0-\uDED6])|(?:[#\*0-9\xA9\xAE\u203C\u2049\u2122\u2139\u2194-\u2199\u21A9\u21AA\u231A\u231B\u2328\u23CF\u23E9-\u23F3\u23F8-\u23FA\u24C2\u25AA\u25AB\u25B6\u25C0\u25FB-\u25FE\u2600-\u2604\u260E\u2611\u2614\u2615\u2618\u261D\u2620\u2622\u2623\u2626\u262A\u262E\u262F\u2638-\u263A\u2640\u2642\u2648-\u2653\u265F\u2660\u2663\u2665\u2666\u2668\u267B\u267E\u267F\u2692-\u2697\u2699\u269B\u269C\u26A0\u26A1\u26A7\u26AA\u26AB\u26B0\u26B1\u26BD\u26BE\u26C4\u26C5\u26C8\u26CE\u26CF\u26D1\u26D3\u26D4\u26E9\u26EA\u26F0-\u26F5\u26F7-\u26FA\u26FD\u2702\u2705\u2708-\u270D\u270F\u2712\u2714\u2716\u271D\u2721\u2728\u2733\u2734\u2744\u2747\u274C\u274E\u2753-\u2755\u2757\u2763\u2764\u2795-\u2797\u27A1\u27B0\u27BF\u2934\u2935\u2B05-\u2B07\u2B1B\u2B1C\u2B50\u2B55\u3030\u303D\u3297\u3299]|\uD83C[\uDC04\uDCCF\uDD70\uDD71\uDD7E\uDD7F\uDD8E\uDD91-\uDD9A\uDDE6-\uDDFF\uDE01\uDE02\uDE1A\uDE2F\uDE32-\uDE3A\uDE50\uDE51\uDF00-\uDF21\uDF24-\uDF93\uDF96\uDF97\uDF99-\uDF9B\uDF9E-\uDFF0\uDFF3-\uDFF5\uDFF7-\uDFFF]|\uD83D[\uDC00-\uDCFD\uDCFF-\uDD3D\uDD49-\uDD4E\uDD50-\uDD67\uDD6F\uDD70\uDD73-\uDD7A\uDD87\uDD8A-\uDD8D\uDD90\uDD95\uDD96\uDDA4\uDDA5\uDDA8\uDDB1\uDDB2\uDDBC\uDDC2-\uDDC4\uDDD1-\uDDD3\uDDDC-\uDDDE\uDDE1\uDDE3\uDDE8\uDDEF\uDDF3\uDDFA-\uDE4F\uDE80-\uDEC5\uDECB-\uDED2\uDED5-\uDED7\uDEE0-\uDEE5\uDEE9\uDEEB\uDEEC\uDEF0\uDEF3-\uDEFC\uDFE0-\uDFEB]|\uD83E[\uDD0C-\uDD3A\uDD3C-\uDD45\uDD47-\uDD78\uDD7A-\uDDCB\uDDCD-\uDDFF\uDE70-\uDE74\uDE78-\uDE7A\uDE80-\uDE86\uDE90-\uDEA8\uDEB0-\uDEB6\uDEC0-\uDEC2\uDED0-\uDED6])\uFE0F|(?:[\u261D\u26F9\u270A-\u270D]|\uD83C[\uDF85\uDFC2-\uDFC4\uDFC7\uDFCA-\uDFCC]|\uD83D[\uDC42\uDC43\uDC46-\uDC50\uDC66-\uDC78\uDC7C\uDC81-\uDC83\uDC85-\uDC87\uDC8F\uDC91\uDCAA\uDD74\uDD75\uDD7A\uDD90\uDD95\uDD96\uDE45-\uDE47\uDE4B-\uDE4F\uDEA3\uDEB4-\uDEB6\uDEC0\uDECC]|\uD83E[\uDD0C\uDD0F\uDD18-\uDD1F\uDD26\uDD30-\uDD39\uDD3C-\uDD3E\uDD77\uDDB5\uDDB6\uDDB8\uDDB9\uDDBB\uDDCD-\uDDCF\uDDD1-\uDDDD])/g;
            };
          } }), f = {};
          l(f, { default: () => b }), n.exports = y(f);
          function C() {
          ...
          function c(o, x, F, S) {
            ...
            for (; k.length > 0; ) {
              ...
              if (F && k.push(P, a), !x || x(P) !== false)
                if (r(P) || P.type === "fill") {
                  let O = u(P);
                  for (let R = O.length, M = R - 1; M >= 0; --M)
                    k.push(O[M]);
                } else if (P.type === "if-break")
                  P.flatContents && k.push(P.flatContents), P.breakContents && k.push(P.breakContents);
                else if (P.type === "group" && P.expandedStates)
                  if (S)
                    for (let O = P.expandedStates.length, R = O - 1; R >= 0; --R)
                      k.push(P.expandedStates[R]);
                  else
                    k.push(P.contents);
                else
                  P.contents && k.push(P.contents);
            }
          }
          function l(o, x) {
            ...
            function k(P) {
              if (Array.isArray(P))
                return x(P.map(S));
              if (P.type === "concat" || P.type === "fill") {
                let O = P.parts.map(S);
                return x(Object.assign(Object.assign({}, P), {}, { parts: O }));
              }
              if (P.type === "if-break") {
                let O = P.breakContents && S(P.breakContents), R = P.flatContents && S(P.flatContents);
                return x(Object.assign(Object.assign({}, P), {}, { breakContents: O, flatContents: R }));
              }
              if (P.type === "group" && P.expandedStates) {
                let O = P.expandedStates.map(S), R = O[0];
                return x(Object.assign(Object.assign({}, P), {}, { contents: R, expandedStates: O }));
              }
              if (P.contents) {
                let O = S(P.contents);
                return x(Object.assign(Object.assign({}, P), {}, { contents: O }));
              }
              return x(P);
            }
          }
          ...
          function f(o) {
            ...
            function S(P) {
              if (P.type === "break-parent" && p(F), P.type === "group") {
                if (F.push(P), x.has(P))
                  return false;
                x.add(P);
              }
...
`)).parts;
          ...
          n.exports = { isConcat: r, getDocParts: u, willBreak: y, traverseDoc: c, findInDoc: h, mapDoc: l, propagateBreaks: f, removeLines: N, stripTrailingHardline: b, normalizeParts: w, normalizeDoc: I, cleanDoc: B, replaceTextEndOfLine: D, replaceEndOfLine: E, canBreak: d };
        } }), uD = Z({ "src/document/doc-printer.js"(e, n) {
          "use strict";
          ae();
          var { convertEndOfLineToChars: t } = On(), s = st(), i = yi(), { fill: r, cursor: u, indent: a } = Ln(), { isConcat: c, getDocParts: l } = jn(), h, g = 1, y = 2;
          function p() {
          ...
          function N(v, B, w) {
            let I = B.type === "dedent" ? v.queue.slice(0, -1) : [...v.queue, B], E = "", D = 0, m = 0, d = 0;
            for (let O of I)
              switch (O.type) {
                case "indent":
          ...
          function A(v, B, w, I, E, D) {
            ...
            for (; w >= 0; ) {
              ...
              if (typeof S == "string")
                ...
                switch (S.type) {
                  case "indent":
                    d.push([f(x, I), F, S.contents]);
                    break;
                  case "align":
                    d.push([C(x, S.n, I), F, S.contents]);
                    break;
                  case "trim":
                    w += T(o);
                    break;
                  case "group": {
                    if (D && S.break)
                      return false;
                    let k = S.break ? g : F;
                    d.push([x, k, S.expandedStates && k === g ? s(S.expandedStates) : S.contents]), S.id && (h[S.id] = k);
                    break;
                  }
                  case "fill":
                    for (let k = S.parts.length - 1; k >= 0; k--)
                      d.push([x, F, S.parts[k]]);
                    break;
                  case "if-break":
                  case "indent-if-break": {
                    let k = S.groupId ? h[S.groupId] : F;
                    if (k === g) {
                      let P = S.type === "if-break" ? S.breakContents : S.negate ? S.contents : a(S.contents);
                      P && d.push([x, F, P]);
                    }
                    if (k === y) {
                      let P = S.type === "if-break" ? S.flatContents : S.negate ? a(S.contents) : S.contents;
                      P && d.push([x, F, P]);
                    }
                    break;
                  }
          ...
          function b(v, B) {
            h = {};
            let w = B.printWidth, I = t(B.endOfLine), E = 0, D = [[p(), g, v]], m = [], d = false, o = [];
            for (; D.length > 0; ) {
              let [F, S, k] = D.pop();
              if (typeof k == "string") {
                let P = I !== `
` ? k.replace(/\n/g, I) : k;
                ...
                switch (k.type) {
                  ...
                  case "group":
                    switch (S) {
                      case y:
                        if (!d) {
                          D.push([F, k.break ? g : y, k.contents]);
                          break;
                        }
                      case g: {
                        d = false;
                        let P = [F, y, k.contents], O = w - E, R = o.length > 0;
                        if (!k.break && A(P, D, O, B, R))
                          D.push(P);
                          ...
                          if (k.break) {
                            ...
                            for (let H = 1; H < k.expandedStates.length + 1; H++)
                              if (H >= k.expandedStates.length) {
                                ...
                                let _ = k.expandedStates[H], G = [F, y, _];
                                if (A(G, D, O, B, R)) {
                                  D.push(G);
                                  break;
                                }
                  ...
                  case "fill": {
                    ...
                    if (O.length === 0)
                      break;
                    let [R, M] = O, H = [F, y, R], _ = [F, g, R], G = A(H, [], P, B, o.length > 0, true);
                    if (O.length === 1) {
                      G ? D.push(H) : D.push(_);
                      break;
                    }
                    let re = [F, y, M], $ = [F, g, M];
                    if (O.length === 2) {
                      G ? D.push(re, H) : D.push($, _);
                      break;
                    }
                    O.splice(0, 2);
                    let W = [F, S, r(O)], ee = O[0];
                    A([F, y, [R, M, ee]], [], P, B, o.length > 0, true) ? D.push(W, re, H) : G ? D.push(W, $, H) : D.push(W, $, _);
                    break;
                  }
                  case "if-break":
                  case "indent-if-break": {
                    let P = k.groupId ? h[k.groupId] : S;
                    if (P === g) {
                  ...
                  case "line":
                    switch (S) {
                      ...
                      case g:
                        ...
                        k.literal ? F.root ? (m.push(I, F.root.value), E = F.root.length) : (m.push(I), E = 0) : (E -= T(m), m.push(I + F.value), E = F.length);
                        break;
                    }
                    break;
                  case "label":
            ...
            let x = m.indexOf(u.placeholder);
            if (x !== -1) {
              let F = m.indexOf(u.placeholder, x + 1), S = m.slice(0, x).join(""), k = m.slice(x + 1, F).join(""), P = m.slice(F + 1).join("");
              return { formatted: S + k + P, cursorNodeStart: S.length, cursorNodeText: k };
            }
          ...
          function r(u) {
            ...
            function l(g, y, p) {
              ...
              if (t(g)) {
                let f = s(g).map(l).filter(Boolean);
                return f.length === 1 ? f[0] : "[".concat(f.join(", "), "]");
              }
              if (g.type === "line") {
                let f = Array.isArray(p) && p[y + 1] && p[y + 1].type === "break-parent";
                return g.literal ? f ? "literalline" : "literallineWithoutBreakParent" : g.hard ? f ? "hardline" : "hardlineWithoutBreakParent" : g.soft ? "softline" : "line";
              }
              if (g.type === "break-parent")
                return Array.isArray(p) && p[y - 1] && p[y - 1].type === "line" && p[y - 1].hard ? void 0 : "breakParent";
              if (g.type === "trim")
                return "trim";
              if (g.type === "indent")
                return "indent(" + l(g.contents) + ")";
              if (g.type === "align")
                return g.n === Number.NEGATIVE_INFINITY ? "dedentToRoot(" + l(g.contents) + ")" : g.n < 0 ? "dedent(" + l(g.contents) + ")" : g.n.type === "root" ? "markAsRoot(" + l(g.contents) + ")" : "align(" + JSON.stringify(g.n) + ", " + l(g.contents) + ")";
              if (g.type === "if-break")
                return "ifBreak(" + l(g.breakContents) + (g.flatContents ? ", " + l(g.flatContents) : "") + (g.groupId ? (g.flatContents ? "" : ', ""') + ", { groupId: ".concat(h(g.groupId), " }") : "") + ")";
              if (g.type === "indent-if-break") {
                let f = [];
                g.negate && f.push("negate: true"), g.groupId && f.push("groupId: ".concat(h(g.groupId)));
                let C = f.length > 0 ? ", { ".concat(f.join(", "), " }") : "";
                return "indentIfBreak(".concat(l(g.contents)).concat(C, ")");
              }
              if (g.type === "group") {
                let f = [];
                g.break && g.break !== "propagated" && f.push("shouldBreak: true"), g.id && f.push("id: ".concat(h(g.id)));
                let C = f.length > 0 ? ", { ".concat(f.join(", "), " }") : "";
                return g.expandedStates ? "conditionalGroup([".concat(g.expandedStates.map((N) => l(N)).join(","), "]").concat(C, ")") : "group(".concat(l(g.contents)).concat(C, ")");
              }
              if (g.type === "fill")
                return "fill([".concat(g.parts.map((f) => l(f)).join(", "), "])");
              if (g.type === "line-suffix")
                return "lineSuffix(" + l(g.contents) + ")";
              if (g.type === "line-suffix-boundary")
                return "lineSuffixBoundary";
              if (g.type === "label")
                return "label(".concat(JSON.stringify(g.label), ", ").concat(l(g.contents), ")");
              throw new Error("Unknown doc type " + g.type);
            }
            function h(g) {
              if (typeof g != "symbol")
                return JSON.stringify(String(g));
              if (g in a)
                return a[g];
              let y = String(g).slice(7, -1) || "symbol";
              for (let p = 0; ; p++) {
                let f = y + (p > 0 ? " #".concat(p) : "");
                if (!c.has(f))
                  return c.add(f), a[g] = "Symbol.for(".concat(JSON.stringify(f), ")");
              }
            }
          }
        ...
        } }), aD = Z({ "node_modules/escape-string-regexp/index.js"(e, n) {
          "use strict";
          ae(), n.exports = (t) => {
            if (typeof t != "string")
          ...
          e = n.exports = {};
          var i = e.re = [], r = e.src = [], u = e.t = {}, a = 0, c = (l, h, g) => {
            let y = a++;
            s(y, h), u[l] = y, r[y] = h, i[y] = new RegExp(h, g ? "g" : void 0);
          };
          ...
          var t = hi(), { MAX_LENGTH: s, MAX_SAFE_INTEGER: i } = Ci(), { re: r, t: u } = iD(), a = oD(), { compareIdentifiers: c } = cD(), l = class {
            constructor(h, g) {
              ...
              t("SemVer", h, g), this.options = g, this.loose = !!g.loose, this.includePrerelease = !!g.includePrerelease;
              let y = h.trim().match(g.loose ? r[u.LOOSE] : r[u.FULL]);
              if (!y)
                throw new TypeError("Invalid Version: ".concat(h));
            ...
            compareMain(h) {
              return h instanceof l || (h = new l(h, this.options)), c(this.major, h.major) || c(this.minor, h.minor) || c(this.patch, h.patch);
            }
            comparePre(h) {
              if (h instanceof l || (h = new l(h, this.options)), this.prerelease.length && !h.prerelease.length)
                return -1;
              ...
              let g = 0;
              do {
                let y = this.prerelease[g], p = h.prerelease[g];
                if (t("prerelease compare", g, y, p), y === void 0 && p === void 0)
                  return 0;
                if (p === void 0)
                  return 1;
                if (y === void 0)
            ...
            compareBuild(h) {
              ...
              let g = 0;
              do {
                let y = this.build[g], p = h.build[g];
                if (t("prerelease compare", g, y, p), y === void 0 && p === void 0)
                  return 0;
                if (p === void 0)
                  return 1;
            ...
            inc(h, g) {
              switch (h) {
                case "premajor":
                  this.prerelease.length = 0, this.patch = 0, this.minor = 0, this.major++, this.inc("pre", g);
                  break;
                case "preminor":
                ...
                case "pre":
                  ...
                  g && (this.prerelease[0] === g ? isNaN(this.prerelease[1]) && (this.prerelease = [g, 0]) : this.prerelease = [g, 0]);
                  break;
                default:
          ...
          var c = /^[ \t]*(?:\r\n|\r|\n)/, l = /(?:\r\n|\r|\n)[ \t]*$/, h = /^(?:[\r\n]|$)/, g = /(?:\r\n|\r|\n)([ \t]*)(?:[^ \t\r\n]|$)/, y = /^[ \t]*[\r\n][ \t\r\n]*$/;
          function p(A, b, v) {
            var B = 0, w = A[0].match(g);
            w && (B = w[1].length);
            var I = "(\\r\\n|\\r|\\n).{0," + B + "}", E = new RegExp(I, "g");
            b && (A = A.slice(1));
            var D = v.newline, m = v.trimLeadingNewline, d = v.trimTrailingNewline, o = typeof D == "string", x = A.length, F = A.map(function(S, k) {
              return S = S.replace(E, "$1"), k === 0 && m && (S = S.replace(c, "")), k === x - 1 && d && (S = S.replace(l, "")), o && (S = S.replace(/\r\n|\n|\r/g, function(P) {
                return D;
              })), S;
            });
            return F;
          ...
          function N(A) {
            ...
            function B(I) {
              for (var E = [], D = 1; D < arguments.length; D++)
                E[D - 1] = arguments[D];
              if (C(I)) {
                var m = I, d = (E[0] === B || E[0] === T) && y.test(m[0]) && h.test(m[1]), o = d ? v : b, x = o.get(m);
                if (x || (x = p(m, d, A), o.set(m, x)), E.length === 0)
                  return x[0];
                var F = f(x, d ? E.slice(1) : E);
                return F;
              } else
                return N(a(a({}, A), I || {}));
            }
          ...
          "use strict";
          ae();
          var { outdent: t } = mD(), s = "Config", i = "Editor", r = "Format", u = "Other", a = "Output", c = "Global", l = "Special", h = { cursorOffset: { since: "1.4.0", category: l, type: "int", default: -1, range: { start: -1, end: Number.POSITIVE_INFINITY, step: 1 }, description: t(si || (si = wt([`
    ...
    `]))), cliCategory: u }, tabWidth: { type: "int", category: c, default: 2, description: "Number of spaces per indentation level.", range: { start: 0, end: Number.POSITIVE_INFINITY, step: 1 } }, useTabs: { since: "1.0.0", category: c, type: "boolean", default: false, description: "Indent with tabs instead of spaces." }, embeddedLanguageFormatting: { since: "2.1.0", category: c, type: "choice", default: [{ since: "2.1.0", value: "auto" }], description: "Control how Prettier formats quoted code embedded in the file.", choices: [{ value: "auto", description: "Format embedded code if Prettier can automatically identify it." }, { value: "off", description: "Never automatically format embedded code." }] } };
          n.exports = { CATEGORY_CONFIG: s, CATEGORY_EDITOR: i, CATEGORY_FORMAT: r, CATEGORY_OTHER: u, CATEGORY_OUTPUT: a, CATEGORY_GLOBAL: c, CATEGORY_SPECIAL: l, options: h };
        } }), Mn = Z({ "src/main/support.js"(e, n) {
          "use strict";
          ae();
          var t = { compare: qn(), lt: pD(), gte: fD() }, s = DD(), i = gi().version, r = dD().options;
          function u() {
            let { plugins: c = [], showUnreleased: l = false, showDeprecated: h = false, showInternal: g = false } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, y = i.split("-", 1)[0], p = c.flatMap((A) => A.languages || []).filter(C), f = s(Object.assign({}, ...c.map((A) => {
              let { options: b } = A;
              return b;
            }), r), "name").filter((A) => C(A) && N(A)).sort((A, b) => A.name === b.name ? 0 : A.name < b.name ? -1 : 1).map(T).map((A) => {
              A = Object.assign({}, A), Array.isArray(A.default) && (A.default = A.default.length === 1 ? A.default[0].value : A.default.filter(C).sort((v, B) => t.compare(B.since, v.since))[0].value), Array.isArray(A.choices) && (A.choices = A.choices.filter((v) => C(v) && N(v)), A.name === "parser" && a(A, p, c));
            ...
            function C(A) {
              return l || !("since" in A) || A.since && t.gte(y, A.since);
            }
            function N(A) {
          ...
          function a(c, l, h) {
            let g = new Set(c.choices.map((y) => y.value));
            for (let y of l)
              if (y.parsers) {
                for (let p of y.parsers)
                  if (!g.has(p)) {
                    g.add(p);
                    let f = h.find((N) => N.parsers && N.parsers[p]), C = y.name;
                    f && f.name && (C += " (plugin: ".concat(f.name, ")")), c.choices.push({ value: p, description: C });
                  }
              }
          }
...
` || a === "\r" || a === "\u2028" || a === "\u2029")
          ...
          function u(a, c) {
            let l = null, h = c;
            for (; h !== l; )
              l = h, h = r(a, h), h = t(a, h), h = i(a, h), h = s(a, h);
            return h;
          }
          n.exports = u;
          ...
          "use strict";
          ae();
          var t = aD(), s = st(), { getSupportInfo: i } = Mn(), r = Rn(), u = yi(), { skipWhitespace: a, skipSpaces: c, skipToLineEnd: l, skipEverythingButNewLine: h } = Tr(), g = Ei(), y = vi(), p = Fi(), f = gD(), C = ($) => $[$.length - 2];
          function N($) {
            return (W, ee, U) => {
...
`)
          ...
          function v($, W) {
            let ee = null, U = W;
            for (; U !== ee; )
              ee = U, U = l($, U), U = g($, U), U = c($, U);
            return U = y($, U), U = p($, U), U !== false && T($, U);
          }
          function B($, W, ee) {
            return v($, ee(W));
          }
...
`);
          ...
          function o($, W) {
            let ee = $.slice(1, -1), U = W.parser === "json" || W.parser === "json5" && W.quoteProps === "preserve" && !W.singleQuote ? '"' : W.__isInHtmlAttribute ? "'" : d(ee, W.singleQuote ? "'" : '"').quote;
          ...
          function O($, W) {
            W.leading = true, W.trailing = false, P($, W);
          }
          function R($, W, ee) {
            W.leading = false, W.trailing = false, ee && (W.marker = ee), P($, W);
          }
          function M($, W) {
            W.leading = false, W.trailing = true, P($, W);
          }
          function H($, W) {
        ...
        function bi(e, n) {
          ...
          function t(l) {
            for (var h = 0; h < l.length && l[h] === ""; h++)
              ;
            for (var g = l.length - 1; g >= 0 && l[g] === ""; g--)
              ;
            return h > g ? [] : l.slice(h, g - h + 1);
          }
        ...
        var Di, Br, xn, bn, wi, Pi, yD = br({ "node-modules-polyfills:path"() {
          ae(), Di = /^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/, Br = function(e) {
            return Di.exec(e).slice(1);
          }, xn = "/", bn = ":", wi = { extname: Ni, basename: Bi, dirname: Ti, sep: xn, delimiter: bn, relative: bi, join: xi, isAbsolute: Wn, normalize: Vn, resolve: xr }, Pi = "ab".substr(-1) === "b" ? function(e, n, t) {
            return e.substr(n, t);
          } : function(e, n, t) {
            return n < 0 && (n = e.length + n), e.substr(n, t);
          };
        } }), _i = Z({ "node-modules-polyfills-commonjs:path"(e, n) {
          ae();
          var t = (yD(), pt(Ai));
          if (t && t.default) {
            n.exports = t.default;
        ...
        kn(Dt, { __assign: () => Sr, __asyncDelegator: () => wD, __asyncGenerator: () => ND, __asyncValues: () => PD, __await: () => Gt, __awaiter: () => AD, __classPrivateFieldGet: () => LD, __classPrivateFieldSet: () => OD, __createBinding: () => xD, __decorate: () => ED, __exportStar: () => bD, __extends: () => hD, __generator: () => SD, __importDefault: () => kD, __importStar: () => ID, __makeTemplateObject: () => _D, __metadata: () => FD, __param: () => vD, __read: () => Ii, __rest: () => CD, __spread: () => TD, __spreadArrays: () => BD, __values: () => Tn });
        function hD(e, n) {
          Ar(e, n);
          function t() {
            this.constructor = e;
        ...
        function AD(e, n, t, s) {
          ...
          return new (t || (t = Promise))(function(r, u) {
            ...
            function l(h) {
              h.done ? r(h.value) : i(h.value).then(a, c);
            }
        ...
        function ND(e, n, t) {
          ...
          function c(y) {
            y.value instanceof Gt ? Promise.resolve(y.value.v).then(l, h) : g(r[0][2], y);
          }
          function l(y) {
            a("next", y);
          }
          ...
          function g(y, p) {
            y(p), r.shift(), r.length && a(r[0][0], r[0][1]);
          }
        }
        function wD(e) {
          var n, t;
        ...
        var Ar, Sr, gt = br({ "node_modules/tslib/tslib.es6.js"() {
          ...
          n.exports = function(i, r) {
            ...
            if (a -= l, c -= l, a === 0)
              return c;
            for (var h, g, y, p, f = 0, C = 0; f < a; )
              s[l + f] = i.charCodeAt(l + f), t[f] = ++f;
            for (; C < c; )
              for (h = r.charCodeAt(l + C), y = C++, g = C, f = 0; f < a; f++)
                p = h === s[l + f] ? y : y + 1, y = t[f], g = t[f] = y > g ? p > g ? g + 1 : p : p > y ? y + 1 : p;
            return g;
          };
          ...
          e.levenUnknownHandler = (s, i, r) => {
            let { descriptor: u, logger: a, schemas: c } = r, l = ["Ignored unknown option ".concat(n.default.yellow(u.pair({ key: s, value: i })), ".")], h = Object.keys(c).sort().find((g) => t(s, g) < 3);
          ...
          var n = (gt(), pt(Dt)), t = yt(), s = class extends t.Schema {
            ...
            redirect(r, u) {
              ...
              for (let l of r) {
                ...
                "remain" in h && a.push(h.remain), c.push(...h.redirect.map(i));
              }
          ...
          function s() {
            ...
            return (f) => {
              ...
              return p[C] ? true : (p[C] = true, false);
            };
          }
          ...
          function u(p, f) {
            if (p === f)
              return 0;
            let C = typeof p, N = typeof f, T = ["undefined", "object", "boolean", "number", "string"];
            return C !== N ? T.indexOf(C) - T.indexOf(N) : C !== "string" ? Number(p) - Number(f) : p.localeCompare(f);
          }
          ...
          function l(p, f) {
            ...
            return p === false ? false : p === true ? C ? true : [{ value: f }] : "value" in p ? [p] : p.length === 0 ? false : p;
          }
          ...
          e.normalizeForwardResult = g;
          function y(p, f) {
            let C = g(typeof p == "object" && "redirect" in p ? p.redirect : p, f);
            return C.length === 0 ? { remain: f, redirect: C } : typeof p == "object" && "remain" in p ? { remain: p.remain, redirect: C } : { redirect: C };
          }
          e.normalizeRedirectResult = y;
          ...
          var s = class {
            constructor(i, r) {
              let { logger: u = console, descriptor: a = n.defaultDescriptor, unknown: c = n.defaultUnknownHandler, invalid: l = n.defaultInvalidHandler, deprecated: h = n.defaultDeprecatedHandler } = r || {};
              this._utils = { descriptor: a, logger: u || { warn: () => {
              } }, schemas: t.recordFromArray(i, "name"), normalizeDefaultResult: t.normalizeDefaultResult, normalizeDeprecatedResult: t.normalizeDeprecatedResult, normalizeForwardResult: t.normalizeForwardResult, normalizeRedirectResult: t.normalizeRedirectResult, normalizeValidateResult: t.normalizeValidateResult }, this._unknownHandler = c, this._invalidHandler = l, this._deprecatedHandler = h, this.cleanHistory();
            }
            cleanHistory() {
            ...
            _applyNormalization(i, r) {
              ...
              for (let l of a) {
                let h = this._utils.schemas[l], g = h.preprocess(i[l], this._utils), y = t.normalizeValidateResult(h.validate(g, this._utils), g);
                if (y !== true) {
                  let { value: T } = y, A = this._invalidHandler(l, T, this._utils);
                ...
                let p = (T) => {
                  ...
                  let { value: A, redirectTo: b } = T, v = t.normalizeDeprecatedResult(h.deprecated(A, this._utils), g, true);
                  if (v !== false)
                    if (v === true)
                ...
                t.normalizeForwardResult(h.forward(g, this._utils), g).forEach(p);
                let N = t.normalizeRedirectResult(h.redirect(g, this._utils), g);
              ...
              for (let l of c) {
                let h = i[l], g = this._unknownHandler(l, h, this._utils);
                if (g)
                  for (let y of Object.keys(g)) {
                    let p = { [y]: g[y] };
                    y in this._utils.schemas ? u.push(p) : Object.assign(r, p);
                  }
              }
              return u;
            }
          ...
          "use strict";
          ae();
          var t = ZD(), s = st(), i = { key: (y) => y.length === 1 ? "-".concat(y) : "--".concat(y), value: (y) => t.apiDescriptor.value(y), pair: (y) => {
            let { key: p, value: f } = y;
            return f === false ? "--no-".concat(p) : f === true ? i.key(p) : f === "" ? "".concat(i.key(p), " without an argument") : "".concat(i.key(p), "=").concat(f);
          } }, r = (y) => {
            let { colorsModule: p, levenshteinDistance: f } = y;
          ...
          function a(y, p) {
            let { logger: f, isCLI: C = false, passThrough: N = false, colorsModule: T, levenshteinDistance: A } = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, b = N ? Array.isArray(N) ? (D, m) => N.includes(D) ? { [D]: m } : void 0 : (D, m) => ({ [D]: m }) : (D, m, d) => {
              let o = d.schemas, { _: x } = o, F = Pn(o, Xf);
              return t.levenUnknownHandler(D, m, Object.assign(Object.assign({}, d), {}, { schemas: F }));
            }, v = C ? i : t.apiDescriptor, B = c(p, { isCLI: C, colorsModule: T, levenshteinDistance: A }), w = new t.Normalizer(B, { logger: f, unknown: b, descriptor: v }), I = f !== false;
            I && u && (w._hasDeprecationWarned = u);
            let E = w.normalize(y);
            return I && (u = w._hasDeprecationWarned), C && E["plugin-search"] === false && (E["plugin-search-dir"] = false), E;
          }
          function c(y, p) {
            let { isCLI: f, colorsModule: C, levenshteinDistance: N } = p, T = [];
            f && T.push(t.AnySchema.create({ name: "_" }));
            for (let A of y)
              T.push(l(A, { isCLI: f, optionInfos: y, colorsModule: C, levenshteinDistance: N })), A.alias && f && T.push(t.AliasSchema.create({ name: A.alias, sourceName: A.name }));
            return T;
          }
          function l(y, p) {
            let { isCLI: f, optionInfos: C, colorsModule: N, levenshteinDistance: T } = p, { name: A } = y;
            ...
            switch (y.type) {
              ...
              case "string":
                ...
                break;
              case "choice":
                v = t.ChoiceSchema, b.choices = y.choices.map((w) => typeof w == "object" && w.redirect ? Object.assign(Object.assign({}, w), {}, { redirect: { to: { key: y.name, value: w.redirect } } }) : w);
                break;
              case "boolean":
                v = t.BooleanSchema;
                break;
              case "flag":
                v = r({ colorsModule: N, levenshteinDistance: T }), b.flags = C.flatMap((w) => [w.alias, w.description && w.name, w.oppositeDescription && "no-".concat(w.name)].filter(Boolean));
                break;
              case "path":
                v = t.StringSchema;
                break;
              default:
                throw new Error("Unexpected type ".concat(y.type));
            }
            if (y.exception ? b.validate = (w, I, E) => y.exception(w) || I.validate(w, E) : b.validate = (w, I, E) => w === void 0 || I.validate(w, E), y.redirect && (B.redirect = (w) => w ? { to: { key: y.redirect.option, value: y.redirect.value } } : void 0), y.deprecated && (B.deprecated = true), f && !y.array) {
              let w = b.preprocess || ((I) => I);
              b.preprocess = (I, E, D) => E.preprocess(w(Array.isArray(I) ? s(I) : I), D);
            }
            return y.array ? t.ArraySchema.create(Object.assign(Object.assign(Object.assign({}, f ? { preprocess: (w) => Array.isArray(w) ? w : [w] } : {}), B), {}, { valueSchema: v.create(b) })) : v.create(Object.assign(Object.assign({}, b), B));
          }
          function h(y, p, f) {
            return a(y, p, f);
          }
          function g(y, p, f) {
            return a(y, p, Object.assign({ isCLI: true }, f));
          }
          n.exports = { normalizeApiOptions: h, normalizeCliOptions: g };
          ...
          function s(c, l) {
            ...
            if (!h) {
              let g = c.declaration && c.declaration.decorators || c.decorators;
              if (t(g))
                return s(g[0]);
            }
          ...
          function u(c, l) {
            let h = i(c);
            return Number.isInteger(h) && h === i(l);
          }
          function a(c, l) {
            return r(c, l) && u(c, l);
          }
          ...
          var i = /\r\n|[\n\r\u2028\u2029]/;
          function r(c, l, h) {
            let g = Object.assign({ column: 0, line: -1 }, c.start), y = Object.assign({}, g, c.end), { linesAbove: p = 2, linesBelow: f = 3 } = h || {}, C = g.line, N = g.column, T = y.line, A = y.column, b = Math.max(C - (p + 1), 0), v = Math.min(l.length, T + f);
            ...
            if (B)
              ...
              N === A ? N ? w[C] = [N, 0] : w[C] = true : w[C] = [N, A - N];
            return { start: b, end: v, markerLines: w };
          }
          function u(c, l) {
            let h = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, g = (h.highlightCode || h.forceColor) && (0, n.shouldHighlight)(h), y = (0, n.getChalk)(h), p = s(y), f = (I, E) => g ? I(E) : E, C = c.split(i), { start: N, end: T, markerLines: A } = r(l, C, h), b = l.start && typeof l.start.column == "number", v = String(T).length, w = (g ? (0, n.default)(c, h) : c).split(i, T).slice(N, T).map((I, E) => {
              let D = N + 1 + E, m = " ".concat(D).slice(-v), d = " ".concat(m, " |"), o = A[D], x = !A[D + 1];
              if (o) {
                let F = "";
                if (Array.isArray(o)) {
                  let S = I.slice(0, Math.max(o[0] - 1, 0)).replace(/[^\t]/g, " "), k = o[1] || 1;
                  F = [`
 `, f(p.gutter, d.replace(/\d/g, " ")), " ", S, f(p.marker, "^").repeat(k)].join(""), x && h.message && (F += " " + f(p.message, h.message));
                }
                return [f(p.marker, ">"), f(p.gutter, d), I.length > 0 ? " ".concat(I) : "", F].join("");
              } else
                return " ".concat(f(p.gutter, d)).concat(I.length > 0 ? " ".concat(I) : "");
            }).join(`
`);
            return h.message && !b && (w = "".concat(" ".repeat(v + 1)).concat(h.message, `
`).concat(w)), g ? y.reset(w) : w;
          }
          function a(c, l, h) {
            ...
            return h = Math.max(h, 0), u(c, { start: { column: h, line: l } }, g);
          }
        } }), Gn = Z({ "src/main/parser.js"(e, n) {
          "use strict";
          ae();
          var t = _i(), { ConfigError: s } = Jt(), i = nt(), { locStart: r, locEnd: u } = i, a = Object.getOwnPropertyNames, c = Object.getOwnPropertyDescriptor;
          function l(y) {
            let p = {};
            for (let f of y.plugins)
              if (!!f.parsers)
                for (let C of a(f.parsers))
                  Object.defineProperty(p, C, c(f.parsers, C));
            return p;
          }
          function h(y) {
            let p = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : l(y);
            if (typeof y.parser == "function")
              return { parse: y.parser, astFormat: "estree", locStart: r, locEnd: u };
            if (typeof y.parser == "string") {
              if (Object.prototype.hasOwnProperty.call(p, y.parser))
                return p[y.parser];
              throw new s(`Couldn't resolve parser "`.concat(y.parser, '". Parsers must be explicitly added to the standalone bundle.'));
            }
          }
          function g(y, p) {
            let f = l(p), C = Object.defineProperties({}, Object.fromEntries(Object.keys(f).map((T) => [T, { enumerable: true, get() {
              return f[T].parse;
            } }]))), N = h(p, f);
            try {
              return N.preprocess && (y = N.preprocess(y, p)), { text: y, ast: N.parse(y, C, p) };
            } catch (T) {
              let { loc: A } = T;
              if (A) {
                let { codeFrameColumns: b } = rm();
                throw T.codeFrame = b(y, A, { highlightCode: true }), T.message += `
` + T.codeFrame, T;
              }
              throw T.stack;
            }
          }
          n.exports = { parse: g, resolveParser: h };
        } }), Mi = Z({ "src/main/options.js"(e, n) {
          "use strict";
          ae();
          var t = _i(), { UndefinedParserError: s } = Jt(), { getSupportInfo: i } = Mn(), r = em(), { resolveParser: u } = Gn(), a = { astFormat: "estree", printer: {}, originalText: void 0, locStart: null, locEnd: null };
          function c(g) {
            let y = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, p = Object.assign({}, g), f = i({ plugins: g.plugins, showUnreleased: true, showDeprecated: true }).options, C = Object.assign(Object.assign({}, a), Object.fromEntries(f.filter((v) => v.default !== void 0).map((v) => [v.name, v.default])));
            if (!p.parser) {
              if (!p.filepath)
            ...
            let A = Object.fromEntries(f.filter((v) => v.pluginDefaults && v.pluginDefaults[T.name] !== void 0).map((v) => [v.name, v.pluginDefaults[T.name]])), b = Object.assign(Object.assign({}, C), A);
            for (let [v, B] of Object.entries(b))
              (p[v] === null || p[v] === void 0) && (p[v] = B);
            return p.parser === "json" && (p.trailingComma = "none"), r.normalizeApiOptions(p, f, Object.assign({ passThrough: Object.keys(a) }, y));
          }
          function l(g) {
            let { astFormat: y } = g;
            if (!y)
              throw new Error("getPlugin() requires astFormat to be set");
            let p = g.plugins.find((f) => f.printers && f.printers[y]);
            if (!p)
              throw new Error(`Couldn't find plugin for AST format "`.concat(y, '"'));
            return p;
          }
          function h(g, y) {
            let p = t.basename(g).toLowerCase(), C = i({ plugins: y }).languages.filter((N) => N.since !== null).find((N) => N.extensions && N.extensions.some((T) => p.endsWith(T)) || N.filenames && N.filenames.some((T) => T.toLowerCase() === p));
            return C && C.parsers[0];
          }
          n.exports = { normalize: c, hiddenDefaults: a, inferParser: h };
          ...
          function t(s, i, r) {
            ...
            let c = {};
            for (let [l, h] of Object.entries(s))
              !a.has(l) && typeof h != "function" && (c[l] = t(h, i, s));
            if (u) {
              let l = u(s, c, r);
              if (l === null)
                return;
          ...
          "use strict";
          ae();
          var t = Ut(), { builders: { line: s, hardline: i, breakParent: r, indent: u, lineSuffix: a, join: c, cursor: l } } = Le(), { hasNewline: h, skipNewline: g, skipSpaces: y, isPreviousLineEmpty: p, addLeadingComment: f, addDanglingComment: C, addTrailingComment: N } = Ge(), T = /* @__PURE__ */ new WeakMap();
          function A(O, R, M) {
            if (!O)
              return;
            let { printer: H, locStart: _, locEnd: G } = R;
            if (M) {
              if (H.canAttachComment && H.canAttachComment(O)) {
                let $;
                for ($ = M.length - 1; $ >= 0 && !(_(M[$]) <= _(O) && G(M[$]) <= G(O)); --$)
                  ;
                M.splice($ + 1, 0, O);
                return;
              }
          ...
          function b(O, R, M, H) {
            let { locStart: _, locEnd: G } = M, re = _(R), $ = G(R), W = A(O, M), ee, U, ne = 0, se = W.length;
            for (; ne < se; ) {
              let V = ne + se >> 1, oe = W[V], K = _(oe), Ee = G(oe);
              if (K <= re && $ <= Ee)
                return b(oe, R, M, oe);
              if (Ee <= re) {
                ee = oe, ne = V + 1;
            ...
            if (H && H.type === "TemplateLiteral") {
              let { quasis: V } = H, oe = d(V, R, M);
              ee && d(V, ee, M) !== oe && (ee = null), U && d(V, U, M) !== oe && (U = null);
            }
          ...
          function B(O, R, M, H) {
            if (!Array.isArray(O))
              return;
            let _ = [], { locStart: G, locEnd: re, printer: { handleComments: $ = {} } } = H, { avoidAstMutation: W, ownLine: ee = v, endOfLine: U = v, remaining: ne = v } = $, se = O.map((V, oe) => Object.assign(Object.assign({}, b(R, V, H)), {}, { comment: V, text: M, options: H, ast: R, isLastComment: O.length - 1 === oe }));
            for (let [V, oe] of se.entries()) {
              ...
              if (W ? ve = [oe] : (K.enclosingNode = q, K.precedingNode = Ee, K.followingNode = le, ve = [K, ue, Q, de, ge]), I(ue, Q, se, V))
                K.placement = "ownLine", ee(...ve) || (le ? f(le, K) : Ee ? N(Ee, K) : C(q || de, K));
              else if (E(ue, Q, se, V))
                K.placement = "endOfLine", U(...ve) || (Ee ? N(Ee, K) : le ? f(le, K) : C(q || de, K));
              else if (K.placement = "remaining", !ne(...ve))
                if (Ee && le) {
                  let xe = _.length;
                  xe > 0 && _[xe - 1].followingNode !== le && D(_, ue, Q), _.push(oe);
                } else
                  Ee ? N(Ee, K) : le ? f(le, K) : C(q || de, K);
            }
            if (D(_, M, H), !W)
              for (let V of O)
          ...
          var w = (O) => !/[\S\n\u2028\u2029]/.test(O);
          function I(O, R, M, H) {
            let { comment: _, precedingNode: G } = M[H], { locStart: re, locEnd: $ } = R, W = re(_);
            if (G)
            ...
            return h(O, W, { backwards: true });
          }
          function E(O, R, M, H) {
            let { comment: _, followingNode: G } = M[H], { locStart: re, locEnd: $ } = R, W = $(_);
            if (G)
          ...
          function D(O, R, M) {
            ...
            if (H === 0)
              return;
            let { precedingNode: _, followingNode: G, enclosingNode: re } = O[0], $ = M.printer.getGapRegex && M.printer.getGapRegex(re) || /^[\s(]*$/, W = M.locStart(G), ee;
            for (ee = H; ee > 0; --ee) {
              let { comment: U, precedingNode: ne, followingNode: se } = O[ee - 1];
              t.strictEqual(ne, _), t.strictEqual(se, G);
          ...
          function o(O, R) {
            let M = O.getValue(), H = [m(O, R)], { printer: _, originalText: G, locStart: re, locEnd: $ } = R;
            if (_.isBlockComment && _.isBlockComment(M)) {
              let U = h(G, $(M)) ? h(G, re(M), { backwards: true }) ? i : s : " ";
              H.push(U);
            } else
              H.push(i);
            let ee = g(G, y(G, $(M)));
            return ee !== false && h(G, ee) && H.push(i), H;
          }
          function x(O, R) {
            let M = O.getValue(), H = m(O, R), { printer: _, originalText: G, locStart: re } = R, $ = _.isBlockComment && _.isBlockComment(M);
            if (h(G, re(M), { backwards: true })) {
              let ee = p(G, M, re);
              return a([i, ee ? i : "", H]);
            }
            let W = [" ", H];
          ...
          function F(O, R, M, H) {
            ...
            return !G || !G.comments || (O.each(() => {
              let re = O.getValue();
              !re.leading && !re.trailing && (!H || H(re)) && _.push(m(O, R));
            }, "comments"), _.length === 0) ? "" : M ? c(i, _) : u([i, c(i, _)]);
          }
          function S(O, R, M) {
            let H = O.getValue();
            if (!H)
          ...
          function k(O, R, M, H) {
            let { leading: _, trailing: G } = S(O, M, H);
            return !_ && !G ? R : [_, R, G];
          }
          function P(O) {
            if (!!O)
          ...
          n.exports = { attach: B, printComments: k, printCommentsSeparately: S, printDanglingComments: F, getSortedChildNodes: A, ensureAllCommentsPrinted: P };
          ...
          var r = class {
            ...
            call(u) {
              ...
              for (var h = arguments.length, g = new Array(h > 1 ? h - 1 : 0), y = 1; y < h; y++)
                g[y - 1] = arguments[y];
              for (let f of g)
                l = l[f], a.push(f, l);
              let p = u(this);
            ...
            callParent(u) {
              let a = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, c = i(this.stack, a + 1), l = this.stack.splice(c + 1), h = u(this);
            ...
            map(u) {
              let a = [];
              for (var c = arguments.length, l = new Array(c > 1 ? c - 1 : 0), h = 1; h < c; h++)
                l[h - 1] = arguments[h];
              return this.each((g, y, p) => {
                a[y] = u(g, y, p);
              }, ...l), a;
            }
            try(u) {
            ...
            match() {
              ...
              for (var l = arguments.length, h = new Array(l), g = 0; g < l; g++)
                h[g] = arguments[g];
              for (let y of h) {
                if (c === void 0)
                  return false;
                let p = null;
                if (typeof a == "number" && (p = a, a = this.stack[u--], c = this.stack[u--]), y && !y(c, a, p))
                  return false;
            ...
            findAncestor(u) {
              ...
              for (; l; ) {
                let h = null;
                if (typeof c == "number" && (h = c, c = this.stack[a--], l = this.stack[a--]), c !== null && u(l, c, h))
                  return l;
          ...
          function r(a, c, l, h) {
            if (l.printer.embed && l.embeddedLanguageFormatting === "auto")
              return l.printer.embed(a, c, (g, y, p) => u(g, y, l, h, p), l);
          }
          function u(a, c, l, h) {
            let { stripTrailingHardline: g = false } = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : {}, y = s(Object.assign(Object.assign(Object.assign({}, l), c), {}, { parentParser: l.parser, originalText: a }), { passThrough: true }), p = Gn().parse(a, y), { ast: f } = p;
            a = p.text;
            let C = f.comments;
            delete f.comments, i.attach(C, f, a, y), y[Symbol.for("comments")] = C || [], y[Symbol.for("tokens")] = f.tokens || [];
            let N = h(f, y);
            return i.ensureAllCommentsPrinted(C), g ? typeof N == "string" ? N.replace(/(?:\r?\n)*$/, "") : t(N) : N;
          }
          ...
          function c(g, y) {
            let p = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 0, { printer: f } = y;
            f.preprocess && (g = f.preprocess(g, y));
            let C = /* @__PURE__ */ new Map(), N = new t(g), T = A();
            return p > 0 && (T = i([s, T], p, y.tabWidth)), r(T), T;
            function A(v, B) {
            ...
            function b(v) {
              ...
              if (w && C.has(B))
                return C.get(B);
              let I = h(N, y, A, v);
              return w && C.set(B, I), I;
            }
          }
          function l(g, y) {
            let { originalText: p, [Symbol.for("comments")]: f, locStart: C, locEnd: N } = y, T = C(g), A = N(g), b = /* @__PURE__ */ new Set();
            for (let v of f)
              C(v) >= T && N(v) <= A && (v.printed = true, b.add(v));
            return { doc: p.slice(T, A), printedComments: b };
          }
          function h(g, y, p, f) {
            let C = g.getValue(), { printer: N } = y, T, A;
            if (N.hasPrettierIgnore && N.hasPrettierIgnore(g))
              ({ doc: T, printedComments: A } = l(C, y));
            else {
              if (C)
                try {
                  T = a.printSubtree(g, p, y, c);
                } catch (b) {
            ...
            return (!N.willPrintOwnComments || !N.willPrintOwnComments(g, y)) && (T = u(g, T, y, A)), T;
          }
          n.exports = c;
          ...
          function r(f, C) {
            let N = [f.node, ...f.parentNodes], T = /* @__PURE__ */ new Set([C.node, ...C.parentNodes]);
            return N.find((A) => h.has(A.type) && T.has(A));
          }
          function u(f) {
            let C = f.length - 1;
            for (; ; ) {
          ...
          function a(f, C, N) {
            let { locStart: T, locEnd: A } = N, b = f.node, v = C.node;
            if (b === v)
          ...
          function l(f, C) {
            return C !== "DeclareExportDeclaration" && f !== "TypeParameterDeclaration" && (f === "Directive" || f === "TypeAlias" || f === "TSExportAssignment" || f.startsWith("Declare") || f.startsWith("TSDeclare") || f.endsWith("Statement") || f.endsWith("Declaration"));
          }
          var h = /* @__PURE__ */ new Set(["ObjectExpression", "ArrayExpression", "StringLiteral", "NumericLiteral", "BooleanLiteral", "NullLiteral", "UnaryExpression", "TemplateLiteral"]), g = /* @__PURE__ */ new Set(["OperationDefinition", "FragmentDefinition", "VariableDefinition", "TypeExtensionDefinition", "ObjectTypeDefinition", "FieldDefinition", "DirectiveDefinition", "EnumTypeDefinition", "EnumValueDefinition", "InputValueDefinition", "InputObjectTypeDefinition", "SchemaDefinition", "OperationTypeDefinition", "InterfaceTypeDefinition", "UnionTypeDefinition", "ScalarTypeDefinition"]);
          function y(f, C, N) {
            if (!C)
              return false;
            switch (f.parser) {
          ...
          function p(f, C, N) {
            ...
            if (!w)
              for (T += B; A > T && !/\S/.test(f[A - 1]); --A)
                ;
            let I = c(N, T, C, (d, o) => y(C, d, o), [], "rangeStart"), E = w ? I : c(N, A, C, (d) => y(C, d), [], "rangeEnd");
            if (!I || !E)
            ...
            if (i(C)) {
              ...
              ({ startNode: D, endNode: m } = a(I, E, C));
            return { rangeStart: Math.min(b(D), b(m)), rangeEnd: Math.max(v(D), v(m)) };
          }
          n.exports = { calculateRange: p, findNodeAtOffset: c };
        } }), om = Z({ "src/main/core.js"(e, n) {
          "use strict";
          ae();
          var { diffArrays: t } = rD(), { printer: { printDocToString: s }, debug: { printDocToDebug: i } } = Le(), { getAlignmentSize: r } = Ge(), { guessEndOfLine: u, convertEndOfLineToChars: a, countEndOfLineChars: c, normalizeEndOfLine: l } = On(), h = Mi().normalize, g = nm(), y = Qe(), p = Gn(), f = am(), C = im(), N = "\uFEFF", T = Symbol("cursor");
          function A(m, d, o) {
            let x = d.comments;
            return x && (delete d.comments, y.attach(x, d, m, o)), o[Symbol.for("comments")] = x || [], o[Symbol.for("tokens")] = d.tokens || [], o.originalText = m, x;
          }
          function b(m, d) {
            let o = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 0;
            if (!m || m.trim().length === 0)
              return { formatted: "", cursorOffset: -1, comments: [] };
            let { ast: x, text: F } = p.parse(m, d);
            if (d.cursorOffset >= 0) {
              let O = C.findNodeAtOffset(x, d.cursorOffset, d);
              O && O.node && (d.cursorNode = O.node);
            }
            let S = A(F, x, d), k = f(x, d, o), P = s(k, d);
            if (y.ensureAllCommentsPrinted(S), o > 0) {
              let O = P.formatted.trim();
              P.cursorNodeStart !== void 0 && (P.cursorNodeStart -= P.formatted.indexOf(O)), P.formatted = O + a(d.endOfLine);
            }
            if (d.cursorOffset >= 0) {
              let O, R, M, H, _;
              if (d.cursorNode && P.cursorNodeText ? (O = d.locStart(d.cursorNode), R = F.slice(O, d.locEnd(d.cursorNode)), M = d.cursorOffset - O, H = P.cursorNodeStart, _ = P.cursorNodeText) : (O = 0, R = F, M = d.cursorOffset, H = 0, _ = P.formatted), R === _)
                return { formatted: P.formatted, cursorOffset: H + M, comments: S };
              let G = [...R];
              G.splice(M, 0, T);
              let re = [..._], $ = t(G, re), W = H;
              for (let ee of $)
                if (ee.removed) {
                  ...
                  W += ee.count;
              return { formatted: P.formatted, cursorOffset: W, comments: S };
            }
            return { formatted: P.formatted, cursorOffset: -1, comments: S };
          }
          function v(m, d) {
            let { ast: o, text: x } = p.parse(m, d), { rangeStart: F, rangeEnd: S } = C.calculateRange(x, d, o), k = x.slice(F, S), P = Math.min(F, x.lastIndexOf(`
`, F) + 1), O = x.slice(P, F).match(/^\s*/)[0], R = r(O, d.tabWidth), M = b(k, Object.assign(Object.assign({}, d), {}, { rangeStart: 0, rangeEnd: Number.POSITIVE_INFINITY, cursorOffset: d.cursorOffset > F && d.cursorOffset <= S ? d.cursorOffset - F : -1, endOfLine: "lf" }), R), H = M.formatted.trimEnd(), { cursorOffset: _ } = d;
            _ > S ? _ += H.length - k.length : M.cursorOffset >= 0 && (_ = M.cursorOffset + F);
            let G = x.slice(0, F) + H + x.slice(S);
            if (d.endOfLine !== "lf") {
              let re = a(d.endOfLine);
              _ >= 0 && re === `\r
` && (_ += c(G.slice(0, _), `
`)), G = G.replace(/\n/g, re);
            }
            return { formatted: G, cursorOffset: _, comments: M.comments };
          }
          function B(m, d, o) {
            return typeof d != "number" || Number.isNaN(d) || d < 0 || d > m.length ? o : d;
          }
          function w(m, d) {
            let { cursorOffset: o, rangeStart: x, rangeEnd: F } = d;
            return o = B(m, o, -1), x = B(m, x, 0), F = B(m, F, m.length), Object.assign(Object.assign({}, d), {}, { cursorOffset: o, rangeStart: x, rangeEnd: F });
          }
          function I(m, d) {
            let { cursorOffset: o, rangeStart: x, rangeEnd: F, endOfLine: S } = w(m, d), k = m.charAt(0) === N;
            if (k && (m = m.slice(1), o--, x--, F--), S === "auto" && (S = u(m)), m.includes("\r")) {
              let P = (O) => c(m.slice(0, Math.max(O, 0)), `\r
`);
              o -= P(o), x -= P(x), F -= P(F), m = l(m);
            }
            return { hasBOM: k, text: m, options: w(m, Object.assign(Object.assign({}, d), {}, { cursorOffset: o, rangeStart: x, rangeEnd: F, endOfLine: S })) };
          }
          function E(m, d) {
            let o = p.resolveParser(d);
            return !o.hasPragma || o.hasPragma(m);
          }
          function D(m, d) {
            let { hasBOM: o, text: x, options: F } = I(m, h(d));
            if (F.rangeStart >= F.rangeEnd && x !== "" || F.requirePragma && !E(x, F))
              return { formatted: m, cursorOffset: d.cursorOffset, comments: [] };
            let S;
          ...
          n.exports = { formatWithCursor: D, parse(m, d, o) {
            let { text: x, options: F } = I(m, h(d)), S = p.parse(x, F);
            return o && (S.ast = g(S.ast, F)), S;
          }, formatAST(m, d) {
            d = h(d);
            let o = f(m, d);
            return s(o, d);
          }, formatDoc(m, d) {
            return D(i(m), Object.assign(Object.assign({}, d), {}, { parser: "__js_expression" })).formatted;
          }, printToDoc(m, d) {
            d = h(d);
            let { ast: o, text: x } = p.parse(m, d);
            return A(x, o, d), f(o, d);
          }, printDocToString(m, d) {
            return s(m, h(d));
          } };
        } }), cm = Z({ "src/common/util-shared.js"(e, n) {
          "use strict";
          ae();
          var { getMaxContinuousCount: t, getStringWidth: s, getAlignmentSize: i, getIndentSize: r, skip: u, skipWhitespace: a, skipSpaces: c, skipNewline: l, skipToLineEnd: h, skipEverythingButNewLine: g, skipInlineComment: y, skipTrailingComment: p, hasNewline: f, hasNewlineInRange: C, hasSpaces: N, isNextLineEmpty: T, isNextLineEmptyAfterIndex: A, isPreviousLineEmpty: b, getNextNonSpaceNonCommentCharacterIndex: v, makeString: B, addLeadingComment: w, addDanglingComment: I, addTrailingComment: E } = Ge();
          n.exports = { getMaxContinuousCount: t, getStringWidth: s, getAlignmentSize: i, getIndentSize: r, skip: u, skipWhitespace: a, skipSpaces: c, skipNewline: l, skipToLineEnd: h, skipEverythingButNewLine: g, skipInlineComment: y, skipTrailingComment: p, hasNewline: f, hasNewlineInRange: C, hasSpaces: N, isNextLineEmpty: T, isNextLineEmptyAfterIndex: A, isPreviousLineEmpty: b, getNextNonSpaceNonCommentCharacterIndex: v, makeString: B, addLeadingComment: w, addDanglingComment: I, addTrailingComment: E };
        } }), bt = Z({ "src/utils/create-language.js"(e, n) {
          "use strict";
          ae(), n.exports = function(t, s) {
            let { languageId: i } = t, r = Pn(t, Kf);
          ...
          ae(), function() {
            ...
            n.exports = { isDecimalDigit: c, isHexDigit: l, isOctalDigit: h, isWhiteSpace: g, isLineTerminator: y, isIdentifierStartES5: f, isIdentifierPartES5: C, isIdentifierStartES6: N, isIdentifierPartES6: T };
          }();
          ...
          ae(), function() {
            ...
            function u(f, C) {
              return f === "null" || f === "true" || f === "false" || i(f, C);
            }
            function a(f, C) {
            ...
            function l(f) {
              ...
              if (f.length === 0 || (T = f.charCodeAt(0), !t.isIdentifierStartES5(T)))
                return false;
              for (C = 1, N = f.length; C < N; ++C)
                if (T = f.charCodeAt(C), !t.isIdentifierPartES5(T))
                  return false;
              return true;
            }
            function h(f, C) {
            ...
            function g(f) {
              ...
              if (f.length === 0)
                return false;
              for (b = t.isIdentifierStartES6, C = 0, N = f.length; C < N; ++C) {
                if (T = f.charCodeAt(C), 55296 <= T && T <= 56319) {
                  if (++C, C >= N || (A = f.charCodeAt(C), !(56320 <= A && A <= 57343)))
                    return false;
                  T = h(T, A);
                }
                if (!b(T))
            ...
            n.exports = { isKeywordES5: i, isKeywordES6: r, isReservedWordES5: u, isReservedWordES6: a, isRestrictedWord: c, isIdentifierNameES5: l, isIdentifierNameES6: g, isIdentifierES5: y, isIdentifierES6: p };
          }();
        ...
        } }), _t = Z({ "src/language-js/utils/is-block-comment.js"(e, n) {
          "use strict";
          ae();
          function t(s) {
          ...
          "use strict";
          ae();
          var t = fm().keyword.isIdentifierNameES5, { getLast: s, hasNewline: i, skipWhitespace: r, isNonEmptyArray: u, isNextLineEmptyAfterIndex: a, getStringWidth: c } = Ge(), { locStart: l, locEnd: h, hasSameLocStart: g } = nt(), y = _t(), p = "(?:(?=.)\\s)", f = new RegExp("^".concat(p, "*:")), C = new RegExp("^".concat(p, "*::"));
          function N(L) {
            return L.extra && L.extra.parenthesized && u(L.trailingComments) && y(L.trailingComments[0]) && f.test(L.trailingComments[0].value);
          }
          function T(L) {
            return u(L) && y(L[0]) && C.test(L[0].value);
          }
          function A(L, De) {
          ...
          function o(L) {
            return L.type === "UnaryExpression" && (L.operator === "+" || L.operator === "-") && d(L.argument);
          }
          function x(L) {
          ...
          function _(L) {
            return H(L) || g(L, L.value);
          }
          function G(L) {
            return (L.type === "ObjectTypeProperty" || L.type === "ObjectTypeInternalSlot") && L.value.type === "FunctionTypeAnnotation" && !L.static && !_(L);
          }
          function re(L) {
            return (L.type === "TypeAnnotation" || L.type === "TSTypeAnnotation") && L.typeAnnotation.type === "FunctionTypeAnnotation" && !L.static && !g(L, L.typeAnnotation);
          }
          ...
          function K(L, De) {
            ...
            } else if ((L.arguments.length === 2 || L.arguments.length === 3) && (L.callee.type === "Identifier" && se.test(L.callee.name) || V(L)) && (P(L.arguments[0]) || x(L.arguments[0])))
              return L.arguments[2] && !d(L.arguments[2]) ? false : (L.arguments.length === 2 ? S(L.arguments[1]) : k(L.arguments[1]) && Ke(L.arguments[1]).length <= 1) || O(L.arguments[1]);
            return false;
          }
          function Ee(L) {
          ...
          function Q(L, De) {
            let ke = l(De), We = r(L, h(De));
            return We !== false && L.slice(ke, ke + 2) === "/*" && L.slice(We, We + 2) === "*/";
          }
          function de(L, De) {
            return R(De) ? Ae(De) : Me(De, _e.Leading, (ke) => i(L, h(ke)));
          }
          function ge(L, De) {
...
`));
          ...
          function he(L, De) {
            if (De >= 2)
              return false;
            let ke = (Ve) => he(Ve, De + 1), We = L.type === "Literal" && "regex" in L && L.regex.pattern || L.type === "RegExpLiteral" && L.pattern;
            return We && c(We) > 5 ? false : L.type === "Literal" || L.type === "BigIntLiteral" || L.type === "DecimalLiteral" || L.type === "BooleanLiteral" || L.type === "NullLiteral" || L.type === "NumericLiteral" || L.type === "RegExpLiteral" || L.type === "StringLiteral" || L.type === "Identifier" || L.type === "ThisExpression" || L.type === "Super" || L.type === "PrivateName" || L.type === "PrivateIdentifier" || L.type === "ArgumentPlaceholder" || L.type === "Import" ? true : L.type === "TemplateLiteral" ? L.quasis.every((Ve) => !Ve.value.raw.includes(`
`)) && L.expressions.every(ke) : L.type === "ObjectExpression" ? L.properties.every((Ve) => !Ve.computed && (Ve.shorthand || Ve.value && ke(Ve.value))) : L.type === "ArrayExpression" ? L.elements.every((Ve) => Ve === null || ke(Ve)) : rt(L) ? (L.type === "ImportExpression" || he(L.callee, De)) && Be(L).every(ke) : q(L) ? he(L.object, De) && he(L.property, De) : L.type === "UnaryExpression" && (L.operator === "!" || L.operator === "-") ? he(L.argument, De) : L.type === "TSNonNullExpression" ? he(L.expression, De) : false;
          }
          function J(L) {
          ...
          function Se(L, De) {
            let ke = L.getValue(), We = 0, Ve = (ut) => De(ut, We++);
            ke.this && L.call(Ve, "this"), Array.isArray(ke.parameters) ? L.each(Ve, "parameters") : Array.isArray(ke.params) && L.each(Ve, "params"), ke.rest && L.call(Ve, "rest");
          }
          ...
          function Ae(L) {
            return L && (L.prettierIgnore || Me(L, _e.PrettierIgnore));
          }
          function Oe(L) {
            let De = L.getValue();
            return Ae(De);
          }
          var _e = { Leading: 1 << 1, Trailing: 1 << 2, Dangling: 1 << 3, Block: 1 << 4, Line: 1 << 5, PrettierIgnore: 1 << 6, First: 1 << 7, Last: 1 << 8 }, ie = (L, De) => {
            if (typeof L == "function" && (De = L, L = 0), L || De)
              return (ke, We, Ve) => !(L & _e.Leading && !ke.leading || L & _e.Trailing && !ke.trailing || L & _e.Dangling && (ke.leading || ke.trailing) || L & _e.Block && !y(ke) || L & _e.Line && !w(ke) || L & _e.First && We !== 0 || L & _e.Last && We !== Ve.length - 1 || L & _e.PrettierIgnore && !Re(ke) || De && !De(ke));
          };
          function Me(L, De, ke) {
            if (!L || !u(L.comments))
              return false;
          ...
          n.exports = { getFunctionParameters: Ke, iterateFunctionParametersPath: Se, getCallArguments: Be, iterateCallArgumentsPath: Ie, hasRestParameter: Pe, getLeftSide: v, getLeftSidePathName: B, getParentExportDeclaration: D, getTypeScriptMappedTypeModifier: ue, hasFlowAnnotationComment: T, hasFlowShorthandAnnotationComment: N, hasLeadingOwnLineComment: de, hasNakedLeftSide: b, hasNode: A, hasIgnoreComment: Oe, hasNodeIgnoreComment: Ae, identity: ye, isBinaryish: W, isCallLikeExpression: rt, isEnabledHackPipeline: ct, isLineComment: w, isPrettierIgnoreComment: Re, isCallExpression: Ee, isMemberExpression: q, isExportDeclaration: E, isFlowAnnotationComment: Q, isFunctionCompositionArgs: me, isFunctionNotation: _, isFunctionOrArrowExpression: S, isGetterOrSetter: H, isJestEachTemplateLiteral: xe, isJsxNode: R, isLiteral: m, isLongCurriedCallExpression: ce, isSimpleCallArgument: he, isMemberish: ee, isNumericLiteral: d, isSignedNumericLiteral: o, isObjectProperty: Ze, isObjectType: F, isObjectTypePropertyAFunction: G, isSimpleType: ne, isSimpleNumber: ve, isSimpleTemplateLiteral: le, isStringLiteral: x, isStringPropSafeToUnquote: ge, isTemplateOnItsOwnLine: fe, isTestCall: K, isTheOnlyJsxElementInMarkdown: M, isTSXFile: X, isTypeAnnotationAFunction: re, isNextLineEmpty: Je, needsHardlineAfterDanglingComment: pe, rawText: J, shouldPrintComma: Y, isBitwiseOperator: Te, shouldFlatten: Ne, startsWithNoLookaheadToken: te, getPrecedence: Ue, hasComment: Me, getComments: qe, CommentCheckFlags: _e, markerForIfWithoutBlockAndSameLineComment: qt };
        } }), It = Z({ "src/language-js/print/template-literal.js"(e, n) {
          "use strict";
          ae();
          var t = st(), { getStringWidth: s, getIndentSize: i } = Ge(), { builders: { join: r, hardline: u, softline: a, group: c, indent: l, align: h, lineSuffixBoundary: g, addAlignmentToDoc: y }, printer: { printDocToString: p }, utils: { mapDoc: f } } = Le(), { isBinaryish: C, isJestEachTemplateLiteral: N, isSimpleTemplateLiteral: T, hasComment: A, isMemberExpression: b } = Xe();
          function v(m, d, o) {
            let x = m.getValue();
            if (x.type === "TemplateLiteral" && N(x, m.getParentNode())) {
              let R = B(m, o, d);
              if (R)
                return R;
            }
            ...
            let k = [], P = m.map(d, S), O = T(x);
            return O && (P = P.map((R) => p(R, Object.assign(Object.assign({}, o), {}, { printWidth: Number.POSITIVE_INFINITY })).formatted)), k.push(g, "`"), m.each((R) => {
              let M = R.getName();
              if (k.push(d()), M < P.length) {
                let { tabWidth: H } = o, _ = R.getValue(), G = i(_.value.raw, H), re = P[M];
                if (!O) {
                  let W = x[S][M];
                  (A(W) || b(W) || W.type === "ConditionalExpression" || W.type === "SequenceExpression" || W.type === "TSAsExpression" || C(W)) && (re = [l([a, re]), a]);
                }
                let $ = G === 0 && _.value.raw.endsWith(`
`) ? h(Number.NEGATIVE_INFINITY, re) : y(re, G, H);
                k.push(c(["${", $, g, "}"]));
              }
            }, "quasis"), k.push("`"), k;
          }
          function B(m, d, o) {
            let x = m.getNode(), F = x.quasis[0].value.raw.trim().split(/\s*\|\s*/);
            if (F.length > 1 || F.some((S) => S.length > 0)) {
              d.__inJestEach = true;
              let S = m.map(o, "expressions");
              d.__inJestEach = false;
              let k = [], P = S.map((_) => "${" + p(_, Object.assign(Object.assign({}, d), {}, { printWidth: Number.POSITIVE_INFINITY, endOfLine: "lf" })).formatted + "}"), O = [{ hasLineBreak: false, cells: [] }];
              for (let _ = 1; _ < x.quasis.length; _++) {
                let G = t(O), re = P[_ - 1];
                G.cells.push(re), re.includes(`
`) && (G.hasLineBreak = true), x.quasis[_].value.raw.includes(`
`) && O.push({ hasLineBreak: false, cells: [] });
              }
              let R = Math.max(F.length, ...O.map((_) => _.cells.length)), M = Array.from({ length: R }).fill(0), H = [{ cells: F }, ...O.filter((_) => _.cells.length > 0)];
              for (let { cells: _ } of H.filter((G) => !G.hasLineBreak))
                for (let [G, re] of _.entries())
                  M[G] = Math.max(M[G], s(re));
              return k.push(g, "`", l([u, r(u, H.map((_) => r(" | ", _.cells.map((G, re) => _.hasLineBreak ? G : G + " ".repeat(M[re] - s(G))))))]), u, "`"), k;
            }
          }
          function w(m, d) {
            let o = m.getValue(), x = d();
            return A(o) && (x = c([l([a, x]), a])), ["${", x, g, "}"];
          }
          function I(m, d) {
            return m.map((o) => w(o, d), "expressions");
          }
          function E(m, d) {
            return f(m, (o) => typeof o == "string" ? d ? o.replace(/(\\*)`/g, "$1$1\\`") : D(o) : o);
          }
          function D(m) {
          ...
          function a(l, h, g) {
            let p = l.getValue().quasis[0].value.raw.replace(/((?:\\\\)*)\\`/g, (T, A) => "\\".repeat(A.length / 2) + "`"), f = c(p), C = f !== "";
            C && (p = p.replace(new RegExp("^".concat(f), "gm"), ""));
            let N = u(g(p, { parser: "markdown", __inJsTemplate: true }, { stripTrailingHardline: true }), true);
            return ["`", C ? t([s, N]) : [i, r(N)], s, "`"];
          }
          function c(l) {
            let h = l.match(/^([^\S\n]*)\S/m);
            return h === null ? "" : h[1];
          ...
          function h(p, f, C) {
            let N = p.getValue(), T = N.quasis.map((w) => w.value.raw), A = 0, b = T.reduce((w, I, E) => E === 0 ? I : w + "@prettier-placeholder-" + A++ + "-id" + I, ""), v = C(b, { parser: "scss" }, { stripTrailingHardline: true }), B = l(p, f);
            return g(v, N, B);
          }
          function g(p, f, C) {
          ...
          function y(p, f) {
            if (!t(f))
              return p;
            let C = 0, N = u(c(p), (T) => typeof T != "string" || !T.includes("@prettier-placeholder") ? T : T.split(/@prettier-placeholder-(\d+)-id/).map((A, b) => b % 2 === 0 ? a(A) : (C++, f[A])));
            return f.length === C ? N : null;
          }
          n.exports = h;
          ...
          function a(l, h, g) {
            let y = l.getValue(), p = y.quasis.length;
            if (p === 1 && y.quasis[0].value.raw.trim() === "")
              return "``";
            let f = u(l, h), C = [];
            for (let N = 0; N < p; N++) {
              let T = y.quasis[N], A = N === 0, b = N === p - 1, v = T.value.cooked, B = v.split(`
`), w = B.length, I = f[N], E = w > 2 && B[0].trim() === "" && B[1].trim() === "", D = w > 2 && B[w - 1].trim() === "" && B[w - 2].trim() === "", m = B.every((o) => /^\s*(?:#[^\n\r]*)?$/.test(o));
              if (!b && /#[^\n\r]*$/.test(B[w - 1]))
                return null;
              let d = null;
              m ? d = c(B) : d = g(v, { parser: "graphql" }, { stripTrailingHardline: true }), d ? (d = r(d, false), !A && E && C.push(""), C.push(d), !b && D && C.push("")) : !A && !b && E && C.push(""), I && C.push(I);
            }
            return ["`", t([i, s(i, C)]), i, "`"];
          }
          function c(l) {
            let h = [], g = false, y = l.map((p) => p.trim());
            for (let [p, f] of y.entries())
              f !== "" && (y[p - 1] === "" && g ? h.push([i, f]) : h.push(f), g = true);
          ...
          function h(g, y, p, f, C) {
            let { parser: N } = C, T = g.getValue(), A = l;
            l = l + 1 >>> 0;
            let b = (x) => "PRETTIER_HTML_PLACEHOLDER_".concat(x, "_").concat(A, "_IN_JS"), v = T.quasis.map((x, F, S) => F === S.length - 1 ? x.value.cooked : x.value.cooked + b(F)).join(""), B = a(g, y);
            ...
            let w = new RegExp(b("(\\d+)"), "g"), I = 0, E = p(v, { parser: N, __onHtmlRoot(x) {
              ...
              for (let k = 0; k < S.length; k++) {
                let P = S[k];
                if (k % 2 === 0) {
                  P && (P = c(P), f.__embeddedInHtml && (P = P.replace(/<\/(script)\b/gi, "<\\/$1")), F.push(P));
                  continue;
                }
                let O = Number(P);
                F.push(B[O]);
              ...
              return F;
            }), m = /^\s/.test(v) ? " " : "", d = /\s$/.test(v) ? " " : "", o = f.htmlWhitespaceSensitivity === "ignore" ? i : m && d ? s : null;
            return r(o ? ["`", t([o, r(D)]), o, "`"] : ["`", m, I > 1 ? t(r(D)) : r(D), d, "`"]);
          }
          n.exports = h;
          ...
          function y(E) {
            let D = E.getValue(), m = E.getParentNode(), d = E.getParentNode(1);
            return d && D.quasis && m.type === "JSXExpressionContainer" && d.type === "JSXElement" && d.openingElement.name.name === "style" && d.openingElement.attributes.some((o) => o.name.name === "jsx") || m && m.type === "TaggedTemplateExpression" && m.tag.type === "Identifier" && m.tag.name === "css" || m && m.type === "TaggedTemplateExpression" && m.tag.type === "MemberExpression" && m.tag.object.name === "css" && (m.tag.property.name === "global" || m.tag.property.name === "resolve");
          }
          function p(E) {
            return E.match((D) => D.type === "TemplateLiteral", (D, m) => D.type === "ArrayExpression" && m === "elements", (D, m) => i(D) && D.key.type === "Identifier" && D.key.name === "styles" && m === "value", ...C);
          }
          function f(E) {
            return E.match((D) => D.type === "TemplateLiteral", (D, m) => i(D) && D.key.type === "Identifier" && D.key.name === "template" && m === "value", ...C);
          }
          var C = [(E, D) => E.type === "ObjectExpression" && D === "properties", (E, D) => E.type === "CallExpression" && E.callee.type === "Identifier" && E.callee.name === "Component" && D === "arguments", (E, D) => E.type === "Decorator" && D === "expression"];
          function N(E) {
            ...
            switch (m.type) {
              case "MemberExpression":
                return A(m.object) || b(m);
              case "CallExpression":
                return A(m.callee) || m.callee.type === "MemberExpression" && (m.callee.object.type === "MemberExpression" && (A(m.callee.object.object) || b(m.callee.object)) || m.callee.object.type === "CallExpression" && A(m.callee.object.callee));
              case "Identifier":
                return m.name === "css";
              default:
                return false;
          ...
          function v(E) {
            let D = E.getValue(), m = E.getParentNode();
            return B(D, "GraphQL") || m && (m.type === "TaggedTemplateExpression" && (m.tag.type === "MemberExpression" && m.tag.object.name === "graphql" && m.tag.property.name === "experimental" || m.tag.type === "Identifier" && (m.tag.name === "gql" || m.tag.name === "graphql")) || m.type === "CallExpression" && m.callee.type === "Identifier" && m.callee.name === "graphql");
          }
          function B(E, D) {
            return t(E, s.Block | s.Leading, (m) => {
              let { value: d } = m;
              return d === " ".concat(D, " ");
            });
          }
          function w(E) {
            return B(E.getValue(), "HTML") || E.match((D) => D.type === "TemplateLiteral", (D, m) => D.type === "TaggedTemplateExpression" && D.tag.type === "Identifier" && D.tag.name === "html" && m === "quasi");
          }
          function I(E) {
            let { quasis: D } = E;
            return D.some((m) => {
              let { value: { cooked: d } } = m;
              return d === null;
            });
          }
          n.exports = h;
          ...
          "use strict";
          ae();
          var t = _t(), s = /* @__PURE__ */ new Set(["range", "raw", "comments", "leadingComments", "trailingComments", "innerComments", "extra", "start", "end", "loc", "flags", "errors", "tokens"]), i = (u) => {
          ...
          function r(u, a, c) {
            if (u.type === "Program" && delete a.sourceType, (u.type === "BigIntLiteral" || u.type === "BigIntLiteralTypeAnnotation") && a.value && (a.value = a.value.toLowerCase()), (u.type === "BigIntLiteral" || u.type === "Literal") && a.bigint && (a.bigint = a.bigint.toLowerCase()), u.type === "DecimalLiteral" && (a.value = Number(a.value)), u.type === "Literal" && a.decimal && (a.decimal = Number(a.decimal)), u.type === "EmptyStatement" || u.type === "JSXText" || u.type === "JSXExpressionContainer" && (u.expression.type === "Literal" || u.expression.type === "StringLiteral") && u.expression.value === " ")
              return null;
            if ((u.type === "Property" || u.type === "ObjectProperty" || u.type === "MethodDefinition" || u.type === "ClassProperty" || u.type === "ClassMethod" || u.type === "PropertyDefinition" || u.type === "TSDeclareMethod" || u.type === "TSPropertySignature" || u.type === "ObjectTypeProperty") && typeof u.key == "object" && u.key && (u.key.type === "Literal" || u.key.type === "NumericLiteral" || u.key.type === "StringLiteral" || u.key.type === "Identifier") && delete a.key, u.type === "JSXElement" && u.openingElement.name.name === "style" && u.openingElement.attributes.some((h) => h.name.name === "jsx"))
              for (let { type: h, expression: g } of a.children)
                h === "JSXExpressionContainer" && g.type === "TemplateLiteral" && i(g);
            ...
            if (u.type === "Decorator" && l.type === "CallExpression" && l.callee.name === "Component" && l.arguments.length === 1) {
              ...
              for (let [g, y] of a.expression.arguments[0].properties.entries())
                switch (h[g].key.name) {
                  case "styles":
                    y.value.type === "ArrayExpression" && i(y.value.elements[0]);
                    break;
                  case "template":
                    y.value.type === "TemplateLiteral" && i(y.value);
                    break;
                }
            }
            if (u.type === "TaggedTemplateExpression" && (u.tag.type === "MemberExpression" || u.tag.type === "Identifier" && (u.tag.name === "gql" || u.tag.name === "graphql" || u.tag.name === "css" || u.tag.name === "md" || u.tag.name === "markdown" || u.tag.name === "html") || u.tag.type === "CallExpression") && i(a.quasi), u.type === "TemplateLiteral" && (u.leadingComments && u.leadingComments.some((g) => t(g) && ["GraphQL", "HTML"].some((y) => g.value === " ".concat(y, " "))) || c.type === "CallExpression" && c.callee.name === "graphql" || !u.leadingComments) && i(a), u.type === "InterpreterDirective" && (a.value = a.value.trimEnd()), (u.type === "TSIntersectionType" || u.type === "TSUnionType") && u.types.length === 1)
              return a.types[0];
          }
...
`;
          ...
          "use strict";
          ae(), Object.defineProperty(e, "__esModule", { value: true }), e.extract = p, e.parse = C, e.parseWithComments = N, e.print = T, e.strip = f;
          function n() {
            let b = Fm();
            return n = function() {
              return b;
          ...
          function N(b) {
            ...
            b = b.replace(r, "").replace(i, "").replace(g, "$1");
            let B = "";
            for (; B !== b; )
              B = b, b = b.replace(l, "".concat(v, "$1 $2").concat(v));
            b = b.replace(c, "").trimRight();
            let w = /* @__PURE__ */ Object.create(null), I = b.replace(h, "").replace(c, "").trimRight(), E;
            for (; E = h.exec(b); ) {
              let D = E[2].replace(a, "");
              typeof w[E[1]] == "string" || Array.isArray(w[E[1]]) ? w[E[1]] = y.concat(w[E[1]], D) : w[E[1]] = D;
            }
            return { comments: I, pragmas: w };
          }
          function T(b) {
            let { comments: v = "", pragmas: B = {} } = b, w = (0, t().default)(v) || n().EOL, I = "/**", E = " *", D = " */", m = Object.keys(B), d = m.map((x) => A(x, B[x])).reduce((x, F) => x.concat(F), []).map((x) => E + " " + x + w).join("");
            if (!v) {
              if (m.length === 0)
                return "";
              if (m.length === 1 && !Array.isArray(B[m[0]])) {
                let x = B[m[0]];
                return "".concat(I, " ").concat(A(m[0], x)[0]).concat(D);
              }
            }
            let o = v.split(w).map((x) => "".concat(E, " ").concat(x)).join(w) + w;
            return I + w + (v ? o : "") + (v && m.length ? E + w : "") + d + D;
          }
          function A(b, v) {
            return y.concat(v).map((B) => "@".concat(b, " ").concat(B).trim());
          }
...
`);
          ...
          function c(g) {
            let y = a(g);
            y && (g = g.slice(y.length + 1));
            let p = i(g), { pragmas: f, comments: C } = t(p);
            return { shebang: y, text: g, pragmas: f, comments: C };
          }
          function l(g) {
            let y = Object.keys(c(g).pragmas);
            return y.includes("prettier") || y.includes("format");
          }
          function h(g) {
            let { shebang: y, text: p, pragmas: f, comments: C } = c(g), N = s(p), T = r({ pragmas: Object.assign({ format: "" }, f), comments: C.trimStart() });
            return (y ? "".concat(y, `
`) : "") + u(T) + (N.startsWith(`
`) ? `
` : `
...
`) + N;
          ...
          function O(X, Y) {
            X.type === "BlockStatement" ? P(X, Y) : a(X, Y);
          }
          function R(X) {
          ...
          function M(X) {
            ...
            if (te === z.consequent && j === z.alternate) {
              if (te.type === "BlockStatement")
                ...
                je && Ue ? l(te, Y, m) : l(z, Y);
              }
              return true;
            }
            return j.type === "BlockStatement" ? (P(j, Y), true) : j.type === "IfStatement" ? (O(j.consequent, Y), true) : z.consequent === j ? (a(j, Y), true) : false;
          }
          function H(X) {
            let { comment: Y, precedingNode: te, enclosingNode: z, followingNode: j, text: Ce } = X;
            return !z || z.type !== "WhileStatement" || !j ? false : r(Ce, Y, o) === ")" ? (c(te, Y), true) : j.type === "BlockStatement" ? (P(j, Y), true) : z.body === j ? (a(j, Y), true) : false;
          }
          function _(X) {
            let { comment: Y, precedingNode: te, enclosingNode: z, followingNode: j } = X;
            return !z || z.type !== "TryStatement" && z.type !== "CatchClause" || !j ? false : z.type === "CatchClause" && te ? (c(te, Y), true) : j.type === "BlockStatement" ? (P(j, Y), true) : j.type === "TryStatement" ? (O(j.finalizer, Y), true) : j.type === "CatchClause" ? (O(j.body, Y), true) : false;
          }
          function G(X) {
          ...
          function re(X) {
            let { comment: Y, precedingNode: te, enclosingNode: z, followingNode: j, text: Ce } = X, Ne = te && !u(Ce, o(te), d(Y));
          ...
          function W(X) {
            ...
            if (z && (z.type === "ClassDeclaration" || z.type === "ClassExpression" || z.type === "DeclareClass" || z.type === "DeclareInterface" || z.type === "InterfaceDeclaration" || z.type === "TSInterfaceDeclaration")) {
              if (g(z.decorators) && !(j && j.type === "Decorator"))
                return c(t(z.decorators), Y), true;
              if (z.body && j === z.body)
                return P(z.body, Y), true;
              if (j) {
          ...
          function se(X) {
            let { comment: Y, enclosingNode: te, text: z } = X;
            return r(z, Y, o) !== ")" ? false : te && (ce(te) && y(te).length === 0 || A(te) && b(te).length === 0) ? (l(te, Y), true) : te && (te.type === "MethodDefinition" || te.type === "TSAbstractMethodDefinition") && y(te.value).length === 0 ? (l(te.value, Y), true) : false;
          }
          function V(X) {
            let { comment: Y, precedingNode: te, enclosingNode: z, followingNode: j, text: Ce } = X;
          ...
          function Q(X) {
            ...
            return j && j.body && j.body.length === 0 ? (Ce ? l(j, Y) : a(j, Y), true) : te && te.type === "Program" && te.body.length === 0 && !g(te.directives) ? (Ce ? l(te, Y) : a(te, Y), true) : z && z.type === "Program" && z.body.length === 0 && te && te.type === "ModuleExpression" ? (l(z, Y), true) : false;
          }
          function de(X) {
            let { comment: Y, enclosingNode: te } = X;
          ...
          function me(X) {
            let { comment: Y, enclosingNode: te, followingNode: z } = X;
            return !te || te.type !== "SwitchCase" || te.test ? false : (z.type === "BlockStatement" && I(Y) ? P(z, Y) : l(te, Y), true);
          }
          function ce(X) {
          ...
          function he(X, Y) {
            if ((Y.parser === "typescript" || Y.parser === "flow" || Y.parser === "acorn" || Y.parser === "espree" || Y.parser === "meriyah" || Y.parser === "__babel_estree") && X.type === "MethodDefinition" && X.value && X.value.type === "FunctionExpression" && y(X.value).length === 0 && !X.value.returnType && !g(X.value.typeParameters) && X.value.body)
          ...
          function ye(X) {
            ...
            return (Y && (f(Y) || C(Y) || v(te) && z(Y)) || te && (te.type === "JSXSpreadAttribute" || te.type === "JSXSpreadChild" || te.type === "UnionTypeAnnotation" || te.type === "TSUnionType" || (te.type === "ClassDeclaration" || te.type === "ClassExpression") && te.superClass === Y)) && (!T(X) || te.type === "UnionTypeAnnotation" || te.type === "TSUnionType");
          }
          ...
          "use strict";
          ae();
          var t = st(), s = Rn(), { getFunctionParameters: i, getLeftSidePathName: r, hasFlowShorthandAnnotationComment: u, hasNakedLeftSide: a, hasNode: c, isBitwiseOperator: l, startsWithNoLookaheadToken: h, shouldFlatten: g, getPrecedence: y, isCallExpression: p, isMemberExpression: f, isObjectProperty: C } = Xe();
          function N(I, E) {
            let D = I.getParentNode();
            if (!D)
              return false;
            let m = I.getName(), d = I.getNode();
            if (E.__isInHtmlInterpolation && !E.bracketSpacing && v(d) && B(I))
              return true;
            if (T(d))
              return false;
            ...
            if (d.type === "Identifier")
              return !!(d.extra && d.extra.parenthesized && /^PRETTIER_HTML_PLACEHOLDER_\d+_\d+_IN_JS$/.test(d.name) || m === "left" && d.name === "async" && D.type === "ForOfStatement" && !D.await);
            switch (D.type) {
              case "ParenthesizedExpression":
                return false;
              case "ClassDeclaration":
              case "ClassExpression": {
                if (m === "superClass" && (d.type === "ArrowFunctionExpression" || d.type === "AssignmentExpression" || d.type === "AwaitExpression" || d.type === "BinaryExpression" || d.type === "ConditionalExpression" || d.type === "LogicalExpression" || d.type === "NewExpression" || d.type === "ObjectExpression" || d.type === "SequenceExpression" || d.type === "TaggedTemplateExpression" || d.type === "UnaryExpression" || d.type === "UpdateExpression" || d.type === "YieldExpression" || d.type === "TSNonNullExpression"))
                  return true;
                break;
              }
              case "ExportDefaultDeclaration":
                return w(I, E) || d.type === "SequenceExpression";
              case "Decorator": {
                if (m === "expression") {
                  let o = false, x = false, F = d;
                  for (; F; )
                    switch (F.type) {
                      case "MemberExpression":
                        x = true, F = F.object;
              ...
              case "ArrowFunctionExpression": {
                if (m === "body" && d.type !== "SequenceExpression" && h(d, false))
                  return true;
                break;
              }
            }
            switch (d.type) {
              case "UpdateExpression":
                if (D.type === "UnaryExpression")
                  return d.prefix && (d.operator === "++" && D.operator === "+" || d.operator === "--" && D.operator === "-");
              case "UnaryExpression":
                switch (D.type) {
                  case "UnaryExpression":
                    return d.operator === D.operator && (d.operator === "+" || d.operator === "-");
                  case "BindExpression":
                    return true;
                  case "MemberExpression":
                  case "OptionalMemberExpression":
              ...
              case "BinaryExpression": {
                if (D.type === "UpdateExpression" || d.operator === "in" && A(I))
                  return true;
                if (d.operator === "|>" && d.extra && d.extra.parenthesized) {
              ...
              case "LogicalExpression":
                switch (D.type) {
                  ...
                  case "AssignmentPattern":
                    return m === "left" && (d.type === "TSTypeAssertion" || d.type === "TSAsExpression");
                  case "LogicalExpression":
                    if (d.type === "LogicalExpression")
                      return D.operator !== d.operator;
                  case "BinaryExpression": {
                    let { operator: o, type: x } = d;
                    if (!o && x !== "TSTypeAssertion")
                      return true;
                    let F = y(o), S = D.operator, k = y(S);
                    return k > F || m === "right" && k === F || k === F && !g(S, o) ? true : k < F && o === "%" ? S === "+" || S === "-" : !!l(S);
                  }
                  default:
                    return false;
                }
              ...
              case "TSIntersectionType":
                if ((D.type === "TSUnionType" || D.type === "TSIntersectionType") && D.types.length > 1 && (!d.types || d.types.length > 1))
                  return true;
              case "TSInferType":
                if (d.type === "TSInferType" && D.type === "TSRestType")
                  return false;
              case "TSTypeOperator":
                return D.type === "TSArrayType" || D.type === "TSOptionalType" || D.type === "TSRestType" || m === "objectType" && D.type === "TSIndexedAccessType" || D.type === "TSTypeOperator" || D.type === "TSTypeAnnotation" && I.getParentNode(1).type.startsWith("TSJSDoc");
              ...
              case "NumericLiteral":
              case "Literal":
                if (typeof d.value == "string" && D.type === "ExpressionStatement" && !D.directive) {
                  let o = I.getParentNode(1);
                  return o.type === "Program" || o.type === "BlockStatement";
                }
                return m === "object" && D.type === "MemberExpression" && typeof d.value == "number";
              case "AssignmentExpression": {
                let o = I.getParentNode(1);
                return m === "body" && D.type === "ArrowFunctionExpression" ? true : m === "key" && (D.type === "ClassProperty" || D.type === "PropertyDefinition") && D.computed || (m === "init" || m === "update") && D.type === "ForStatement" ? false : D.type === "ExpressionStatement" ? d.left.type === "ObjectPattern" : !(m === "key" && D.type === "TSPropertySignature" || D.type === "AssignmentExpression" || D.type === "SequenceExpression" && o && o.type === "ForStatement" && (o.init === D || o.update === D) || m === "value" && D.type === "Property" && o && o.type === "ObjectPattern" && o.properties.includes(D) || D.type === "NGChainedExpression");
              }
              case "ConditionalExpression":
                switch (D.type) {
                  case "TaggedTemplateExpression":
              ...
              case "ArrowFunctionExpression":
                switch (D.type) {
                  case "BinaryExpression":
                    return D.operator !== "|>" || d.extra && d.extra.parenthesized;
                  case "NewExpression":
                  case "CallExpression":
                  case "OptionalCallExpression":
                    return m === "callee";
              ...
              case "TSNonNullExpression":
                ...
                return false;
              case "BindExpression":
                return m === "callee" && (D.type === "BindExpression" || D.type === "NewExpression") || m === "object" && f(D);
              case "NGPipeExpression":
                return !(D.type === "NGRoot" || D.type === "NGMicrosyntaxExpression" || D.type === "ObjectProperty" && !(d.extra && d.extra.parenthesized) || D.type === "ArrayExpression" || p(D) && D.arguments[m] === d || m === "right" && D.type === "NGPipeExpression" || m === "property" && D.type === "MemberExpression" || D.type === "AssignmentExpression");
              case "JSXFragment":
              case "JSXElement":
                return m === "callee" || m === "left" && D.type === "BinaryExpression" && D.operator === "<" || D.type !== "ArrayExpression" && D.type !== "ArrowFunctionExpression" && D.type !== "AssignmentExpression" && D.type !== "AssignmentPattern" && D.type !== "BinaryExpression" && D.type !== "NewExpression" && D.type !== "ConditionalExpression" && D.type !== "ExpressionStatement" && D.type !== "JsExpressionRoot" && D.type !== "JSXAttribute" && D.type !== "JSXElement" && D.type !== "JSXExpressionContainer" && D.type !== "JSXFragment" && D.type !== "LogicalExpression" && !p(D) && !C(D) && D.type !== "ReturnStatement" && D.type !== "ThrowStatement" && D.type !== "TypeCastExpression" && D.type !== "VariableDeclarator" && D.type !== "YieldExpression";
              case "TypeAnnotation":
                return m === "returnType" && D.type === "ArrowFunctionExpression" && b(d);
            }
            return false;
          }
          function T(I) {
          ...
          function B(I) {
            let E = I.getValue(), D = I.getParentNode(), m = I.getName();
            switch (D.type) {
              case "NGPipeExpression":
              ...
              case "ObjectProperty":
                if (m === "value") {
                  let d = I.getParentNode(1);
                  return t(d.properties) === D;
                }
                break;
              case "BinaryExpression":
              case "LogicalExpression":
          ...
          function w(I, E) {
            let D = I.getValue(), m = I.getParentNode();
            return D.type === "FunctionExpression" || D.type === "ClassExpression" ? m.type === "ExportDefaultDeclaration" || !N(I, E) : !a(D) || m.type !== "ExportDefaultDeclaration" && N(I, E) ? false : I.call((d) => w(d, E), ...r(I, D));
          }
          n.exports = N;
          ...
          function a(l, h, g) {
            let y = l.getValue();
            if (h.__onHtmlBindingRoot && l.getName() === null && h.__onHtmlBindingRoot(y, h), y.type === "File") {
              if (h.__isVueForBindingLeft)
                return l.call((p) => {
                  let f = t([",", s], p.map(g, "params")), { params: C } = p.getValue();
                  return C.length === 1 ? f : ["(", u([r, i(f)]), r, ")"];
                }, "program", "body", 0);
              if (h.__isVueBindings)
                return l.call((p) => t([",", s], p.map(g, "params")), "program", "body", 0);
            }
          }
          function c(l) {
            switch (l.type) {
          ...
          "use strict";
          ae();
          var { printComments: t } = Qe(), { getLast: s } = Ge(), { builders: { join: i, line: r, softline: u, group: a, indent: c, align: l, ifBreak: h, indentIfBreak: g }, utils: { cleanDoc: y, getDocParts: p, isConcat: f } } = Le(), { hasLeadingOwnLineComment: C, isBinaryish: N, isJsxNode: T, shouldFlatten: A, hasComment: b, CommentCheckFlags: v, isCallExpression: B, isMemberExpression: w, isObjectProperty: I, isEnabledHackPipeline: E } = Xe(), D = 0;
          function m(x, F, S) {
            let k = x.getValue(), P = x.getParentNode(), O = x.getParentNode(1), R = k !== P.body && (P.type === "IfStatement" || P.type === "WhileStatement" || P.type === "SwitchStatement" || P.type === "DoWhileStatement"), M = E(F) && k.operator === "|>", H = d(x, S, F, false, R);
            if (R)
              return H;
            if (M)
              return a(H);
            if (B(P) && P.callee === k || P.type === "UnaryExpression" || w(P) && !P.computed)
              return a([c([u, ...H]), u]);
            let _ = P.type === "ReturnStatement" || P.type === "ThrowStatement" || P.type === "JSXExpressionContainer" && O.type === "JSXAttribute" || k.operator !== "|" && P.type === "JsExpressionRoot" || k.type !== "NGPipeExpression" && (P.type === "NGRoot" && F.parser === "__ng_binding" || P.type === "NGMicrosyntaxExpression" && O.type === "NGMicrosyntax" && O.body.length === 1) || k === P.body && P.type === "ArrowFunctionExpression" || k !== P.body && P.type === "ForStatement" || P.type === "ConditionalExpression" && O.type !== "ReturnStatement" && O.type !== "ThrowStatement" && !B(O) || P.type === "TemplateLiteral", G = P.type === "AssignmentExpression" || P.type === "VariableDeclarator" || P.type === "ClassProperty" || P.type === "PropertyDefinition" || P.type === "TSAbstractPropertyDefinition" || P.type === "ClassPrivateProperty" || I(P), re = N(k.left) && A(k.operator, k.left.operator);
            if (_ || o(k) && !re || !o(k) && G)
              return a(H);
            if (H.length === 0)
              return "";
            ...
            if (!$)
              return se;
            let V = s(H);
            return a([se, g(V, { groupId: ne })]);
          }
          function d(x, F, S, k, P) {
            let O = x.getValue();
            if (!N(O))
              return [a(F())];
            let R = [];
            A(O.operator, O.left.operator) ? R = x.call((U) => d(U, F, S, true, P), "left") : R.push(a(F("left")));
            let M = o(O), H = (O.operator === "|>" || O.type === "NGPipeExpression" || O.operator === "|" && S.parser === "__vue_expression") && !C(S.originalText, O.right), _ = O.type === "NGPipeExpression" ? "|" : O.operator, G = O.type === "NGPipeExpression" && O.arguments.length > 0 ? a(c([u, ": ", i([u, ":", h(" ")], x.map(F, "arguments").map((U) => l(2, a(U))))])) : "", re;
            if (M)
              re = [_, " ", F("right"), G];
            else {
              let ne = E(S) && _ === "|>" ? x.call((se) => d(se, F, S, true, P), "right") : F("right");
              re = [H ? r : "", _, H ? " " : r, ne, G];
            }
            let $ = x.getParentNode(), W = b(O.left, v.Trailing | v.Line), ee = W || !(P && O.type === "LogicalExpression") && $.type !== O.type && O.left.type !== O.type && O.right.type !== O.type;
          ...
          n.exports = { printBinaryishExpression: m, shouldInlineLogicalExpression: o };
            ...
            if (!!C.type.startsWith("NG"))
              switch (C.type) {
                ...
                case "NGChainedExpression":
                  return i(t([";", s], y.map((N) => g(N) ? f() : ["(", f(), ")"], "expressions")));
                case "NGEmptyExpression":
                  return "";
                case "NGQuotedExpression":
                  return [C.prefix, ": ", C.value.trim()];
                case "NGMicrosyntax":
                  return y.map((N, T) => [T === 0 ? "" : h(N.getValue(), T, C) ? " " : [";", s], f()], "body");
                ...
                case "NGMicrosyntaxKeyedExpression": {
                  let N = y.getName(), T = y.getParentNode(), A = h(C, N, T) || (N === 1 && (C.key.name === "then" || C.key.name === "else") || N === 2 && C.key.name === "else" && T.body[N - 1].type === "NGMicrosyntaxKeyedExpression" && T.body[N - 1].key.name === "then") && T.body[0].type === "NGMicrosyntaxExpression";
          ...
          function h(y, p, f) {
            return y.type === "NGMicrosyntaxKeyedExpression" && y.key.name === "of" && p === 1 && f.body[0].type === "NGMicrosyntaxLet" && f.body[0].value === null;
          }
          function g(y) {
            return r(y.getValue(), (p) => {
              switch (p.type) {
                case void 0:
                  return false;
                case "CallExpression":
          ...
          "use strict";
          ae();
          var { printComments: t, printDanglingComments: s } = Qe(), { builders: { line: i, hardline: r, softline: u, group: a, indent: c, conditionalGroup: l, fill: h, ifBreak: g, lineSuffixBoundary: y, join: p }, utils: { willBreak: f } } = Le(), { getLast: C, getPreferredQuote: N } = Ge(), { isJsxNode: T, rawText: A, isLiteral: b, isCallExpression: v, isStringLiteral: B, isBinaryish: w, hasComment: I, CommentCheckFlags: E, hasNodeIgnoreComment: D } = Xe(), m = kt(), { willPrintOwnComments: d } = to(), o = (q) => q === "" || q === i || q === r || q === u;
          function x(q, le, ue) {
            let Q = q.getValue();
            ...
            let ve = Q.children.some(T), xe = Q.children.filter((z) => z.type === "JSXExpressionContainer").length > 1, we = Q.type === "JSXElement" && Q.openingElement.attributes.length > 1, fe = f(de) || ve || we || xe, pe = q.getParentNode().rootMarker === "mdx", me = le.singleQuote ? "{' '}" : '{" "}', ce = pe ? " " : g([me, u], " "), he = Q.openingElement && Q.openingElement.name && Q.openingElement.name.name === "fbt", J = F(q, le, ue, ce, he), ye = Q.children.some((z) => oe(z));
            ...
            let Y = ye ? h(X) : a(X, { shouldBreak: true });
            if (pe)
              return Y;
            ...
            return q.each((ve, xe, we) => {
              ...
              if (b(fe)) {
                ...
                if (oe(fe)) {
                  ...
                  let ce;
                  if (C(me) === "" && (me.pop(), ce = me.pop()), me.length === 0)
                    return;
          ...
          function P(q, le, ue) {
            ...
            if (!Q || { ArrayExpression: true, JSXAttribute: true, JSXElement: true, JSXExpressionContainer: true, JSXFragment: true, ExpressionStatement: true, CallExpression: true, OptionalCallExpression: true, ConditionalExpression: true, JsExpressionRoot: true }[Q.type])
              return le;
            let ge = q.match(void 0, (xe) => xe.type === "ArrowFunctionExpression", v, (xe) => xe.type === "JSXExpressionContainer"), ve = m(q, ue);
            return a([ve ? "" : g("("), c([u, le]), u, ve ? "" : g(")")], { shouldBreak: ge });
          }
          function O(q, le, ue) {
            let Q = q.getValue(), de = [];
          ...
          function R(q, le, ue) {
            ...
            return de(Q.expression, q.getParentNode(0)) ? a(["{", ue("expression"), y, "}"]) : a(["{", c([u, ue("expression")]), u, y, "}"]);
          }
          function M(q, le, ue) {
...
`) && !de && !I(Q.attributes[0]))
            ...
            let ge = Q.attributes.length > 0 && I(C(Q.attributes), E.Trailing), ve = Q.attributes.length === 0 && !de || (le.bracketSameLine || le.jsxBracketSameLine) && (!de || Q.attributes.length > 0) && !ge, xe = Q.attributes && Q.attributes.some((fe) => fe.value && B(fe.value) && fe.value.value.includes(`
`)), we = le.singleAttributePerLine && Q.attributes.length > 1 ? r : i;
          ...
          function $(q, le, ue) {
            ...
            return ["{", q.call((de) => {
              ...
              return !I(ve) || !d(de) ? ge : [c([u, t(de, ge, le)]), u];
...
\r	`, U = new RegExp("([" + ee + "]+)"), ne = new RegExp("[^" + ee + "]"), se = (q) => q.replace(new RegExp("(?:^" + U.source + "|" + U.source + "$)"), "");
          ...
          function a(C) {
            let N = C.getValue();
            return !N.optional || N.type === "Identifier" && N === C.getParentNode().key ? "" : N.type === "OptionalCallExpression" || N.type === "OptionalMemberExpression" && N.computed ? "?." : "?";
          }
          function c(C) {
            return C.getValue().definite || C.match(void 0, (N, T) => T === "id" && N.type === "VariableDeclarator" && N.definite) ? "!" : "";
          }
          function l(C, N, T) {
            let A = C.getValue();
          ...
          function h(C, N, T) {
            ...
            if (!A.typeAnnotation)
              return "";
            let b = C.getParentNode(), v = b.type === "DeclareFunction" && b.id === A;
          ...
          function y(C, N, T) {
            let A = C.getValue();
            return t(A.modifiers) ? [i(" ", C.map(T, "modifiers")), " "] : "";
          }
          function p(C, N, T) {
            return C.type === "EmptyStatement" ? ";" : C.type === "BlockStatement" || T ? [" ", N] : s([r, N]);
          }
          function f(C, N, T) {
            return ["...", T("argument"), h(C, N, T)];
          }
          n.exports = { printOptionalToken: a, printDefiniteToken: c, printFunctionTypeParameters: l, printBindExpressionCallee: g, printTypeScriptModifiers: y, printTypeAnnotation: h, printRestSpread: f, adjustClause: p };
        } }), zt = Z({ "src/language-js/print/array.js"(e, n) {
          "use strict";
          ae();
          var { printDanglingComments: t } = Qe(), { builders: { line: s, softline: i, hardline: r, group: u, indent: a, ifBreak: c, fill: l } } = Le(), { getLast: h, hasNewline: g } = Ge(), { shouldPrintComma: y, hasComment: p, CommentCheckFlags: f, isNextLineEmpty: C, isNumericLiteral: N, isSignedNumericLiteral: T } = Xe(), { locStart: A } = nt(), { printOptionalToken: b, printTypeAnnotation: v } = ot();
          function B(D, m, d) {
            let o = D.getValue(), x = [], F = o.type === "TupleExpression" ? "#[" : "[", S = "]";
            if (o.elements.length === 0)
              p(o, f.Dangling) ? x.push(u([F, t(D, m), i, S])) : x.push(F, S);
            else {
              let k = h(o.elements), P = !(k && k.type === "RestElement"), O = k === null, R = Symbol("array"), M = !m.__inJestEach && o.elements.length > 1 && o.elements.every((G, re, $) => {
                let W = G && G.type;
              ...
              }), H = w(o, m), _ = P ? O ? "," : y(m) ? H ? c(",", "", { groupId: R }) : c(",") : "" : "";
              x.push(u([F, a([i, H ? E(D, m, d, _) : [I(D, m, "elements", d), _], t(D, m, true)]), i, S], { shouldBreak: M, id: R }));
            }
            return x.push(b(D), v(D, m, d)), x;
          }
          function w(D, m) {
            return D.elements.length > 1 && D.elements.every((d) => d && (N(d) || T(d) && !p(d.argument)) && !p(d, f.Trailing | f.Line, (o) => !g(m.originalText, A(o), { backwards: true })));
          }
          function I(D, m, d, o) {
            let x = [], F = [];
            return D.each((S) => {
              x.push(F, u(o())), F = [",", s], S.getValue() && C(S.getValue(), m) && F.push(i);
            }, d), x;
          }
          function E(D, m, d, o) {
            let x = [];
            return D.each((F, S, k) => {
              let P = S === k.length - 1;
              x.push([d(), P ? o : ","]), P || x.push(C(F.getValue(), m) ? [r, r] : p(k[S + 1], f.Leading | f.Line) ? r : s);
            }, "elements"), l(x);
          }
          ...
          "use strict";
          ae();
          var { printDanglingComments: t } = Qe(), { getLast: s, getPenultimate: i } = Ge(), { getFunctionParameters: r, hasComment: u, CommentCheckFlags: a, isFunctionCompositionArgs: c, isJsxNode: l, isLongCurriedCallExpression: h, shouldPrintComma: g, getCallArguments: y, iterateCallArgumentsPath: p, isNextLineEmpty: f, isCallExpression: C, isStringLiteral: N, isObjectProperty: T } = Xe(), { builders: { line: A, hardline: b, softline: v, group: B, indent: w, conditionalGroup: I, ifBreak: E, breakParent: D }, utils: { willBreak: m } } = Le(), { ArgExpansionBailout: d } = Jt(), { isConciselyPrintedArray: o } = zt();
          function x(M, H, _) {
            let G = M.getValue(), re = G.type === "ImportExpression", $ = y(G);
            if ($.length === 0)
              return ["(", t(M, H, true), ")"];
            if (P($))
            ...
            p(M, (q, le) => {
              let ue = q.getNode(), Q = [_()];
              le === U || (f(ue, H) ? (le === 0 && (ee = true), W = true, Q.push(",", b, b)) : Q.push(",", A)), ne.push(Q);
            });
            let se = !(re || G.callee && G.callee.type === "Import") && g(H, "all") ? "," : "";
            function V() {
            ...
            let oe = k($), K = S($, H);
            if (oe || K) {
              if (oe ? ne.slice(1).some(m) : ne.slice(0, -1).some(m))
                return V();
              let q = [];
              try {
                M.try(() => {
                  p(M, (le, ue) => {
                    oe && ue === 0 && (q = [[_([], { expandFirstArg: true }), ne.length > 1 ? "," : "", ee ? b : A, ee ? b : ""], ...ne.slice(1)]), K && ue === U && (q = [...ne.slice(0, -1), _([], { expandLastArg: true })]);
                  });
                });
              } catch (le) {
                if (le instanceof d)
              ...
              return [ne.some(m) ? D : "", I([["(", ...q, ")"], oe ? ["(", B(q[0], { shouldBreak: true }), ...q.slice(1), ")"] : ["(", ...ne.slice(0, -1), B(s(q), { shouldBreak: true }), ")"], V()])];
            }
            let Ee = ["(", w([v, ...ne]), E(se), v, ")"];
            return h(M) ? Ee : B(Ee, { shouldBreak: ne.some(m) || W });
          }
          function F(M) {
            let H = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
            return M.type === "ObjectExpression" && (M.properties.length > 0 || u(M)) || M.type === "ArrayExpression" && (M.elements.length > 0 || u(M)) || M.type === "TSTypeAssertion" && F(M.expression) || M.type === "TSAsExpression" && F(M.expression) || M.type === "FunctionExpression" || M.type === "ArrowFunctionExpression" && (!M.returnType || !M.returnType.typeAnnotation || M.returnType.typeAnnotation.type !== "TSTypeReference" || O(M.body)) && (M.body.type === "BlockStatement" || M.body.type === "ArrowFunctionExpression" && F(M.body, true) || M.body.type === "ObjectExpression" || M.body.type === "ArrayExpression" || !H && (C(M.body) || M.body.type === "ConditionalExpression") || l(M.body)) || M.type === "DoExpression" || M.type === "ModuleExpression";
          }
          function S(M, H) {
            let _ = s(M), G = i(M);
            return !u(_, a.Leading) && !u(_, a.Trailing) && F(_) && (!G || G.type !== _.type) && (M.length !== 2 || G.type !== "ArrowFunctionExpression" || _.type !== "ArrayExpression") && !(M.length > 1 && _.type === "ArrayExpression" && o(_, H));
          }
          function k(M) {
            if (M.length !== 2)
              return false;
            let [H, _] = M;
            return H.type === "ModuleExpression" && R(_) ? true : !u(H) && (H.type === "FunctionExpression" || H.type === "ArrowFunctionExpression" && H.body.type === "BlockStatement") && _.type !== "FunctionExpression" && _.type !== "ArrowFunctionExpression" && _.type !== "ConditionalExpression" && !F(_);
          }
          function P(M) {
          ...
          function h(y, p, f) {
            let C = y.getValue(), N = y.getParentNode(), T, A = 0;
            do
              T = y.getParentNode(A), A++;
            while (T && (a(T) || T.type === "TSNonNullExpression"));
            let b = f("object"), v = g(y, p, f), B = T && (T.type === "NewExpression" || T.type === "BindExpression" || T.type === "AssignmentExpression" && T.left.type !== "Identifier") || C.computed || C.object.type === "Identifier" && C.property.type === "Identifier" && !a(N) || (N.type === "AssignmentExpression" || N.type === "VariableDeclarator") && (c(C.object) && C.object.arguments.length > 0 || C.object.type === "TSNonNullExpression" && c(C.object.expression) && C.object.expression.arguments.length > 0 || b.label === "member-chain");
            return r(b.label === "member-chain" ? "member-chain" : "member", [b, B ? v : s(i([t, v]))]);
          }
          function g(y, p, f) {
            let C = f("property"), N = y.getValue(), T = l(y);
            return N.computed ? !N.property || u(N.property) ? [T, "[", C, "]"] : s([T, "[", i([t, C]), t, "]"]) : [T, ".", C];
          }
          n.exports = { printMemberExpression: h, printMemberLookup: g };
        } }), Nm = Z({ "src/language-js/print/member-chain.js"(e, n) {
          "use strict";
          ae();
          var { printComments: t } = Qe(), { getLast: s, isNextLineEmptyAfterIndex: i, getNextNonSpaceNonCommentCharacterIndex: r } = Ge(), u = kt(), { isCallExpression: a, isMemberExpression: c, isFunctionOrArrowExpression: l, isLongCurriedCallExpression: h, isMemberish: g, isNumericLiteral: y, isSimpleCallArgument: p, hasComment: f, CommentCheckFlags: C, isNextLineEmpty: N } = Xe(), { locEnd: T } = nt(), { builders: { join: A, hardline: b, group: v, indent: B, conditionalGroup: w, breakParent: I, label: E }, utils: { willBreak: D } } = Le(), m = no(), { printMemberLookup: d } = uo(), { printOptionalToken: o, printFunctionTypeParameters: x, printBindExpressionCallee: F } = ot();
          function S(k, P, O) {
            let R = k.getParentNode(), M = !R || R.type === "ExpressionStatement", H = [];
            function _(me) {
              let { originalText: ce } = P, he = r(ce, me, T);
              return ce.charAt(he) === ")" ? he !== false && i(ce, he + 1) : N(me, P);
            }
            function G(me) {
              let ce = me.getValue();
              a(ce) && (g(ce.callee) || a(ce.callee)) ? (H.unshift({ node: ce, printed: [t(me, [o(me), x(me, P, O), m(me, P, O)], P), _(ce) ? b : ""] }), me.call((he) => G(he), "callee")) : g(ce) ? (H.unshift({ node: ce, needsParens: u(me, P), printed: t(me, c(ce) ? d(me, P, O) : F(me, P, O), P) }), me.call((he) => G(he), "object")) : ce.type === "TSNonNullExpression" ? (H.unshift({ node: ce, printed: t(me, "!", P) }), me.call((he) => G(he), "expression")) : H.unshift({ node: ce, printed: O() });
            }
            let re = k.getValue();
            H.unshift({ node: re, printed: [o(k), x(k, P, O), m(k, P, O)] }), re.callee && k.call((me) => G(me), "callee");
            let $ = [], W = [H[0]], ee = 1;
            for (; ee < H.length && (H[ee].node.type === "TSNonNullExpression" || a(H[ee].node) || c(H[ee].node) && H[ee].node.computed && y(H[ee].node.property)); ++ee)
              W.push(H[ee]);
            if (!a(H[0].node))
              for (; ee + 1 < H.length && (g(H[ee].node) && g(H[ee + 1].node)); ++ee)
                W.push(H[ee]);
            $.push(W), W = [];
            let U = false;
            for (; ee < H.length; ++ee) {
              if (U && g(H[ee].node)) {
                if (H[ee].node.computed && y(H[ee].node.property)) {
                  W.push(H[ee]);
                  continue;
                }
                $.push(W), W = [], U = false;
              }
              (a(H[ee].node) || H[ee].node.type === "ImportExpression") && (U = true), W.push(H[ee]), f(H[ee].node, C.Trailing) && ($.push(W), W = [], U = false);
            }
            W.length > 0 && $.push(W);
            function ne(me) {
            ...
            let q = $.map(K), le = q, ue = oe ? 3 : 2, Q = $.flat(), de = Q.slice(1, -1).some((me) => f(me.node, C.Leading)) || Q.slice(0, -1).some((me) => f(me.node, C.Trailing)) || $[ue] && f($[ue][0].node, C.Leading);
            if ($.length <= ue && !de)
              return h(k) ? le : v(le);
            let ge = s($[oe ? 1 : 0]).node, ve = !a(ge) && _(ge), xe = [K($[0]), oe ? $.slice(1, 2).map(K) : "", ve ? b : "", Ee($.slice(oe ? 2 : 1))], we = H.map((me) => {
              let { node: ce } = me;
              return ce;
            }).filter(a);
            function fe() {
          ...
          "use strict";
          ae();
          var { builders: { join: t, group: s } } = Le(), i = kt(), { getCallArguments: r, hasFlowAnnotationComment: u, isCallExpression: a, isMemberish: c, isStringLiteral: l, isTemplateOnItsOwnLine: h, isTestCall: g, iterateCallArgumentsPath: y } = Xe(), p = Nm(), f = no(), { printOptionalToken: C, printFunctionTypeParameters: N } = ot();
          function T(b, v, B) {
            let w = b.getValue(), I = b.getParentNode(), E = w.type === "NewExpression", D = w.type === "ImportExpression", m = C(b), d = r(w);
            if (d.length > 0 && (!D && !E && A(w, I) || d.length === 1 && h(d[0], v.originalText) || !E && g(w, I))) {
              let F = [];
              return y(b, () => {
                F.push(B());
              }), [E ? "new " : "", B("callee"), m, N(b, v, B), "(", t(", ", F), ")"];
            }
            ...
            if (o && (w.callee.trailingComments[0].printed = true), !D && !E && c(w.callee) && !b.call((F) => i(F, v), "callee"))
              return p(b, v, B);
            let x = [E ? "new " : "", D ? "import" : B("callee"), m, o ? "/*:: ".concat(w.callee.trailingComments[0].value.slice(2).trim(), " */") : "", N(b, v, B), f(b, v, B)];
          ...
          "use strict";
          ae();
          var { isNonEmptyArray: t, getStringWidth: s } = Ge(), { builders: { line: i, group: r, indent: u, indentIfBreak: a, lineSuffixBoundary: c }, utils: { cleanDoc: l, willBreak: h, canBreak: g } } = Le(), { hasLeadingOwnLineComment: y, isBinaryish: p, isStringLiteral: f, isLiteral: C, isNumericLiteral: N, isCallExpression: T, isMemberExpression: A, getCallArguments: b, rawText: v, hasComment: B, isSignedNumericLiteral: w, isObjectProperty: I } = Xe(), { shouldInlineLogicalExpression: E } = Jn(), { printCallExpression: D } = so();
          function m(V, oe, K, Ee, q, le) {
          ...
          function d(V, oe, K) {
            let Ee = V.getValue();
            return m(V, oe, K, K("left"), [" ", Ee.operator], "right");
          }
          function o(V, oe, K) {
            return m(V, oe, K, K("id"), " =", "init");
          }
...
`) : C(V);
          ...
          function m(F, S, k, P, O) {
            ...
            return re && W ? [H, "(", ...$, ")"] : G ? [H, "(", ...$, ")"] : (A(_) || N(_) || _.type === "TypeAlias" || _.type === "UnionTypeAnnotation" || _.type === "TSUnionType" || _.type === "IntersectionTypeAnnotation" || _.type === "FunctionTypeAnnotation" && _.returnType === R) && M.length === 1 && M[0].name === null && R.this !== M[0] && M[0].typeAnnotation && R.typeParameters === null && f(M[0].typeAnnotation) && !R.rest ? k.arrowParens === "always" ? ["(", ...$, ")"] : $ : [H, "(", c([u, ...$]), l(!b(R) && v(k, "all") ? "," : ""), u, ")"];
          }
          function d(F) {
            if (!F)
              return false;
          ...
          function x(F, S) {
            ...
            if (!k)
              return false;
            let P = F.typeParameters && F.typeParameters.params;
            if (P) {
              if (P.length > 1)
                return false;
              if (P.length === 1) {
            ...
            return y(F).length === 1 && (T(k) || g(S));
          }
          n.exports = { printFunctionParameters: m, shouldHugFunctionParameters: d, shouldGroupFunctionParameters: x };
        } }), Pr = Z({ "src/language-js/print/type-annotation.js"(e, n) {
          "use strict";
          ae();
          var { printComments: t, printDanglingComments: s } = Qe(), { isNonEmptyArray: i } = Ge(), { builders: { group: r, join: u, line: a, softline: c, indent: l, align: h, ifBreak: g } } = Le(), y = kt(), { locStart: p } = nt(), { isSimpleType: f, isObjectType: C, hasLeadingOwnLineComment: N, isObjectTypePropertyAFunction: T, shouldPrintComma: A } = Xe(), { printAssignment: b } = Xt(), { printFunctionParameters: v, shouldGroupFunctionParameters: B } = wr(), { printArrayItems: w } = zt();
          function I(S) {
            if (f(S) || C(S))
              return true;
            if (S.type === "UnionTypeAnnotation" || S.type === "TSUnionType") {
              let k = S.types.filter((O) => O.type === "VoidTypeAnnotation" || O.type === "TSVoidKeyword" || O.type === "NullLiteralTypeAnnotation" || O.type === "TSNullKeyword").length, P = S.types.some((O) => O.type === "ObjectTypeAnnotation" || O.type === "TSTypeLiteral" || O.type === "GenericTypeAnnotation" || O.type === "TSTypeReference");
              if (S.types.length - 1 === k && P)
                return true;
            }
            return false;
          }
          function E(S, k, P) {
            ...
            return M.push("opaque type ", P("id"), P("typeParameters")), R.supertype && M.push(": ", P("supertype")), R.impltype && M.push(" = ", P("impltype")), M.push(O), M;
          }
          function D(S, k, P) {
            let O = k.semi ? ";" : "", R = S.getValue(), M = [];
            R.declare && M.push("declare "), M.push("type ", P("id"), P("typeParameters"));
            let H = R.type === "TSTypeAliasDeclaration" ? "typeAnnotation" : "right";
            return [b(S, k, P, M, " =", H), O];
          }
          function m(S, k, P) {
            let O = S.getValue(), R = S.map(P, "types"), M = [], H = false;
            for (let _ = 0; _ < R.length; ++_)
              _ === 0 ? M.push(R[_]) : C(O.types[_ - 1]) && C(O.types[_]) ? M.push([" & ", H ? l(R[_]) : R[_]]) : !C(O.types[_ - 1]) && !C(O.types[_]) ? M.push(l([" &", a, R[_]])) : (_ > 1 && (H = true), M.push(" & ", _ > 1 ? l(R[_]) : R[_]));
            return r(M);
          }
          function d(S, k, P) {
            ...
            if (H)
              return u(" | ", _);
            let G = M && !N(k.originalText, O), re = [g([G ? a : "", "| "]), u([a, "| "], _)];
            return y(S, k) ? r([l(re), c]) : R.type === "TupleTypeAnnotation" && R.types.length > 1 || R.type === "TSTupleType" && R.elementTypes.length > 1 ? r([l([g(["(", c]), re]), c, g(")")]) : r(M ? l(re) : re);
          }
          function o(S, k, P) {
            let O = S.getValue(), R = [], M = S.getParentNode(0), H = S.getParentNode(1), _ = S.getParentNode(2), G = O.type === "TSFunctionType" || !((M.type === "ObjectTypeProperty" || M.type === "ObjectTypeInternalSlot") && !M.variance && !M.optional && p(M) === p(O) || M.type === "ObjectTypeCallProperty" || _ && _.type === "DeclareFunction"), re = G && (M.type === "TypeAnnotation" || M.type === "TSTypeAnnotation"), $ = re && G && (M.type === "TypeAnnotation" || M.type === "TSTypeAnnotation") && H.type === "ArrowFunctionExpression";
            T(M) && (G = true, re = true), $ && R.push("(");
            let W = v(S, P, k, false, true), ee = O.returnType || O.predicate || O.typeAnnotation ? [G ? " => " : ": ", P("returnType"), P("predicate"), P("typeAnnotation")] : "", U = B(O, ee);
            return R.push(U ? r(W) : W), ee && R.push(ee), $ && R.push(")"), r(R);
          }
          function x(S, k, P) {
            let O = S.getValue(), R = O.type === "TSTupleType" ? "elementTypes" : "types", M = O[R], H = i(M), _ = H ? c : "";
            return r(["[", l([_, w(S, k, R, P)]), g(H && A(k, "all") ? "," : ""), s(S, k, true), _, "]"]);
          }
          function F(S, k, P) {
            let O = S.getValue(), R = O.type === "OptionalIndexedAccessType" && O.optional ? "?.[" : "[";
            return [P("objectType"), R, P("indexType"), "]"];
          }
          n.exports = { printOpaqueType: E, printTypeAlias: D, printIntersectionType: m, printUnionType: d, printFunctionType: o, printTupleType: x, printIndexedAccessType: F, shouldHugType: I };
        } }), _r = Z({ "src/language-js/print/type-parameters.js"(e, n) {
          "use strict";
          ae();
          var { printDanglingComments: t } = Qe(), { builders: { join: s, line: i, hardline: r, softline: u, group: a, indent: c, ifBreak: l } } = Le(), { isTestCall: h, hasComment: g, CommentCheckFlags: y, isTSXFile: p, shouldPrintComma: f, getFunctionParameters: C, isObjectType: N } = Xe(), { createGroupIdMapper: T } = Ge(), { shouldHugType: A } = Pr(), { isArrowFunctionVariableDeclarator: b } = Xt(), v = T("typeParameters");
          function B(E, D, m, d) {
            let o = E.getValue();
            if (!o[d])
              return "";
            if (!Array.isArray(o[d]))
              return m(d);
            let x = E.getNode(2), F = x && h(x);
            if (!E.match((O) => !(O[d].length === 1 && N(O[d][0])), void 0, (O, R) => R === "typeAnnotation", (O) => O.type === "Identifier", b) && (F || o[d].length === 0 || o[d].length === 1 && (o[d][0].type === "NullableTypeAnnotation" || A(o[d][0]))))
              return ["<", s(", ", E.map(m, d)), w(E, D), ">"];
            let P = o.type === "TSTypeParameterInstantiation" ? "" : C(o).length === 1 && p(D) && !o[d][0].constraint && E.getParentNode().type === "ArrowFunctionExpression" ? "," : f(D, "all") ? l(",") : "";
            return a(["<", c([u, s([",", i], E.map(m, d))]), P, u, ">"], { id: v(o) });
          }
          function w(E, D) {
            let m = E.getValue();
            if (!g(m, y.Dangling))
              return "";
            let d = !g(m, y.Line), o = t(E, D, d);
            return d ? o : [o, r];
          }
          function I(E, D, m) {
            let d = E.getValue(), o = [], x = E.getParentNode();
            return x.type === "TSMappedType" ? (o.push("[", m("name")), d.constraint && o.push(" in ", m("constraint")), x.nameType && o.push(" as ", E.callParent(() => m("nameType"))), o.push("]"), o) : (d.variance && o.push(m("variance")), o.push(m("name")), d.bound && o.push(": ", m("bound")), d.constraint && o.push(" extends ", m("constraint")), d.default && o.push(" = ", m("default")), o);
          }
          ...
          "use strict";
          ae();
          var { printComments: t } = Qe(), { printString: s, printNumber: i } = Ge(), { isNumericLiteral: r, isSimpleNumber: u, isStringLiteral: a, isStringPropSafeToUnquote: c, rawText: l } = Xe(), { printAssignment: h } = Xt(), g = /* @__PURE__ */ new WeakMap();
          function y(f, C, N) {
            let T = f.getNode();
            if (T.computed)
              return ["[", N("key"), "]"];
            ...
            if (T.type === "ClassPrivateProperty" && b.type === "Identifier")
              return ["#", N("key")];
            if (C.quoteProps === "consistent" && !g.has(A)) {
              let v = (A.properties || A.body || A.members).some((B) => !B.computed && B.key && a(B.key) && !c(B, C));
              g.set(A, v);
            }
            if ((b.type === "Identifier" || r(b) && u(i(l(b))) && String(b.value) === i(l(b)) && !(C.parser === "typescript" || C.parser === "babel-ts")) && (C.parser === "json" || C.quoteProps === "consistent" && g.get(A))) {
              let v = s(JSON.stringify(b.type === "Identifier" ? b.name : b.value.toString()), C);
              return f.call((B) => t(B, v, C), "key");
            }
            return c(T, C) && (C.quoteProps === "as-needed" || C.quoteProps === "consistent" && !g.get(A)) ? f.call((v) => t(v, /^\d/.test(b.value) ? i(b.value) : b.value, C), "key") : N("key");
          }
          function p(f, C, N) {
            return f.getValue().shorthand ? N("value") : h(f, C, N, y(f, C, N), ":", "value");
          }
          n.exports = { printProperty: p, printPropertyKey: y };
        } }), Ir = Z({ "src/language-js/print/function.js"(e, n) {
          "use strict";
          ae();
          var t = Ut(), { printDanglingComments: s, printCommentsSeparately: i } = Qe(), r = st(), { getNextNonSpaceNonCommentCharacterIndex: u } = Ge(), { builders: { line: a, softline: c, group: l, indent: h, ifBreak: g, hardline: y, join: p, indentIfBreak: f }, utils: { removeLines: C, willBreak: N } } = Le(), { ArgExpansionBailout: T } = Jt(), { getFunctionParameters: A, hasLeadingOwnLineComment: b, isFlowAnnotationComment: v, isJsxNode: B, isTemplateOnItsOwnLine: w, shouldPrintComma: I, startsWithNoLookaheadToken: E, isBinaryish: D, isLineComment: m, hasComment: d, getComments: o, CommentCheckFlags: x, isCallLikeExpression: F, isCallExpression: S, getCallArguments: k, hasNakedLeftSide: P, getLeftSide: O } = Xe(), { locEnd: R } = nt(), { printFunctionParameters: M, shouldGroupFunctionParameters: H } = wr(), { printPropertyKey: _ } = Kt(), { printFunctionTypeParameters: G } = ot();
          ...
          function $(ue, Q, de) {
            ...
            return !ve || ve === "init" || ve === "method" || ve === "constructor" ? xe.async && we.push("async ") : (t.ok(ve === "get" || ve === "set"), we.push(ve, " ")), xe.generator && we.push("*"), we.push(_(ue, Q, de), ge.optional || ge.key.optional ? "?" : ""), ge === xe ? we.push(W(ue, Q, de)) : xe.type === "FunctionExpression" ? we.push(ue.call((fe) => W(fe, Q, de), "value")) : we.push(de("value")), we;
          }
          function W(ue, Q, de) {
          ...
          function U(ue, Q, de, ge, ve, xe) {
            ...
            return xe.body.type === "SequenceExpression" && (ve = l(["(", h([c, ve]), c, ")"])), l([l(h([pe || me ? c : "", l(p([" =>", a], de), { shouldBreak: ge })]), { id: J, shouldBreak: he }), " =>", f(ce ? h([a, ve]) : [" ", ve], { groupId: J }), pe ? g(c, "", { groupId: J }) : ""]);
          }
          function ne(ue, Q, de, ge) {
            ...
            if (ve.body.type === "SequenceExpression")
              return l([...pe, l([" (", h([c, we]), c, ")"])]);
            let me = (ge && ge.expandLastArg || ue.getParentNode().type === "JSXExpressionContainer") && !d(ve), ce = ge && ge.expandLastArg && I(Q, "all"), he = ve.body.type === "ConditionalExpression" && !E(ve.body, false);
            return l([...pe, l([h([a, he ? g("", "(") : "", we, he ? g("", ")") : ""]), me ? [g(ce ? "," : ""), c] : ""])]);
          }
          function se(ue) {
            let Q = A(ue);
            return Q.length === 1 && !ue.typeParameters && !d(ue, x.Dangling) && Q[0].type === "Identifier" && !Q[0].typeAnnotation && !d(Q[0]) && !Q[0].optional && !ue.predicate && !ue.returnType;
          }
          function V(ue, Q) {
          ...
          function K(ue, Q, de) {
            ...
            ge.argument && (le(Q, ge.argument) ? xe.push([" (", h([y, de("argument")]), y, ")"]) : D(ge.argument) || ge.argument.type === "SequenceExpression" ? xe.push(l([g(" (", " "), h([c, de("argument")]), c, g(")")])) : xe.push(" ", de("argument")));
            let we = o(ge), fe = r(we), pe = fe && m(fe);
            return pe && xe.push(ve), d(ge, x.Dangling) && xe.push(" ", s(ue, Q, true)), pe || xe.push(ve), xe;
          }
          function Ee(ue, Q, de) {
          ...
          "use strict";
          ae();
          var { isNonEmptyArray: t, hasNewline: s } = Ge(), { builders: { line: i, hardline: r, join: u, breakParent: a, group: c } } = Le(), { locStart: l, locEnd: h } = nt(), { getParentExportDeclaration: g } = Xe();
          function y(T, A, b) {
            let v = T.getValue();
            return c([u(i, T.map(b, "decorators")), C(v, A) ? r : i]);
          }
          function p(T, A, b) {
          ...
          function f(T, A, b) {
            ...
            return [g(T) ? r : w ? a : "", u(i, T.map(b, "decorators")), i];
          }
          function C(T, A) {
          ...
          n.exports = { printDecorators: f, printClassMemberDecorators: y, printDecoratorsBeforeExport: p, hasDecoratorsBeforeExport: N };
        } }), Yt = Z({ "src/language-js/print/class.js"(e, n) {
          "use strict";
          ae();
          var { isNonEmptyArray: t, createGroupIdMapper: s } = Ge(), { printComments: i, printDanglingComments: r } = Qe(), { builders: { join: u, line: a, hardline: c, softline: l, group: h, indent: g, ifBreak: y } } = Le(), { hasComment: p, CommentCheckFlags: f } = Xe(), { getTypeParametersGroupId: C } = _r(), { printMethod: N } = Ir(), { printOptionalToken: T, printTypeAnnotation: A, printDefiniteToken: b } = ot(), { printPropertyKey: v } = Kt(), { printAssignment: B } = Xt(), { printClassMemberDecorators: w } = Un();
          function I(k, P, O) {
            let R = k.getValue(), M = [];
            R.declare && M.push("declare "), R.abstract && M.push("abstract "), M.push("class");
            let H = R.id && p(R.id, f.Trailing) || R.typeParameters && p(R.typeParameters, f.Trailing) || R.superClass && p(R.superClass) || t(R.extends) || t(R.mixins) || t(R.implements), _ = [], G = [];
            if (R.id && _.push(" ", O("id")), _.push(O("typeParameters")), R.superClass) {
              let re = [x(k, P, O), O("superTypeParameters")], $ = k.call((W) => ["extends ", i(W, re, P)], "superClass");
              H ? G.push(a, h($)) : G.push(" ", $);
            } else
              G.push(o(k, P, O, "extends"));
            if (G.push(o(k, P, O, "mixins"), o(k, P, O, "implements")), H) {
              let re;
              d(R) ? re = [..._, g(G)] : re = g([..._, G]), M.push(h(re, { id: E(R) }));
            } else
              M.push(..._, ...G);
          ...
          function D(k) {
            return y(c, "", { groupId: E(k) });
          }
          function m(k) {
            return ["superClass", "extends", "mixins", "implements"].filter((P) => Boolean(k[P])).length > 1;
          }
          function d(k) {
            return k.typeParameters && !p(k.typeParameters, f.Trailing | f.Line) && !m(k);
          }
          function o(k, P, O, R) {
            let M = k.getValue();
            if (!t(M[R]))
            ...
            return [d(M) ? y(" ", a, { groupId: C(M.typeParameters) }) : a, H, H && c, R, h(g([a, u([",", a], k.map(O, R))]))];
          }
          function x(k, P, O) {
            let R = O("superClass");
            return k.getParentNode().type === "AssignmentExpression" ? h(y(["(", g([l, R]), l, ")"], R)) : R;
          }
          function F(k, P, O) {
            let R = k.getValue(), M = [];
            return t(R.decorators) && M.push(w(k, P, O)), R.accessibility && M.push(R.accessibility + " "), R.readonly && M.push("readonly "), R.declare && M.push("declare "), R.static && M.push("static "), (R.type === "TSAbstractMethodDefinition" || R.abstract) && M.push("abstract "), R.override && M.push("override "), M.push(N(k, P, O)), M;
          }
          function S(k, P, O) {
            let R = k.getValue(), M = [], H = P.semi ? ";" : "";
            return t(R.decorators) && M.push(w(k, P, O)), R.accessibility && M.push(R.accessibility + " "), R.declare && M.push("declare "), R.static && M.push("static "), (R.type === "TSAbstractPropertyDefinition" || R.abstract) && M.push("abstract "), R.override && M.push("override "), R.readonly && M.push("readonly "), R.variance && M.push(O("variance")), R.type === "ClassAccessorProperty" && M.push("accessor "), M.push(v(k, P, O), T(k), b(k), A(k, P, O)), [B(k, P, O, M, " =", "value"), H];
          }
          ...
          "use strict";
          ae();
          var { isNonEmptyArray: t } = Ge(), { builders: { join: s, line: i, group: r, indent: u, ifBreak: a } } = Le(), { hasComment: c, identity: l, CommentCheckFlags: h } = Xe(), { getTypeParametersGroupId: g } = _r(), { printTypeScriptModifiers: y } = ot();
          function p(f, C, N) {
            let T = f.getValue(), A = [];
            T.declare && A.push("declare "), T.type === "TSInterfaceDeclaration" && A.push(T.abstract ? "abstract " : "", y(f, C, N)), A.push("interface");
            let b = [], v = [];
            T.type !== "InterfaceTypeAnnotation" && b.push(" ", N("id"), N("typeParameters"));
            let B = T.typeParameters && !c(T.typeParameters, h.Trailing | h.Line);
            return t(T.extends) && v.push(B ? a(" ", i, { groupId: g(T.typeParameters) }) : i, "extends ", (T.extends.length === 1 ? l : u)(s([",", i], f.map(N, "extends")))), T.id && c(T.id, h.Trailing) || t(T.extends) ? B ? A.push(r([...b, u(v)])) : A.push(r(u([...b, ...v]))) : A.push(...b, ...v), A.push(" ", N("body")), r(A);
          }
          n.exports = { printInterface: p };
        } }), io = Z({ "src/language-js/print/module.js"(e, n) {
          "use strict";
          ae();
          var { isNonEmptyArray: t } = Ge(), { builders: { softline: s, group: i, indent: r, join: u, line: a, ifBreak: c, hardline: l } } = Le(), { printDanglingComments: h } = Qe(), { hasComment: g, CommentCheckFlags: y, shouldPrintComma: p, needsHardlineAfterDanglingComment: f, isStringLiteral: C, rawText: N } = Xe(), { locStart: T, hasSameLoc: A } = nt(), { hasDecoratorsBeforeExport: b, printDecoratorsBeforeExport: v } = Un();
          function B(S, k, P) {
            let O = S.getValue(), R = k.semi ? ";" : "", M = [], { importKind: H } = O;
            return M.push("import"), H && H !== "value" && M.push(" ", H), M.push(m(S, k, P), D(S, k, P), o(S, k, P), R), M;
          }
          function w(S, k, P) {
            let O = S.getValue(), R = [];
            b(O) && R.push(v(S, k, P));
            let { type: M, exportKind: H, declaration: _ } = O;
            return R.push("export"), (O.default || M === "ExportDefaultDeclaration") && R.push(" default"), g(O, y.Dangling) && (R.push(" ", h(S, k, true)), f(O) && R.push(l)), _ ? R.push(" ", P("declaration")) : R.push(H === "type" ? " type" : "", m(S, k, P), D(S, k, P), o(S, k, P)), E(O, k) && R.push(";"), R;
          }
          function I(S, k, P) {
            let O = S.getValue(), R = k.semi ? ";" : "", M = [], { exportKind: H, exported: _ } = O;
            return M.push("export"), H === "type" && M.push(" type"), M.push(" *"), _ && M.push(" as ", P("exported")), M.push(D(S, k, P), o(S, k, P), R), M;
          }
          function E(S, k) {
            if (!k.semi)
              return false;
            let { type: P, declaration: O } = S, R = S.default || P === "ExportDefaultDeclaration";
            if (!O)
              return true;
            let { type: M } = O;
          ...
          function D(S, k, P) {
            ...
            if (!O.source)
              return "";
            let R = [];
            return d(O, k) || R.push(" from"), R.push(" ", P("source")), R;
          }
          function m(S, k, P) {
            let O = S.getValue();
            if (d(O, k))
            ...
            if (t(O.specifiers)) {
              let M = [], H = [];
              S.each(() => {
                let _ = S.getValue().type;
                if (_ === "ExportNamespaceSpecifier" || _ === "ExportDefaultSpecifier" || _ === "ImportNamespaceSpecifier" || _ === "ImportDefaultSpecifier")
                  M.push(P());
                else if (_ === "ExportSpecifier" || _ === "ImportSpecifier")
                  H.push(P());
                else
                  throw new Error("Unknown specifier type ".concat(JSON.stringify(_)));
              }, "specifiers"), R.push(u(", ", M)), H.length > 0 && (M.length > 0 && R.push(", "), H.length > 1 || M.length > 0 || O.specifiers.some((G) => g(G)) ? R.push(i(["{", r([k.bracketSpacing ? a : s, u([",", a], H)]), c(p(k) ? "," : ""), k.bracketSpacing ? a : s, "}"])) : R.push(["{", k.bracketSpacing ? " " : "", ...H, k.bracketSpacing ? " " : "", "}"]));
            } else
              R.push("{}");
            return R;
          }
          function d(S, k) {
            let { type: P, importKind: O, source: R, specifiers: M } = S;
            return P !== "ImportDeclaration" || t(M) || O === "type" ? false : !/{\s*}/.test(k.originalText.slice(T(S), T(R)));
          }
          function o(S, k, P) {
            let O = S.getNode();
            return t(O.assertions) ? [" assert {", k.bracketSpacing ? " " : "", u(", ", S.map(P, "assertions")), k.bracketSpacing ? " " : "", "}"] : "";
          }
          function x(S, k, P) {
            let O = S.getNode(), { type: R } = O, M = [], H = R === "ImportSpecifier" ? O.importKind : O.exportKind;
            H && H !== "value" && M.push(H, " ");
            let _ = R.startsWith("Import"), G = _ ? "imported" : "local", re = _ ? "local" : "exported", $ = O[G], W = O[re], ee = "", U = "";
            return R === "ExportNamespaceSpecifier" || R === "ImportNamespaceSpecifier" ? ee = "*" : $ && (ee = P(G)), W && !F(O) && (U = P(re)), M.push(ee, ee && U ? " as " : "", U), M;
          }
          function F(S) {
            if (S.type !== "ImportSpecifier" && S.type !== "ExportSpecifier")
              return false;
            let { local: k, [S.type === "ImportSpecifier" ? "imported" : "exported"]: P } = S;
            if (k.type !== P.type || !A(k, P))
              return false;
            if (C(k))
              return k.value === P.value && N(k) === N(P);
            switch (k.type) {
              case "Identifier":
          ...
          "use strict";
          ae();
          var { printDanglingComments: t } = Qe(), { builders: { line: s, softline: i, group: r, indent: u, ifBreak: a, hardline: c } } = Le(), { getLast: l, hasNewlineInRange: h, hasNewline: g, isNonEmptyArray: y } = Ge(), { shouldPrintComma: p, hasComment: f, getComments: C, CommentCheckFlags: N, isNextLineEmpty: T } = Xe(), { locStart: A, locEnd: b } = nt(), { printOptionalToken: v, printTypeAnnotation: B } = ot(), { shouldHugFunctionParameters: w } = wr(), { shouldHugType: I } = Pr(), { printHardlineAfterHeritage: E } = Yt();
          function D(m, d, o) {
            let x = d.semi ? ";" : "", F = m.getValue(), S;
            F.type === "TSTypeLiteral" ? S = "members" : F.type === "TSInterfaceBody" ? S = "body" : S = "properties";
            let k = F.type === "ObjectTypeAnnotation", P = [S];
            k && P.push("indexers", "callProperties", "internalSlots");
            let O = P.map((V) => F[V][0]).sort((V, oe) => A(V) - A(oe))[0], R = m.getParentNode(0), M = k && R && (R.type === "InterfaceDeclaration" || R.type === "DeclareInterface" || R.type === "DeclareClass") && m.getName() === "body", H = F.type === "TSInterfaceBody" || M || F.type === "ObjectPattern" && R.type !== "FunctionDeclaration" && R.type !== "FunctionExpression" && R.type !== "ArrowFunctionExpression" && R.type !== "ObjectMethod" && R.type !== "ClassMethod" && R.type !== "ClassPrivateMethod" && R.type !== "AssignmentPattern" && R.type !== "CatchClause" && F.properties.some((V) => V.value && (V.value.type === "ObjectPattern" || V.value.type === "ArrayPattern")) || F.type !== "ObjectPattern" && O && h(d.originalText, A(F), A(O)), _ = M ? ";" : F.type === "TSInterfaceBody" || F.type === "TSTypeLiteral" ? a(x, ";") : ",", G = F.type === "RecordExpression" ? "#{" : F.exact ? "{|" : "{", re = F.exact ? "|}" : "}", $ = [];
            for (let V of P)
              m.each((oe) => {
                let K = oe.getValue();
                $.push({ node: K, printed: o(), loc: A(K) });
              }, V);
            P.length > 1 && $.sort((V, oe) => V.loc - oe.loc);
            let W = [], ee = $.map((V) => {
              let oe = [...W, r(V.printed)];
              return W = [_, s], (V.node.type === "TSPropertySignature" || V.node.type === "TSMethodSignature" || V.node.type === "TSConstructSignatureDeclaration") && f(V.node, N.PrettierIgnore) && W.shift(), T(V.node, d) && W.push(c), oe;
            });
            if (F.inexact) {
              let V;
              if (f(F, N.Dangling)) {
                let oe = f(F, N.Line);
                V = [t(m, d, true), oe || g(d.originalText, b(l(C(F)))) ? c : s, "..."];
              } else
                V = ["..."];
              ee.push([...W, ...V]);
            }
            ...
            if (ee.length === 0) {
              if (!f(F, N.Dangling))
                return [G, re, B(m, d, o)];
              se = r([G, t(m, d), i, re, v(m), B(m, d, o)]);
            } else
              se = [M && y(F.properties) ? E(R) : "", G, u([d.bracketSpacing ? s : i, ...ee]), a(ne && (_ !== "," || p(d)) ? _ : ""), d.bracketSpacing ? s : i, re, v(m), B(m, d, o)];
            return m.match((V) => V.type === "ObjectPattern" && !V.decorators, (V, oe, K) => w(V) && (oe === "params" || oe === "parameters" || oe === "this" || oe === "rest") && K === 0) || m.match(I, (V, oe) => oe === "typeAnnotation", (V, oe) => oe === "typeAnnotation", (V, oe, K) => w(V) && (oe === "params" || oe === "parameters" || oe === "this" || oe === "rest") && K === 0) || !H && m.match((V) => V.type === "ObjectPattern", (V) => V.type === "AssignmentExpression" || V.type === "VariableDeclarator") ? se : r(se, { shouldBreak: H });
          }
          n.exports = { printObject: D };
        } }), wm = Z({ "src/language-js/print/flow.js"(e, n) {
          "use strict";
          ae();
          var t = Ut(), { printDanglingComments: s } = Qe(), { printString: i, printNumber: r } = Ge(), { builders: { hardline: u, softline: a, group: c, indent: l } } = Le(), { getParentExportDeclaration: h, isFunctionNotation: g, isGetterOrSetter: y, rawText: p, shouldPrintComma: f } = Xe(), { locStart: C, locEnd: N } = nt(), { printClass: T } = Yt(), { printOpaqueType: A, printTypeAlias: b, printIntersectionType: v, printUnionType: B, printFunctionType: w, printTupleType: I, printIndexedAccessType: E } = Pr(), { printInterface: D } = ao(), { printTypeParameter: m, printTypeParameters: d } = _r(), { printExportDeclaration: o, printExportAllDeclaration: x } = io(), { printArrayItems: F } = zt(), { printObject: S } = zn(), { printPropertyKey: k } = Kt(), { printOptionalToken: P, printTypeAnnotation: O, printRestSpread: R } = ot();
          function M(_, G, re) {
            let $ = _.getValue(), W = G.semi ? ";" : "", ee = [];
            switch ($.type) {
              case "DeclareClass":
                return H(_, T(_, G, re));
              case "DeclareFunction":
                return H(_, ["function ", re("id"), $.predicate ? " " : "", re("predicate"), W]);
              case "DeclareModule":
                return H(_, ["module ", re("id"), " ", re("body")]);
              case "DeclareModuleExports":
                return H(_, ["module.exports", ": ", re("typeAnnotation"), W]);
              case "DeclareVariable":
                return H(_, ["var ", re("id"), W]);
              ...
              case "GenericTypeAnnotation":
                return [re("id"), d(_, G, re, "typeParameters")];
              ...
              case "EnumSymbolBody": {
                ...
                if ($.members.length === 0 && !$.hasUnknownMembers)
                  ...
                  let U = $.members.length > 0 ? [u, F(_, G, "members", re), $.hasUnknownMembers || f(G) ? "," : ""] : [];
                  ee.push(c(["{", l([...U, ...$.hasUnknownMembers ? [u, "..."] : []]), s(_, G, true), u, "}"]));
                }
                return ee;
              }
              ...
              case "FunctionTypeParam": {
                let U = $.name ? re("name") : _.getParentNode().this === $ ? "this" : "";
                return [U, P(_), U ? ": " : "", re("typeAnnotation")];
              }
              ...
              case "ObjectTypeProperty": {
                let U = "";
                return $.proto ? U = "proto " : $.static && (U = "static "), [U, y($) ? $.kind + " " : "", $.variance ? re("variance") : "", k(_, G, re), P(_), g($) ? "" : ": ", re("value")];
              }
              case "ObjectTypeAnnotation":
                return S(_, G, re);
              case "ObjectTypeInternalSlot":
                return [$.static ? "static " : "", "[[", re("id"), "]]", P(_), $.method ? "" : ": ", re("value")];
              ...
              case "TypeCastExpression":
                return ["(", re("expression"), O(_, G, re), ")"];
              case "TypeParameterDeclaration":
              case "TypeParameterInstantiation": {
                let U = d(_, G, re, "params");
                if (G.parser === "flow") {
                  let ne = C($), se = N($), V = G.originalText.lastIndexOf("/*", ne), oe = G.originalText.indexOf("*/", se);
                  if (V !== -1 && oe !== -1) {
        ...
        } }), Pm = Z({ "src/language-js/utils/is-ts-keyword-type.js"(e, n) {
          "use strict";
          ae();
          function t(s) {
            let { type: i } = s;
          ...
          "use strict";
          ae();
          var { hasNewlineInRange: t } = Ge(), { isJsxNode: s, getComments: i, isCallExpression: r, isMemberExpression: u } = Xe(), { locStart: a, locEnd: c } = nt(), l = _t(), { builders: { line: h, softline: g, group: y, indent: p, align: f, ifBreak: C, dedent: N, breakParent: T } } = Le();
          function A(I) {
            let E = [I];
            for (let D = 0; D < E.length; D++) {
              let m = E[D];
              for (let d of ["test", "consequent", "alternate"]) {
                let o = m[d];
                if (s(o))
                  return true;
          ...
          function b(I, E, D) {
            let m = I.getValue(), d = m.type === "ConditionalExpression", o = d ? "alternate" : "falseType", x = I.getParentNode(), F = d ? D("test") : [D("checkType"), " ", "extends", " ", D("extendsType")];
            return x.type === m.type && x[o] === m ? f(2, F) : F;
          }
          ...
          function B(I) {
            ...
            let D, m = E;
            for (let d = 0; !D; d++) {
              let o = I.getParentNode(d);
              if (r(o) && o.callee === m || u(o) && o.object === m || o.type === "TSNonNullExpression" && o.expression === m) {
                m = o;
                continue;
              }
              o.type === "NewExpression" && o.callee === m || o.type === "TSAsExpression" && o.expression === m ? (D = I.getParentNode(d + 1), m = o) : D = o;
            }
            return m === E ? false : D[v.get(D.type)] === m;
          }
          function w(I, E, D) {
            let m = I.getValue(), d = m.type === "ConditionalExpression", o = d ? "consequent" : "trueType", x = d ? "alternate" : "falseType", F = d ? ["test"] : ["checkType", "extendsType"], S = m[o], k = m[x], P = [], O = false, R = I.getParentNode(), M = R.type === m.type && F.some((K) => R[K] === m), H = R.type === m.type && !M, _, G, re = 0;
            do
              G = _ || m, _ = I.getParentNode(re), re++;
            while (_ && _.type === m.type && F.every((K) => _[K] !== G));
            let $ = _ || R, W = G;
            if (d && (s(m[F[0]]) || s(S) || s(k) || A(W))) {
              O = true, H = true;
              let K = (q) => [C("("), p([g, q]), g, C(")")], Ee = (q) => q.type === "NullLiteral" || q.type === "Literal" && q.value === null || q.type === "Identifier" && q.name === "undefined";
              P.push(" ? ", Ee(S) ? D(o) : K(D(o)), " : ", k.type === m.type || Ee(k) ? D(x) : K(D(x)));
            } else {
              let K = [h, "? ", S.type === m.type ? C("", "(") : "", f(2, D(o)), S.type === m.type ? C("", ")") : "", h, ": ", k.type === m.type ? D(x) : f(2, D(x))];
              P.push(R.type !== m.type || R[x] === m || M ? K : E.useTabs ? N(p(K)) : f(Math.max(0, E.tabWidth - 2), K));
            }
            let U = [...F.map((K) => i(m[K])), i(S), i(k)].flat().some((K) => l(K) && t(E.originalText, a(K), c(K))), ne = (K) => R === $ ? y(K, { shouldBreak: U }) : U ? [K, T] : K, se = !O && (u(R) || R.type === "NGPipeExpression" && R.left === m) && !R.computed, V = B(I), oe = ne([b(I, E, D), H ? P : p(P), d && se && !V ? g : ""]);
            return M || V ? y([p([g, oe]), g]) : oe;
          }
          n.exports = { printTernary: w };
        } }), co = Z({ "src/language-js/print/statement.js"(e, n) {
          "use strict";
          ae();
          var { builders: { hardline: t } } = Le(), s = kt(), { getLeftSidePathName: i, hasNakedLeftSide: r, isJsxNode: u, isTheOnlyJsxElementInMarkdown: a, hasComment: c, CommentCheckFlags: l, isNextLineEmpty: h } = Xe(), { shouldPrintParamsWithoutParens: g } = Ir();
          function y(v, B, w, I) {
            let E = v.getValue(), D = [], m = E.type === "ClassBody", d = p(E[I]);
            return v.each((o, x, F) => {
              let S = o.getValue();
              if (S.type === "EmptyStatement")
                return;
              let k = w();
              !B.semi && !m && !a(B, o) && f(o, B) ? c(S, l.Leading) ? D.push(w([], { needsSemi: true })) : D.push(";", k) : D.push(k), !B.semi && m && A(S) && b(S, F[x + 1]) && D.push(";"), S !== d && (D.push(t), h(S, B) && D.push(t));
            }, I), D;
          }
          function p(v) {
          ...
          function f(v, B) {
            return v.getNode().type !== "ExpressionStatement" ? false : v.call((I) => C(I, B), "expression");
          }
          function C(v, B) {
            let w = v.getValue();
            switch (w.type) {
            ...
            return s(v, B) ? true : r(w) ? v.call((I) => C(I, B), ...i(v, w)) : false;
          }
          function N(v, B, w) {
            return y(v, B, w, "body");
          }
          function T(v, B, w) {
            return y(v, B, w, "consequent");
          }
          var A = (v) => {
            let { type: B } = v;
          ...
          "use strict";
          ae();
          var { printDanglingComments: t } = Qe(), { isNonEmptyArray: s } = Ge(), { builders: { hardline: i, indent: r } } = Le(), { hasComment: u, CommentCheckFlags: a, isNextLineEmpty: c } = Xe(), { printHardlineAfterHeritage: l } = Yt(), { printBody: h } = co();
          function g(p, f, C) {
            let N = p.getValue(), T = [];
          ...
          function y(p, f, C) {
            ...
            let v = [];
            if (T && p.each((B, w, I) => {
              v.push(C()), (w < I.length - 1 || A || b) && (v.push(i), c(B.getValue(), f) && v.push(i));
            }, "directives"), A && v.push(h(p, f, C)), b && v.push(t(p, f, true)), N.type === "Program") {
              let B = p.getParentNode();
              (!B || B.type !== "ModuleExpression") && v.push(i);
            }
            return v;
          }
          n.exports = { printBlock: g, printBlockBody: y };
        } }), _m = Z({ "src/language-js/print/typescript.js"(e, n) {
          "use strict";
          ae();
          var { printDanglingComments: t } = Qe(), { hasNewlineInRange: s } = Ge(), { builders: { join: i, line: r, hardline: u, softline: a, group: c, indent: l, conditionalGroup: h, ifBreak: g } } = Le(), { isLiteral: y, getTypeScriptMappedTypeModifier: p, shouldPrintComma: f, isCallExpression: C, isMemberExpression: N } = Xe(), T = Pm(), { locStart: A, locEnd: b } = nt(), { printOptionalToken: v, printTypeScriptModifiers: B } = ot(), { printTernary: w } = oo(), { printFunctionParameters: I, shouldGroupFunctionParameters: E } = wr(), { printTemplateLiteral: D } = It(), { printArrayItems: m } = zt(), { printObject: d } = zn(), { printClassProperty: o, printClassMethod: x } = Yt(), { printTypeParameter: F, printTypeParameters: S } = _r(), { printPropertyKey: k } = Kt(), { printFunction: P, printMethodInternal: O } = Ir(), { printInterface: R } = ao(), { printBlock: M } = lo(), { printTypeAlias: H, printIntersectionType: _, printUnionType: G, printFunctionType: re, printTupleType: $, printIndexedAccessType: W } = Pr();
          function ee(U, ne, se) {
            let V = U.getValue();
            ...
            switch (V.type) {
              case "TSThisType":
                return "this";
              case "TSTypeAssertion": {
                let Ee = !(V.expression.type === "ArrayExpression" || V.expression.type === "ObjectExpression"), q = c(["<", l([a, se("typeAnnotation")]), a, ">"]), le = [g("("), l([a, se("expression")]), a, g(")")];
                return Ee ? h([[q, se("expression")], [q, c(le, { shouldBreak: true })], [q, se("expression")]]) : c([q, se("expression")]);
              }
              ...
              case "TSAsExpression": {
                ...
                return C(Ee) && Ee.callee === V || N(Ee) && Ee.object === V ? c([l([a, ...K]), a]) : K;
              }
              case "TSArrayType":
              ...
              case "TSIndexSignature": {
                let Ee = U.getParentNode(), q = V.parameters.length > 1 ? g(f(ne) ? "," : "") : "", le = c([l([a, i([", ", a], U.map(se, "parameters"))]), q, a]);
              ...
              case "TSMappedType": {
                ...
                return c(["{", l([ne.bracketSpacing ? r : a, V.readonly ? [p(V.readonly, "readonly"), " "] : "", B(U, ne, se), se("typeParameter"), V.optional ? p(V.optional, "?") : "", V.typeAnnotation ? ": " : "", se("typeAnnotation"), g(oe)]), t(U, ne, true), ne.bracketSpacing ? r : a, "}"], { shouldBreak: Ee });
              }
              ...
              case "TSEnumDeclaration":
                return V.declare && K.push("declare "), V.modifiers && K.push(B(U, ne, se)), V.const && K.push("const "), K.push("enum ", se("id"), " "), V.members.length === 0 ? K.push(c(["{", t(U, ne), a, "}"])) : K.push(c(["{", l([u, m(U, ne, "members", se), f(ne, "es5") ? "," : ""]), t(U, ne, true), u, "}"])), K;
              case "TSEnumMember":
              ...
              case "TSModuleDeclaration": {
                let Ee = U.getParentNode(), q = y(V.id), le = Ee.type === "TSModuleDeclaration", ue = V.body && V.body.type === "TSModuleDeclaration";
                if (le)
                  K.push(".");
                else {
          ...
          "use strict";
          ae();
          var { hasNewline: t } = Ge(), { builders: { join: s, hardline: i }, utils: { replaceTextEndOfLine: r } } = Le(), { isLineComment: u } = Xe(), { locStart: a, locEnd: c } = nt(), l = _t();
          function h(p, f) {
            let C = p.getValue();
            if (u(C))
              return f.originalText.slice(a(C), c(C)).trimEnd();
            if (l(C)) {
              if (g(C)) {
                let A = y(C);
                return C.trailing && !t(f.originalText, a(C), { backwards: true }) ? [i, A] : A;
              }
              let N = c(C), T = f.originalText.slice(N - 3, N) === "*-/";
              return ["/*", r(C.value), T ? "*-/" : "*/"];
            }
...
`);
          ...
          function y(p) {
            let f = p.value.split(`
`);
            return ["/*", s(i, f.map((C, N) => N === 0 ? C.trimEnd() : " " + (N < f.length - 1 ? C.trim() : C.trimStart()))), "*/"];
          }
          ...
          function i(a, c) {
            ...
            switch (l.type) {
              ...
              case "Literal": {
                ...
                let { value: h } = l;
                return typeof h == "number" ? s(l.raw) : typeof h == "string" ? t(l.raw, c) : String(h);
              }
            }
          }
          function r(a) {
          ...
          function je(Te, Pe, Fe, Ke) {
            ...
            switch (Se.type) {
              ...
              case "ExpressionStatement": {
                ...
                if (Pe.parser === "__vue_event_binding") {
                  ...
                  if (Re.type === "Program" && Re.body.length === 1 && Re.body[0] === Se)
                    return [Fe("expression"), P(Se.expression) ? ";" : ""];
                }
                let Ie = t(Te, Pe, true, (Re) => {
                  let { marker: Ae } = Re;
                  return Ae === o;
                });
                return [Fe("expression"), v(Pe, Te) ? "" : ze, Ie ? [" ", Ie] : ""];
              }
              case "ParenthesizedExpression":
              ...
              case "BindExpression":
                return Se.object && Be.push(Fe("object")), Be.push(c(l([a, re(Te, Pe, Fe)]))), Be;
              case "Identifier":
                return [Se.name, G(Te), U(Te), $(Te, Pe, Fe)];
              ...
              case "AwaitExpression": {
                if (Be.push("await"), Se.argument) {
                  ...
                  if (m(Ie) && Ie.callee === Se || d(Ie) && Ie.object === Se) {
                    Be = [l([a, ...Be]), a];
              ...
              case "SequenceExpression": {
                ...
                if (Ie.type === "ExpressionStatement" || Ie.type === "ForStatement") {
                  ...
                  return Te.each((Ae, Oe) => {
                    Oe === 0 ? Re.push(Fe()) : Re.push(",", l([r, Fe()]));
                  }, "expressions"), c(Re);
                }
              ...
              case "VariableDeclaration": {
                ...
                return Ie.length === 1 && !A(Se.declarations[0]) ? _e = Ie[0] : Ie.length > 0 && (_e = l(Ie[0])), Be = [Se.declare ? "declare " : "", Se.kind, _e ? [" ", _e] : "", l(Ie.slice(1).map((ie) => [",", Oe && !Ae ? u : r, ie]))], Ae && Re.body !== Se || Be.push(ze), c(Be);
              }
              case "WithStatement":
                return c(["with (", Fe("object"), ")", W(Se.body, Fe("body"))]);
              case "IfStatement": {
                let Ie = W(Se.consequent, Fe("consequent")), Re = c(["if (", c([l([a, Fe("test")]), a]), ")", Ie]);
                if (Be.push(Re), Se.alternate) {
                  let Ae = A(Se.consequent, b.Trailing | b.Line) || I(Se), Oe = Se.consequent.type === "BlockStatement" && !Ae;
                  Be.push(Oe ? " " : u), A(Se, b.Dangling) && Be.push(t(Te, Pe, true), Ae ? u : " "), Be.push("else", c(W(Se.alternate, Fe("alternate"), Se.alternate.type === "IfStatement")));
                }
                return Be;
              }
              case "ForStatement": {
                let Ie = W(Se.body, Fe("body")), Re = t(Te, Pe, true), Ae = Re ? [Re, a] : "";
              ...
              case "CatchClause":
                if (Se.param) {
                  let Ie = A(Se.param, (Ae) => !S(Ae) || Ae.leading && s(Pe.originalText, F(Ae)) || Ae.trailing && s(Pe.originalText, x(Ae), { backwards: true })), Re = Fe("param");
                  return ["catch ", Ie ? ["(", l([a, Re]), a, ") "] : ["(", Re, ") "], Fe("body")];
                }
                return ["catch ", Fe("body")];
              case "SwitchStatement":
                return [c(["switch (", l([a, Fe("discriminant")]), a, ")"]), " {", Se.cases.length > 0 ? l([u, i(u, Te.map((Ie, Re, Ae) => {
                  let Oe = Ie.getValue();
                  return [Fe(), Re !== Ae.length - 1 && w(Oe, Pe) ? u : ""];
                }, "cases"))]) : "", u, "}"];
              case "SwitchCase": {
                Se.test ? Be.push("case ", Fe("test"), ":") : Be.push("default:"), A(Se, b.Dangling) && Be.push(" ", t(Te, Pe, true));
                let Ie = Se.consequent.filter((Re) => Re.type !== "EmptyStatement");
                if (Ie.length > 0) {
                  let Re = ye(Te, Pe, Fe);
                  Be.push(Ie.length === 1 && Ie[0].type === "BlockStatement" ? [" ", Re] : l([u, Re]));
                }
                return Be;
              }
              case "DebuggerStatement":
              ...
              case "InterpreterDirective":
                return Be.push("#!", Se.value, u), w(Se, Pe) && Be.push(u), Be;
              case "TopicReference":
                return "%";
          ...
          n.exports = { preprocess: N, print: Ne, embed: g, insertPragma: p, massageAstNode: y, hasPrettierIgnore(Te) {
            return D(Te) || M(Te);
            ...
            switch (y.type) {
              ...
              case "ArrayExpression": {
                if (y.elements.length === 0)
                  return "[]";
                let p = l.map(() => l.getValue() === null ? "null" : g(), "elements");
                return ["[", s([t, i([",", t], p)]), t, "]"];
              }
              case "ObjectExpression":
                return y.properties.length === 0 ? "{}" : ["{", s([t, i([",", t], l.map(g, "properties"))]), t, "}"];
              case "ObjectProperty":
                return [g("key"), ": ", g("value")];
              case "UnaryExpression":
                return [y.operator === "+" ? "" : y.operator, g("argument")];
              case "NullLiteral":
                return "null";
              case "BooleanLiteral":
              ...
              case "StringLiteral":
              case "NumericLiteral":
                return JSON.stringify(y.value);
              case "Identifier": {
                let p = l.getParentNode();
                return p && p.type === "ObjectProperty" && p.key === y ? JSON.stringify(y.name) : y.name;
              }
              case "TemplateLiteral":
                return g(["quasis", 0]);
              case "TemplateElement":
                return JSON.stringify(y.value.cooked);
              default:
          ...
          function c(l, h) {
            let { type: g } = l;
            if (g === "ObjectProperty" && l.key.type === "Identifier") {
              h.key = { type: "StringLiteral", value: l.key.name };
              return;
            }
            if (g === "UnaryExpression" && l.operator === "+")
              return h.argument;
            if (g === "ArrayExpression") {
              for (let [y, p] of l.elements.entries())
                p === null && h.elements.splice(y, 0, { type: "NullLiteral" });
              return;
            }
          ...
          function r(a, c, l) {
            ...
            if (a.type === "css-atrule" && a.name.toLowerCase() === "supports" && delete c.value, a.type === "selector-unknown" && delete c.value, a.type === "value-comma_group") {
              let h = a.groups.findIndex((g) => g.type === "value-number" && g.unit === "...");
              h !== -1 && (c.groups[h].unit = "", c.groups.splice(h + 1, 0, { type: "value-word", value: "...", isColor: false, isHex: false }));
            }
          }
          ...
          function s(i) {
            ...
            if (!r)
              return { content: i };
            let { startDelimiter: u, language: a, value: c = "", endDelimiter: l } = r.groups, h = a.trim() || "yaml";
            if (u === "+++" && (h = "toml"), h !== "yaml" && u !== l)
              return { content: i };
            let [g] = r;
            return { frontMatter: { type: "front-matter", lang: h, value: c, startDelimiter: u, endDelimiter: l, raw: g.replace(/\n$/, "") }, content: g.replace(/[^\n]/g, " ") + i.slice(g.length) };
          }
          n.exports = s;
...
` : "") + t.insertPragma(c);
          ...
          n.exports = { getAncestorCounter: s, getAncestorNode: i, getPropOfDeclNode: r, maybeToLowerCase: c, insideValueFunctionNode: l, insideICSSRuleNode: h, insideAtRuleNode: g, insideURLFunctionInImportAtRuleNode: y, isKeyframeAtRuleKeywords: a, isWideKeywords: u, isLastNode: f, isSCSSControlDirectiveNode: d, isDetachedRulesetDeclarationNode: C, isRelationalOperatorNode: m, isEqualityOperatorNode: D, isMultiplicationNode: b, isDivisionNode: v, isAdditionNode: B, isSubtractionNode: w, isModuloNode: I, isMathOperatorNode: E, isEachKeywordNode: A, isForKeywordNode: N, isURLFunctionNode: p, isIfElseKeywordNode: T, hasComposesNode: k, hasParensAroundNode: P, hasEmptyRawBefore: O, isDetachedRulesetCallNode: o, isTemplatePlaceholderNode: x, isTemplatePropNode: F, isPostcssSimpleVarNode: S, isKeyValuePairNode: R, isKeyValuePairInParenGroupNode: M, isKeyInValuePairNode: U, isSCSSMapItemNode: H, isInlineValueCommentNode: _, isHashNode: G, isLeftCurlyBraceNode: re, isRightCurlyBraceNode: $, isWordNode: W, isColonNode: ee, isMediaAndSupportsKeywords: ne, isColorAdjusterFuncNode: se, lastLineHasInlineComment: V, isAtWordPlaceholderNode: oe, isConfigurationNode: K, isParenGroupNode: Ee };
...
`, i) + 1;
          ...
          function u(p, f) {
            ...
            return C && p.source && !p.source.end && (p = C), p.source && p.source.end ? i(p.source.end, f) : null;
          }
          function a(p, f) {
            p.source && (p.source.startOffset = r(p, f), p.source.endOffset = u(p, f));
            for (let C in p) {
              let N = p[C];
              C === "source" || !N || typeof N != "object" || (N.type === "value-root" || N.type === "value-unknown" ? c(N, l(p), N.text || N.value) : a(N, f));
            }
          }
          function c(p, f, C) {
            ...
            for (let N in p) {
              let T = p[N];
              N === "source" || !T || typeof T != "object" || c(T, f, C);
            }
          }
          function l(p) {
          ...
          function h(p) {
            let f = "initial", C = "initial", N, T = false, A = [];
...
` || v === "\r") && (T && A.push([N, b]), f = "initial", T = false);
          ...
          n.exports = { locStart: g, locEnd: y, calculateLoc: a, replaceQuotesInInlineComments: h };
          ...
          "use strict";
          ae();
          var t = st(), { printNumber: s, printString: i, hasNewline: r, isFrontMatterNode: u, isNextLineEmpty: a, isNonEmptyArray: c } = Ge(), { builders: { join: l, line: h, hardline: g, softline: y, group: p, fill: f, indent: C, dedent: N, ifBreak: T, breakParent: A }, utils: { removeLines: b, getDocParts: v } } = Le(), B = Hm(), w = Gm(), { insertPragma: I } = Jm(), { getAncestorNode: E, getPropOfDeclNode: D, maybeToLowerCase: m, insideValueFunctionNode: d, insideICSSRuleNode: o, insideAtRuleNode: x, insideURLFunctionInImportAtRuleNode: F, isKeyframeAtRuleKeywords: S, isWideKeywords: k, isLastNode: P, isSCSSControlDirectiveNode: O, isDetachedRulesetDeclarationNode: R, isRelationalOperatorNode: M, isEqualityOperatorNode: H, isMultiplicationNode: _, isDivisionNode: G, isAdditionNode: re, isSubtractionNode: $, isMathOperatorNode: W, isEachKeywordNode: ee, isForKeywordNode: U, isURLFunctionNode: ne, isIfElseKeywordNode: se, hasComposesNode: V, hasParensAroundNode: oe, hasEmptyRawBefore: K, isKeyValuePairNode: Ee, isKeyInValuePairNode: q, isDetachedRulesetCallNode: le, isTemplatePlaceholderNode: ue, isTemplatePropNode: Q, isPostcssSimpleVarNode: de, isSCSSMapItemNode: ge, isInlineValueCommentNode: ve, isHashNode: xe, isLeftCurlyBraceNode: we, isRightCurlyBraceNode: fe, isWordNode: pe, isColonNode: me, isMediaAndSupportsKeywords: ce, isColorAdjusterFuncNode: he, lastLineHasInlineComment: J, isAtWordPlaceholderNode: ye, isConfigurationNode: X, isParenGroupNode: Y } = Um(), { locStart: te, locEnd: z } = Xm(), j = Km(), Ce = Ym(), Ne = Zm();
          function je(Ae) {
          ...
          function Ue(Ae, Oe, _e) {
            ...
            switch (ie.type) {
              ...
              case "css-root": {
                ...
                return [Me, qe ? " ".concat(qe) : "", v(Me).length > 0 ? g : ""];
              }
              case "css-comment": {
              ...
              case "css-rule":
                return [_e("selector"), ie.important ? " !important" : "", ie.nodes ? [ie.selector && ie.selector.type === "selector-unknown" && J(ie.selector.value) ? h : " ", "{", ie.nodes.length > 0 ? C([g, tt(Ae, Oe, _e)]) : "", g, "}", R(ie) ? ";" : ""] : ";"];
              case "css-decl": {
                let Me = Ae.getParentNode(), { between: qe } = ie.raws, Je = qe.trim(), rt = Je === ":", Ze = V(ie) ? b(_e("value")) : _e("value");
                return !rt && J(Je) && (Ze = C([g, N(Ze)])), [ie.raws.before.replace(/[\s;]/g, ""), o(Ae) ? ie.prop : m(ie.prop), Je.startsWith("//") ? " " : "", Je, ie.extend ? "" : " ", j(Oe) && ie.extend && ie.selector ? ["extend(", _e("selector"), ")"] : "", Ze, ie.raws.important ? ie.raws.important.replace(/\s*!\s*important/i, " !important") : ie.important ? " !important" : "", ie.raws.scssDefault ? ie.raws.scssDefault.replace(/\s*!default/i, " !default") : ie.scssDefault ? " !default" : "", ie.raws.scssGlobal ? ie.raws.scssGlobal.replace(/\s*!global/i, " !global") : ie.scssGlobal ? " !global" : "", ie.nodes ? [" {", C([y, tt(Ae, Oe, _e)]), y, "}"] : Q(ie) && !Me.raws.semicolon && Oe.originalText[z(ie) - 1] !== ";" ? "" : Oe.__isHTMLStyleAttribute && P(Ae, ie) ? T(";") : ";"];
              }
              case "css-atrule": {
                ...
                if (j(Oe)) {
                  ...
                  if (ie.variable)
                    return ["@", ie.name, ": ", ie.value ? _e("value") : "", ie.raws.between.trim() ? ie.raws.between.trim() + " " : "", ie.nodes ? ["{", C([ie.nodes.length > 0 ? y : "", tt(Ae, Oe, _e)]), y, "}"] : "", qe ? "" : ";"];
                }
                return ["@", le(ie) || ie.name.endsWith(":") ? ie.name : m(ie.name), ie.params ? [le(ie) ? "" : ue(ie) ? ie.raws.afterName === "" ? "" : ie.name.endsWith(":") ? " " : /^\s*\n\s*\n/.test(ie.raws.afterName) ? [g, g] : /^\s*\n/.test(ie.raws.afterName) ? g : " " : " ", _e("params")] : "", ie.selector ? C([" ", _e("selector")]) : "", ie.value ? p([" ", _e("value"), O(ie) ? oe(ie) ? " " : h : ""]) : ie.name === "else" ? " " : "", ie.nodes ? [O(ie) ? "" : ie.selector && !ie.selector.nodes && typeof ie.selector.value == "string" && J(ie.selector.value) || !ie.selector && typeof ie.params == "string" && J(ie.params) ? h : " ", "{", C([ie.nodes.length > 0 ? y : "", tt(Ae, Oe, _e)]), y, "}"] : qe ? "" : ";"];
              }
              ...
              case "media-unknown":
                return ie.value;
              case "selector-root":
                return p([x(Ae, "custom-selector") ? [E(Ae, "css-atrule").customSelector, h] : "", l([",", x(Ae, ["extend", "custom-selector", "nest"]) ? h : g], Ae.map(_e, "nodes"))]);
              case "selector-selector":
                return p(C(Ae.map(_e, "nodes")));
              ...
              case "selector-combinator": {
                if (ie.value === "+" || ie.value === ">" || ie.value === "~" || ie.value === ">>>") {
                  ...
                  return [Je.type === "selector-selector" && Je.nodes[0] === ie ? "" : h, ie.value, P(Ae, ie) ? "" : " "];
                }
                let Me = ie.value.trim().startsWith("(") ? h : "", qe = Ie(ze(ie.value.trim(), Oe)) || h;
                return [Me, qe];
              }
              case "selector-universal":
                return [ie.namespace ? [ie.namespace === true ? "" : ie.namespace.trim(), "|"] : "", ie.value];
              case "selector-pseudo":
                return [m(ie.value), c(ie.nodes) ? ["(", l(", ", Ae.map(_e, "nodes")), ")"] : ""];
              case "selector-nesting":
                return ie.value;
              case "selector-unknown": {
                let Me = E(Ae, "css-rule");
                if (Me && Me.isSCSSNesterProperty)
                  return Ie(ze(m(ie.value), Oe));
              ...
              case "value-comma_group": {
                let Me = Ae.getParentNode(), qe = Ae.getParentNode(1), Je = D(Ae), rt = Je && Me.type === "value-value" && (Je === "grid" || Je.startsWith("grid-template")), Ze = E(Ae, "css-atrule"), ct = Ze && O(Ze), qt = ie.groups.some((ut) => ve(ut)), L = Ae.map(_e, "groups"), De = [], ke = d(Ae, "url"), We = false, Ve = false;
                for (let ut = 0; ut < ie.groups.length; ++ut) {
                  De.push(L[ut]);
                  let et = ie.groups[ut - 1], $e = ie.groups[ut], He = ie.groups[ut + 1], Zt = ie.groups[ut + 2];
                  if (ke) {
                    (He && re(He) || re($e)) && De.push(" ");
                    continue;
                  }
                  if (x(Ae, "forward") && $e.type === "value-word" && $e.value && et !== void 0 && et.type === "value-word" && et.value === "as" && He.type === "value-operator" && He.value === "*" || !He || $e.type === "value-word" && $e.value.endsWith("-") && ye(He))
                    continue;
                  let ho = $e.type === "value-string" && $e.value.startsWith("#{"), Co = We && He.type === "value-string" && He.value.endsWith("}");
                  if (ho || Co) {
                    We = !We;
                    continue;
                  }
                  if (We || me($e) || me(He) || $e.type === "value-atword" && $e.value === "" || $e.value === "~" || $e.value && $e.value.includes("\\") && He && He.type !== "value-comment" || et && et.value && et.value.indexOf("\\") === et.value.length - 1 && $e.type === "value-operator" && $e.value === "/" || $e.value === "\\" || de($e, He) || xe($e) || we($e) || fe(He) || we(He) && K(He) || fe($e) && K(He) || $e.value === "--" && xe(He))
                    continue;
                  let Qn = W($e), Zn = W(He);
                  if ((Qn && xe(He) || Zn && fe($e)) && K(He) || !et && G($e) || d(Ae, "calc") && (re($e) || re(He) || $($e) || $(He)) && K(He))
                    continue;
                  let Eo = (re($e) || $($e)) && ut === 0 && (He.type === "value-number" || He.isHex) && qe && he(qe) && !K(He), eu = Zt && Zt.type === "value-func" || Zt && pe(Zt) || $e.type === "value-func" || pe($e), tu = He.type === "value-func" || pe(He) || et && et.type === "value-func" || et && pe(et);
                  if (!(!(_(He) || _($e)) && !d(Ae, "calc") && !Eo && (G(He) && !eu || G($e) && !tu || re(He) && !eu || re($e) && !tu || $(He) || $($e)) && (K(He) || Qn && (!et || et && W(et))))) {
                    if (ve($e)) {
                    ...
                    if (ct && (H(He) || M(He) || se(He) || ee($e) || U($e))) {
                      De.push(" ");
                      continue;
                    }
                    ...
                    if (rt) {
                      $e.source && He.source && $e.source.start.line !== He.source.start.line ? (De.push(g), Ve = true) : De.push(" ");
                      continue;
                    }
                    if (Zn) {
                      De.push(" ");
                    ...
                    if (!(He && He.value === "...") && !(ye($e) && ye(He) && z($e) === te(He))) {
                      if (ye($e) && Y(He) && z($e) === te(He.open)) {
                        De.push(y);
                        continue;
                      }
                ...
                return qt && De.push(A), Ve && De.unshift(g), ct ? p(C(De)) : F(Ae) ? p(f(De)) : p(C(f(De)));
              }
              case "value-paren_group": {
                ...
                if (Me && ne(Me) && (ie.groups.length === 1 || ie.groups.length > 0 && ie.groups[0].type === "value-comma_group" && ie.groups[0].groups.length > 0 && ie.groups[0].groups[0].type === "value-word" && ie.groups[0].groups[0].value.startsWith("data:")))
                  return [ie.open ? _e("open") : "", l(",", Ae.map(_e, "groups")), ie.close ? _e("close") : ""];
                if (!ie.open) {
                  let ke = Ae.map(_e, "groups"), We = [];
                  for (let Ve = 0; Ve < ke.length; Ve++)
                    Ve !== 0 && We.push([",", h]), We.push(ke[Ve]);
                  return p(C(f(We)));
                }
                let qe = ge(Ae), Je = t(ie.groups), rt = Je && Je.type === "value-comment", Ze = q(ie, Me), ct = X(ie, Me), qt = ct || qe && !Ze, L = ct || Ze, De = p([ie.open ? _e("open") : "", C([y, l([h], Ae.map((ke, We) => {
                  ...
                  if (Ee(Ve) && Ve.type === "value-comma_group" && Ve.groups && Ve.groups[0].type !== "value-paren_group" && Ve.groups[2] && Ve.groups[2].type === "value-paren_group") {
                    let $e = v(et[0].contents.contents);
                    return $e[1] = p($e[1]), p(N(et));
                  }
                  return !ut && Ve.type === "value-comma_group" && Ve.groups && Ve.groups[0].type !== "value-paren_group" && a(Oe.originalText, t(Ve.groups), z) && et.push(g), et;
                }, "groups"))]), T(!rt && Ce(Oe.parser, Oe.originalText) && qe && je(Oe) ? "," : ""), y, ie.close ? _e("close") : ""], { shouldBreak: qt });
                return L ? N(De) : De;
              }
              case "value-func":
                return [ie.value, x(Ae, "supports") && ce(ie) ? " " : "", _e("group")];
              case "value-paren":
                return ie.value;
              case "value-number":
              ...
              case "value-colon": {
                ...
                return [ie.value, Je && typeof Je.value == "string" && t(Je.value) === "\\" || d(Ae, "url") ? "" : h];
              }
              case "value-comma":
                return [ie.value, " "];
              case "value-string":
          ...
          function tt(Ae, Oe, _e) {
            ...
            return Ae.each((Me, qe, Je) => {
              ...
              if (rt && rt.type === "css-comment" && rt.text.trim() === "prettier-ignore") {
                ...
                ie.push(_e());
              qe !== Je.length - 1 && (Je[qe + 1].type === "css-comment" && !r(Oe.originalText, te(Je[qe + 1]), { backwards: true }) && !u(Je[qe]) || Je[qe + 1].type === "css-atrule" && Je[qe + 1].name === "else" && Je[qe].type !== "css-comment" ? ie.push(" ") : (ie.push(Oe.__isHTMLStyleAttribute ? h : g), a(Oe.originalText, Me.getValue(), z) && !u(Je[qe]) && ie.push(g)));
            }, "nodes"), ie;
          }
          ...
          function ze(Ae, Oe) {
            return Ae.replace(Te, (_e) => i(_e, Oe));
          }
          function Be(Ae, Oe) {
          ...
          function Ie(Ae) {
            return Ae.replace(Se, (Oe, _e, ie, Me, qe) => !ie && Me ? Re(Me) + m(qe || "") : Oe);
          }
          function Re(Ae) {
        ...
        } }), ld = Z({ "node_modules/html-void-elements/index.json"(e, n) {
          n.exports = ["area", "base", "basefont", "bgsound", "br", "col", "command", "embed", "frame", "hr", "image", "img", "input", "isindex", "keygen", "link", "menuitem", "meta", "nextid", "param", "source", "track", "wbr"];
          ...
          function i(b) {
            ...
            return !!(g(b, ["ElementNode"]) && s(B.children) === v || g(b, ["Block"]) && s(B.body) === v);
          }
          function r(b) {
            return b.toUpperCase() === b;
          }
          function u(b) {
            return h(b, ["ElementNode"]) && typeof b.tag == "string" && b.tag[0] !== ":" && (r(b.tag[0]) || b.tag.includes("."));
          }
          var a = new Set(t);
          function c(b) {
          ...
          function T(b) {
            return h(b, ["MustacheCommentStatement"]) && typeof b.value == "string" && b.value.trim() === "prettier-ignore";
          }
          function A(b) {
            let v = b.getValue(), B = C(b, 2);
            return T(v) || T(B);
          }
          n.exports = { getNextNode: N, getPreviousNode: C, hasPrettierIgnore: A, isLastNodeOfSiblings: i, isNextNodeOfSomeType: p, isNodeOfSomeType: h, isParentOfSomeType: g, isPreviousNodeOfSomeType: y, isVoid: c, isWhitespaceNode: l };
        } }), fd = Z({ "src/language-handlebars/printer-glimmer.js"(e, n) {
          "use strict";
          ae();
          var { builders: { dedent: t, fill: s, group: i, hardline: r, ifBreak: u, indent: a, join: c, line: l, softline: h }, utils: { getDocParts: g, replaceTextEndOfLine: y } } = Le(), { getPreferredQuote: p, isNonEmptyArray: f } = Ge(), { locStart: C, locEnd: N } = od(), T = cd(), { getNextNode: A, getPreviousNode: b, hasPrettierIgnore: v, isLastNodeOfSiblings: B, isNextNodeOfSomeType: w, isNodeOfSomeType: I, isParentOfSomeType: E, isPreviousNodeOfSomeType: D, isVoid: m, isWhitespaceNode: d } = pd(), o = 2;
          function x(J, ye, X) {
            let Y = J.getValue();
            if (!Y)
              return "";
            if (v(J))
              return ye.originalText.slice(C(Y), N(Y));
            ...
            switch (Y.type) {
              ...
              case "ElementNode": {
                let z = i(S(J, X)), j = ye.htmlWhitespaceSensitivity === "ignore" && w(J, ["ElementNode"]) ? h : "";
                if (m(Y))
                  return [z, j];
                let Ce = ["</", Y.tag, ">"];
              ...
              case "AttrNode": {
                ...
                if (z && Y.value.chars === "" && C(Y.value) === N(Y.value))
                  return Y.name;
              ...
              case "TextNode": {
                ...
                if (ye.htmlWhitespaceSensitivity !== "ignore") {
                  ...
                  if (Ae) {
                    if (!Be) {
                      _e = [l];
                      let ie = Q(Ae);
                      ie && (_e = ve(ie)), B(J) && (_e = _e.map((Me) => t(Me)));
                    }
                    z = z.replace(ze, "");
                  }
                  return [...Oe, s(q(z)), ..._e];
                ...
                if ((je || Ue) && Ne && E(J, ["Block", "ElementNode", "Template"]))
                  return "";
                Ne && tt ? (Te = Math.min(tt, o), Pe = 0) : (w(J, ["BlockStatement", "ElementNode"]) && (Pe = Math.max(Pe, 1)), D(J, ["BlockStatement", "ElementNode"]) && (Te = Math.max(Te, 1)));
                let Fe = "", Ke = "";
                return Pe === 0 && w(J, ["MustacheStatement"]) && (Ke = " "), Te === 0 && D(J, ["MustacheStatement"]) && (Fe = " "), je && (Te = 0, Fe = ""), Ue && (Pe = 0, Ke = ""), z = z.replace(/^[\t\n\f\r ]+/g, Fe).replace(/[\t\n\f\r ]+$/, Ke), [...ve(Te), s(q(z)), ...ve(Pe)];
              }
              case "MustacheCommentStatement": {
                let z = C(Y), j = N(Y), Ce = ye.originalText.charAt(z + 2) === "~", Ne = ye.originalText.charAt(j - 3) === "~", je = Y.value.includes("}}") ? "--" : "";
          ...
          function S(J, ye) {
            ...
            return f(X.blockParams) && te.push(l, he(X)), ["<", X.tag, a(te), P(X)];
          }
          function k(J, ye, X) {
            let te = J.getValue().children.every((z) => d(z));
          ...
          function ne(J, ye, X) {
            let Y = J.getValue();
            return X.htmlWhitespaceSensitivity === "ignore" ? [se(Y) ? h : r, _(Y), ye("path"), G(Y)] : [_(Y), ye("path"), G(Y)];
          }
          function se(J) {
            return I(J, ["BlockStatement"]) && J.program.body.every((ye) => d(ye));
          }
          function V(J) {
...
` + i;
          ...
          "use strict";
          ae();
          var { builders: { join: t, hardline: s, line: i, softline: r, group: u, indent: a, ifBreak: c } } = Le(), { isNextLineEmpty: l, isNonEmptyArray: h } = Ge(), { insertPragma: g } = gd(), { locStart: y, locEnd: p } = yd();
          function f(w, I, E) {
            let D = w.getValue();
            if (!D)
              return "";
            ...
            switch (D.kind) {
              case "Document": {
                let m = [];
                return w.each((d, o, x) => {
                  m.push(E()), o !== x.length - 1 && (m.push(s), l(I.originalText, d.getValue(), p) && m.push(s));
                }, "definitions"), [...m, s];
              }
              case "OperationDefinition": {
                let m = I.originalText[y(D)] !== "{", d = Boolean(D.name);
                return [m ? D.operation : "", m && d ? [" ", E("name")] : "", m && !d && h(D.variableDefinitions) ? " " : "", h(D.variableDefinitions) ? u(["(", a([r, t([c("", ", "), r], w.map(E, "variableDefinitions"))]), r, ")"]) : "", C(w, E, D), D.selectionSet ? !m && !d ? "" : " " : "", E("selectionSet")];
              }
              case "FragmentDefinition":
                return ["fragment ", E("name"), h(D.variableDefinitions) ? u(["(", a([r, t([c("", ", "), r], w.map(E, "variableDefinitions"))]), r, ")"]) : "", " on ", E("typeCondition"), C(w, E, D), " ", E("selectionSet")];
              case "SelectionSet":
                return ["{", a([s, t(s, w.call((m) => N(m, I, E), "selections"))]), s, "}"];
              case "Field":
                return u([D.alias ? [E("alias"), ": "] : "", E("name"), D.arguments.length > 0 ? u(["(", a([r, t([c("", ", "), r], w.call((m) => N(m, I, E), "arguments"))]), r, ")"]) : "", C(w, E, D), D.selectionSet ? " " : "", E("selectionSet")]);
              case "Name":
                return D.value;
              case "StringValue":
...
`)), s, '"""'] : ['"', D.value.replace(/["\\]/g, "\\$&").replace(/\n/g, "\\n"), '"'];
              ...
              case "Directive":
                return ["@", E("name"), D.arguments.length > 0 ? u(["(", a([r, t([c("", ", "), r], w.call((m) => N(m, I, E), "arguments"))]), r, ")"]) : ""];
              case "NamedType":
                return E("name");
              case "VariableDefinition":
                return [E("variable"), ": ", E("type"), D.defaultValue ? [" = ", E("defaultValue")] : "", C(w, E, D)];
              case "ObjectTypeExtension":
              case "ObjectTypeDefinition":
                return [E("description"), D.description ? s : "", D.kind === "ObjectTypeExtension" ? "extend " : "", "type ", E("name"), D.interfaces.length > 0 ? [" implements ", ...b(w, I, E)] : "", C(w, E, D), D.fields.length > 0 ? [" {", a([s, t(s, w.call((m) => N(m, I, E), "fields"))]), s, "}"] : ""];
              case "FieldDefinition":
                return [E("description"), D.description ? s : "", E("name"), D.arguments.length > 0 ? u(["(", a([r, t([c("", ", "), r], w.call((m) => N(m, I, E), "arguments"))]), r, ")"]) : "", ": ", E("type"), C(w, E, D)];
              case "DirectiveDefinition":
                return [E("description"), D.description ? s : "", "directive ", "@", E("name"), D.arguments.length > 0 ? u(["(", a([r, t([c("", ", "), r], w.call((m) => N(m, I, E), "arguments"))]), r, ")"]) : "", D.repeatable ? " repeatable" : "", " on ", t(" | ", w.map(E, "locations"))];
              case "EnumTypeExtension":
              case "EnumTypeDefinition":
                return [E("description"), D.description ? s : "", D.kind === "EnumTypeExtension" ? "extend " : "", "enum ", E("name"), C(w, E, D), D.values.length > 0 ? [" {", a([s, t(s, w.call((m) => N(m, I, E), "values"))]), s, "}"] : ""];
              case "EnumValueDefinition":
                return [E("description"), D.description ? s : "", E("name"), C(w, E, D)];
              case "InputValueDefinition":
                return [E("description"), D.description ? D.description.block ? s : i : "", E("name"), ": ", E("type"), D.defaultValue ? [" = ", E("defaultValue")] : "", C(w, E, D)];
              case "InputObjectTypeExtension":
              case "InputObjectTypeDefinition":
                return [E("description"), D.description ? s : "", D.kind === "InputObjectTypeExtension" ? "extend " : "", "input ", E("name"), C(w, E, D), D.fields.length > 0 ? [" {", a([s, t(s, w.call((m) => N(m, I, E), "fields"))]), s, "}"] : ""];
              case "SchemaDefinition":
                return [E("description"), D.description ? s : "", "schema", C(w, E, D), " {", D.operationTypes.length > 0 ? a([s, t(s, w.call((m) => N(m, I, E), "operationTypes"))]) : "", s, "}"];
              case "OperationTypeDefinition":
                return [E("operation"), ": ", E("type")];
              case "InterfaceTypeExtension":
              case "InterfaceTypeDefinition":
                return [E("description"), D.description ? s : "", D.kind === "InterfaceTypeExtension" ? "extend " : "", "interface ", E("name"), D.interfaces.length > 0 ? [" implements ", ...b(w, I, E)] : "", C(w, E, D), D.fields.length > 0 ? [" {", a([s, t(s, w.call((m) => N(m, I, E), "fields"))]), s, "}"] : ""];
              case "FragmentSpread":
                return ["...", E("name"), C(w, E, D)];
              case "InlineFragment":
                return ["...", D.typeCondition ? [" on ", E("typeCondition")] : "", C(w, E, D), " ", E("selectionSet")];
              case "UnionTypeExtension":
              case "UnionTypeDefinition":
                return u([E("description"), D.description ? s : "", u([D.kind === "UnionTypeExtension" ? "extend " : "", "union ", E("name"), C(w, E, D), D.types.length > 0 ? [" =", c("", " "), a([c([i, "  "]), t([i, "| "], w.map(E, "types"))])] : ""])]);
              case "ScalarTypeExtension":
              case "ScalarTypeDefinition":
                return [E("description"), D.description ? s : "", D.kind === "ScalarTypeExtension" ? "extend " : "", "scalar ", E("name"), C(w, E, D)];
              case "NonNullType":
                return [E("type"), "!"];
              case "ListType":
                return ["[", E("type"), "]"];
          ...
          function N(w, I, E) {
            let D = w.getValue().length;
            return w.map((m, d) => {
              let o = E();
              return l(I.originalText, m.getValue(), p) && d < D - 1 ? [o, s] : o;
            });
          }
          function T(w) {
          ...
          function b(w, I, E) {
            let D = w.getNode(), m = [], { interfaces: d } = D, o = w.map((x) => E(x), "interfaces");
            for (let x = 0; x < d.length; x++) {
              let F = d[x];
              m.push(o[x]);
              let S = d[x + 1];
              if (S) {
                let k = I.originalText.slice(F.loc.end, S.loc.start), P = k.includes("#"), O = k.replace(/#.*/g, "").trim();
                m.push(O === "," ? "," : " &", P ? i : " ");
              }
            }
            return m;
          ...
          n.exports = { print: f, massageAstNode: v, hasPrettierIgnore: B, insertPragma: g, printComment: A, canAttachComment: T };
          ...
          "use strict";
          ae();
          var { getLast: t } = Ge(), { locStart: s, locEnd: i } = fo(), { cjkPattern: r, kPattern: u, punctuationPattern: a } = Ad(), c = ["liquidNode", "inlineCode", "emphasis", "esComment", "strong", "delete", "wikiLink", "link", "linkReference", "image", "imageReference", "footnote", "footnoteReference", "sentence", "whitespace", "word", "break", "inlineMath"], l = [...c, "tableCell", "paragraph", "heading"], h = new RegExp(u), g = new RegExp(a);
          function y(A, b) {
...
(`).concat(r, ")"), "g"), "$1$2")).split(/([\t\n ]+)/);
            for (let [d, o] of D.entries()) {
              if (d % 2 === 1) {
                E.push({ type: "whitespace", value: /\n/.test(o) ? `
` : " " });
                continue;
              }
              if ((d === 0 || d === D.length - 1) && o === "")
                continue;
              let x = o.split(new RegExp("(".concat(r, ")")));
              for (let [F, S] of x.entries())
                if (!((F === 0 || F === x.length - 1) && S === "")) {
                  if (F % 2 === 0) {
                    S !== "" && m({ type: "word", value: S, kind: v, hasLeadingPunctuation: g.test(S[0]), hasTrailingPunctuation: g.test(t(S)) });
                    continue;
                  }
                  m(g.test(S) ? { type: "word", value: S, kind: I, hasLeadingPunctuation: true, hasTrailingPunctuation: true } : { type: "word", value: S, kind: h.test(S) ? w : B, hasLeadingPunctuation: false, hasTrailingPunctuation: false });
                }
            }
            return E;
            function m(d) {
              let o = t(E);
              o && o.type === "word" && (o.kind === v && d.kind === B && !o.hasTrailingPunctuation || o.kind === B && d.kind === v && !d.hasLeadingPunctuation ? E.push({ type: "whitespace", value: " " }) : !x(v, I) && ![o.value, d.value].some((F) => /\u3000/.test(F)) && E.push({ type: "whitespace", value: "" })), E.push(d);
              function x(F, S) {
                return o.kind === F && d.kind === S || o.kind === S && d.kind === F;
              }
            }
          }
          function p(A, b) {
...
`) ? v.slice(0, -1) : v;
          ...
          function N(A, b) {
            return function v(B, w, I) {
              ...
              return E.children && (E.children = E.children.map((D, m) => v(D, m, [E, ...I]))), E;
            }(A, null, []);
          }
          function T(A) {
          ...
          n.exports = { mapAst: N, splitText: y, punctuationPattern: a, getFencedCodeBlockValue: C, getOrderedListItemInfo: p, hasGitDiffFriendlyOrderedList: f, INLINE_NODE_TYPES: c, INLINE_NODE_WRAPPER_TYPES: l, isAutolink: T };
          ...
          function l(h, g, y, p) {
            ...
            if (f.type === "code" && f.lang !== null) {
              let C = t(f.lang, p);
              if (C) {
                let N = p.__inJsTemplate ? "~" : "`", T = N.repeat(Math.max(3, s(f.value, N) + 1)), A = { parser: C };
                f.lang === "tsx" && (A.filepath = "dummy.tsx");
                let b = y(c(f, p.originalText), A, { stripTrailingHardline: true });
            ...
            switch (f.type) {
              case "front-matter":
                return a(f, y);
              case "importExport":
                return [y(f.value, { parser: "babel" }, { stripTrailingHardline: true }), i];
              case "jsx":
                return y("<$>".concat(f.value, "</$>"), { parser: "__js_expression", rootMarker: "mdx" }, { stripTrailingHardline: true });
            }
            return null;
          }
          n.exports = l;
...
`).concat(u.content);
          ...
          function a(T, A) {
            return T = h(T, A), T = p(T), T = l(T), T = C(T, A), T = N(T, A), T = f(T, A), T = c(T), T = g(T), T;
          }
          function c(T) {
          ...
          function g(T) {
            return y(T, (A, b) => A.type === "importExport" && b.type === "importExport", (A, b) => ({ type: "importExport", value: A.value + `
...
` + b.value, position: { start: A.position.start, end: b.position.end } }));
          ...
          function p(T) {
            return y(T, (A, b) => A.type === "text" && b.type === "text", (A, b) => ({ type: "text", value: A.value + b.value, position: { start: A.position.start, end: b.position.end } }));
          }
          function f(T, A) {
            return i(T, (b, v, B) => {
              let [w] = B;
          ...
          function N(T, A) {
            ...
            function v(B) {
              ...
              let m = b(I);
              return D !== m ? false : D % A.tabWidth === 0 ? true : s(I, A.originalText).leadingSpaces.length > 1;
            }
          }
          n.exports = a;
          ...
          "use strict";
          ae();
          var { getLast: t, getMinNotPresentContinuousCount: s, getMaxContinuousCount: i, getStringWidth: r, isNonEmptyArray: u } = Ge(), { builders: { breakParent: a, join: c, line: l, literalline: h, markAsRoot: g, hardline: y, softline: p, ifBreak: f, fill: C, align: N, indent: T, group: A, hardlineWithoutBreakParent: b }, utils: { normalizeDoc: v, replaceTextEndOfLine: B }, printer: { printDocToString: w } } = Le(), I = Sd(), { insertPragma: E } = Do(), { locStart: D, locEnd: m } = fo(), d = xd(), o = bd(), { getFencedCodeBlockValue: x, hasGitDiffFriendlyOrderedList: F, splitText: S, punctuationPattern: k, INLINE_NODE_TYPES: P, INLINE_NODE_WRAPPER_TYPES: O, isAutolink: R } = Kn(), M = /* @__PURE__ */ new Set(["importExport"]), H = ["heading", "tableCell", "link", "wikiLink"], _ = /* @__PURE__ */ new Set(["listItem", "definition", "footnoteDefinition"]);
          function G(fe, pe, me) {
            let ce = fe.getValue();
            if (de(fe))
            ...
            switch (ce.type) {
              ...
              case "root":
                return ce.children.length === 0 ? "" : [v(oe(fe, pe, me)), M.has(Ee(ce).type) ? "" : y];
              case "paragraph":
              ...
              case "code": {
                if (ce.isIndented) {
                  let ye = " ".repeat(4);
                  return N(ye, [ye, ...B(ce.value, y)]);
                }
                let he = pe.__inJsTemplate ? "~" : "`", J = he.repeat(Math.max(3, i(ce.value, he) + 1));
                return [J, ce.lang || "", ce.meta ? " " + ce.meta : "", y, ...B(x(ce, pe.originalText), y), y, J];
              }
              case "html": {
              ...
              case "tableCell":
                return K(fe, pe, me);
              case "break":
                return /\s/.test(pe.originalText[ce.position.start.offset]) ? ["  ", g(h)] : ["\\", y];
              case "liquidNode":
                return B(ce.value, y);
              case "importExport":
                return [ce.value, y];
              ...
              case "jsx":
                return ce.value;
              case "math":
                return ["$$", y, ce.value ? [...B(ce.value, y), y] : "", "$$"];
              case "inlineMath":
                return pe.originalText.slice(D(ce), m(ce));
              case "tableRow":
              case "listItem":
              default:
...
`)
          ...
          function V(fe, pe, me) {
            ...
            function te(j) {
              let Ce = he.map((Ne, je) => {
                let Ue = ce.align[je], tt = Ue === "center" || Ue === "left" ? ":" : "-", Te = Ue === "center" || Ue === "right" ? ":" : "-", Pe = j ? "-" : "-".repeat(Ne - 2);
          ...
          function K(fe, pe, me) {
            ...
            return fe.each((te, z) => {
              ...
              if (Ce !== false) {
                ...
                le(j, Ne) && (X.push(y), Y && M.has(Y.type) || (ue(j, Ne) || Q(j, Ne)) && X.push(y), Q(j, Ne) && X.push(y)), X.push(Ce), Y = j;
              }
            }, "children"), he ? he(X) : X;
          }
          function Ee(fe) {
          ...
          function le(fe, pe) {
            let me = pe.parts.length === 0, ce = P.includes(fe.type), he = fe.type === "html" && O.includes(pe.parentNode.type);
            return !me && !ce && !he;
          }
          function ue(fe, pe) {
            let ce = (pe.prevNode && pe.prevNode.type) === fe.type && _.has(fe.type), he = pe.parentNode.type === "listItem" && !pe.parentNode.loose, J = pe.prevNode && pe.prevNode.type === "listItem" && pe.prevNode.loose, ye = q(pe.prevNode) === "next", X = fe.type === "html" && pe.prevNode && pe.prevNode.type === "html" && pe.prevNode.position.end.line + 1 === fe.position.start.line, Y = fe.type === "html" && pe.parentNode.type === "listItem" && pe.prevNode && pe.prevNode.type === "paragraph" && pe.prevNode.position.end.line + 1 === fe.position.start.line;
          ...
          n.exports = { preprocess: d, print: G, embed: I, massageAstNode: o, hasPrettierIgnore: we, insertPragma: E };
          ...
          n.exports = { languages: u, options: i, printers: a, parsers: r };
        } }), Pd = Z({ "src/language-html/clean.js"(e, n) {
          "use strict";
          ae();
        ...
        } }), _d = Z({ "src/language-html/constants.evaluate.js"(e, n) {
          ...
          "use strict";
          ae();
          var { inferParserByLanguage: t, isFrontMatterNode: s } = Ge(), { builders: { line: i, hardline: r, join: u }, utils: { getDocParts: a, replaceTextEndOfLine: c } } = Le(), { CSS_DISPLAY_TAGS: l, CSS_DISPLAY_DEFAULT: h, CSS_WHITE_SPACE_TAGS: g, CSS_WHITE_SPACE_DEFAULT: y } = _d(), p = Id(), f = /* @__PURE__ */ new Set(["	", `
`, "\f", "\r", " "]), C = (j) => j.replace(/^[\t\n\f\r ]+/, ""), N = (j) => j.replace(/[\t\n\f\r ]+$/, ""), T = (j) => C(N(j)), A = (j) => j.replace(/^[\t\f\r ]*\n/g, ""), b = (j) => A(N(j)), v = (j) => j.split(/[\t\n\f\r ]+/), B = (j) => j.match(/^[\t\n\f\r ]*/)[0], w = (j) => {
          ...
          function D(j) {
            return j.type === "attribute" || !j.parent || !j.prev ? false : m(j.prev);
          }
          function m(j) {
          ...
          function xe(j, Ce) {
            ...
            switch (Ce.htmlWhitespaceSensitivity) {
              ...
              case "ignore":
                return "block";
              default:
                return Ce.parser === "vue" && j.parent && j.parent.type === "root" ? "block" : j.type === "element" && (!j.namespace || Ne || p(j)) && l[j.name] || h;
            }
          }
          function we(j) {
            return j.type === "element" && (!j.namespace || p(j)) && g[j.name] || y;
          }
          function fe(j) {
...
`);
          ...
          e.Version = I;
          var E = typeof window < "u" && window, D = typeof self < "u" && typeof WorkerGlobalScope < "u" && self instanceof WorkerGlobalScope && self, m = typeof globalThis < "u" && globalThis, d = m || E || D;
          e.global = d;
          ...
          var N = class {
            constructor(F) {
              let { encapsulation: S, template: k, templateUrl: P, htmlAst: O, styles: R, styleUrls: M, externalStylesheets: H, animations: _, ngContentSelectors: G, interpolation: re, isInline: $, preserveWhitespaces: W } = F;
              if (this.encapsulation = S, this.template = k, this.templateUrl = P, this.htmlAst = O, this.styles = w(R), this.styleUrls = w(M), this.externalStylesheets = w(H), this.animations = _ ? E(_) : [], this.ngContentSelectors = G || [], re && re.length != 2)
          ...
          var T = class {
            static create(F) {
              let { isHost: S, type: k, isComponent: P, selector: O, exportAs: R, changeDetection: M, inputs: H, outputs: _, host: G, providers: re, viewProviders: $, queries: W, guards: ee, viewQueries: U, entryComponents: ne, template: se, componentViewType: V, rendererType: oe, componentFactory: K } = F, Ee = {}, q = {}, le = {};
              ...
              let Q = {};
              return _ != null && _.forEach((de) => {
                let ge = t.splitAtColon(de, [de, de]);
                Q[ge[0]] = ge[1];
              }), new T({ isHost: S, type: k, isComponent: !!P, selector: O, exportAs: R, changeDetection: M, inputs: ue, outputs: Q, hostListeners: Ee, hostProperties: q, hostAttributes: le, providers: re, viewProviders: $, queries: W, guards: ee, viewQueries: U, entryComponents: ne, template: se, componentViewType: V, rendererType: oe, componentFactory: K });
            }
            constructor(F) {
              let { isHost: S, type: k, isComponent: P, selector: O, exportAs: R, changeDetection: M, inputs: H, outputs: _, hostListeners: G, hostProperties: re, hostAttributes: $, providers: W, viewProviders: ee, queries: U, guards: ne, viewQueries: se, entryComponents: V, template: oe, componentViewType: K, rendererType: Ee, componentFactory: q } = F;
              this.isHost = !!S, this.type = k, this.isComponent = P, this.selector = O, this.exportAs = R, this.changeDetection = M, this.inputs = H, this.outputs = _, this.hostListeners = G, this.hostProperties = re, this.hostAttributes = $, this.providers = w(W), this.viewProviders = w(ee), this.queries = w(U), this.guards = ne, this.viewQueries = w(se), this.entryComponents = w(V), this.template = oe, this.componentViewType = K, this.rendererType = Ee, this.componentFactory = q;
            }
            toSummary() {
          ...
          var A = class {
            constructor(F) {
              let { type: S, name: k, pure: P } = F;
              this.type = S, this.name = k, this.pure = !!P;
            }
            toSummary() {
          ...
          var v = class {
            constructor(F) {
              let { type: S, providers: k, declaredDirectives: P, exportedDirectives: O, declaredPipes: R, exportedPipes: M, entryComponents: H, bootstrapComponents: _, importedModules: G, exportedModules: re, schemas: $, transitiveModule: W, id: ee } = F;
              this.type = S || null, this.declaredDirectives = w(P), this.exportedDirectives = w(O), this.declaredPipes = w(R), this.exportedPipes = w(M), this.providers = w(k), this.entryComponents = w(H), this.bootstrapComponents = w(_), this.importedModules = w(G), this.exportedModules = w(re), this.schemas = w($), this.id = ee || null, this.transitiveModule = W || null;
            }
            toSummary() {
              let F = this.transitiveModule;
              return { summaryKind: y.NgModule, type: this.type, entryComponents: F.entryComponents, providers: F.providers, modules: F.modules, exportedDirectives: F.exportedDirectives, exportedPipes: F.exportedPipes };
            }
          };
          ...
          var I = class {
            constructor(F, S) {
              let { useClass: k, useValue: P, useExisting: O, useFactory: R, deps: M, multi: H } = S;
              this.token = F, this.useClass = k || null, this.useValue = P, this.useExisting = O, this.useFactory = R || null, this.dependencies = M || null, this.multi = !!H;
            }
          };
          e.ProviderMeta = I;
          function E(F) {
            return F.reduce((S, k) => {
              let P = Array.isArray(k) ? E(k) : k;
              return S.concat(P);
            }, []);
          }
          e.flatten = E;
          ...
          function m(F, S, k) {
            let P;
            return k.isInline ? S.type.reference instanceof n.StaticSymbol ? P = "".concat(S.type.reference.filePath, ".").concat(S.type.reference.name, ".html") : P = "".concat(u(F), "/").concat(u(S.type), ".html") : P = k.templateUrl, S.type.reference instanceof n.StaticSymbol ? P : D(P);
          }
          e.templateSourceUrl = m;
          function d(F, S) {
            let k = F.moduleUrl.split(/\/\\/g), P = k[k.length - 1];
            return D("css/".concat(S).concat(P, ".ngstyle.js"));
          }
          e.sharedStylesheetJitUrl = d;
          function o(F) {
          ...
          var n = kd(), t = jd(), s = class {
            constructor(h, g, y, p) {
              this.file = h, this.offset = g, this.line = y, this.col = p;
            }
            toString() {
              return this.offset != null ? "".concat(this.file.url, "@").concat(this.line, ":").concat(this.col) : this.file.url;
            }
            moveBy(h) {
              let g = this.file.content, y = g.length, p = this.offset, f = this.line, C = this.col;
              for (; p > 0 && h < 0; )
                if (p--, h++, g.charCodeAt(p) == n.$LF) {
                  f--;
                  let T = g.substr(0, p - 1).lastIndexOf(String.fromCharCode(n.$LF));
                  C = T > 0 ? p - T : p;
                } else
                  C--;
              for (; p < y && h > 0; ) {
                let N = g.charCodeAt(p);
                p++, h--, N == n.$LF ? (f++, C = 0) : C++;
              }
...
` && ++N == g)); )
                  ;
                for (C = 0, N = 0; C < h && f < y.length - 1 && (f++, C++, !(y[f] == `
` && ++N == g)); )
                  ;
                return { before: y.substring(p, this.offset), after: y.substring(this.offset, f + 1) };
              }
              return null;
            }
          };
          ...
          var r = class {
            constructor(h, g) {
              ...
              this.start = h, this.end = g, this.details = y;
            }
            toString() {
          ...
          var a = class {
            constructor(h, g) {
              let y = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : u.ERROR;
              this.span = h, this.msg = g, this.level = y;
            }
            contextualMessage() {
              let h = this.span.start.getContext(100, 3);
              return h ? "".concat(this.msg, ' ("').concat(h.before, "[").concat(u[this.level], " ->]").concat(h.after, '")') : this.msg;
            }
            toString() {
          ...
          e.ParseError = a;
          function c(h, g) {
            let y = t.identifierModuleUrl(g), p = y != null ? "in ".concat(h, " ").concat(t.identifierName(g), " in ").concat(y) : "in ".concat(h, " ").concat(t.identifierName(g)), f = new i("", p);
            return new r(new s(f, -1, -1, -1), new s(f, -1, -1, -1));
          }
          e.typeSourceSpan = c;
          function l(h, g, y) {
            let p = "in ".concat(h, " ").concat(g, " in ").concat(y), f = new i("", p);
            return new r(new s(f, -1, -1, -1), new s(f, -1, -1, -1));
          }
          ...
          "use strict";
          ae();
          var { ParseSourceSpan: t } = qd(), { htmlTrim: s, getLeadingAndTrailingHtmlWhitespace: i, hasHtmlWhitespace: r, canHaveInterpolation: u, getNodeCssStyleDisplay: a, isDanglingSpaceSensitiveNode: c, isIndentationSensitiveNode: l, isLeadingSpaceSensitiveNode: h, isTrailingSpaceSensitiveNode: g, isWhitespaceSensitiveNode: y } = Ot(), p = [C, N, A, v, B, E, w, I, D, b];
          function f(m, d) {
            for (let o of p)
              o(m, d);
            return m;
...
`) {
                let o = d.children[0];
                o.value.length === 1 ? d.removeChild(o) : o.value = o.value.slice(1);
              }
            });
          }
          function N(m) {
            let d = (o) => o.type === "element" && o.prev && o.prev.type === "ieConditionalStartComment" && o.prev.sourceSpan.end.offset === o.startSourceSpan.start.offset && o.firstChild && o.firstChild.type === "ieConditionalEndComment" && o.firstChild.sourceSpan.start.offset === o.startSourceSpan.end.offset;
            m.walk((o) => {
              if (o.children)
                for (let x = 0; x < o.children.length; x++) {
                  ...
                  o.removeChild(S), x--;
                  let P = new t(S.sourceSpan.start, k.sourceSpan.end), O = new t(P.start, F.sourceSpan.end);
                  F.condition = S.condition, F.sourceSpan = O, F.startSourceSpan = P, F.removeChild(k);
                }
            });
          }
          function T(m, d, o) {
          ...
          function A(m) {
            return T(m, (d) => d.type === "cdata", (d) => "<![CDATA[".concat(d.value, "]]>"));
          }
          function b(m) {
            let d = (o) => o.type === "element" && o.attrs.length === 0 && o.children.length === 1 && o.firstChild.type === "text" && !r(o.children[0].value) && !o.firstChild.hasLeadingSpaces && !o.firstChild.hasTrailingSpaces && o.isLeadingSpaceSensitive && !o.hasLeadingSpaces && o.isTrailingSpaceSensitive && !o.hasTrailingSpaces && o.prev && o.prev.type === "text" && o.next && o.next.type === "text";
            m.walk((o) => {
              if (o.children)
                for (let x = 0; x < o.children.length; x++) {
                  let F = o.children[x];
            ...
            m.walk((x) => {
              if (!!u(x))
                for (let F of x.children) {
                  if (F.type !== "text")
                    continue;
                  let S = F.sourceSpan.start, k = null, P = F.value.split(o);
                  for (let O = 0; O < P.length; O++, S = k) {
                    let R = P[O];
                    if (O % 2 === 0) {
          ...
          function B(m) {
            m.walk((d) => {
              ...
              let o = y(d), x = l(d);
              if (!o)
                for (let F = 0; F < d.children.length; F++) {
                  let S = d.children[F];
                  if (S.type !== "text")
                    continue;
                  let { leadingWhitespace: k, text: P, trailingWhitespace: O } = i(S.value), R = S.prev, M = S.next;
                  P ? (S.value = P, S.sourceSpan = new t(S.sourceSpan.start.moveBy(k.length), S.sourceSpan.end.moveBy(-O.length)), k && (R && (R.hasTrailingSpaces = true), S.hasLeadingSpaces = true), O && (S.hasTrailingSpaces = true, M && (M.hasLeadingSpaces = true))) : (d.removeChild(S), F--, (k || O) && (R && (R.hasTrailingSpaces = true), M && (M.hasLeadingSpaces = true)));
                }
              d.isWhitespaceSensitive = o, d.isIndentationSensitive = x;
            });
          }
          function w(m) {
            m.walk((d) => {
          ...
          function I(m, d) {
            m.walk((o) => {
              o.type === "element" && (o.hasHtmComponentClosingTag = o.endSourceSpan && /^<\s*\/\s*\/\s*>$/.test(d.originalText.slice(o.endSourceSpan.start.offset, o.endSourceSpan.end.offset)));
            });
          }
          function E(m, d) {
            m.walk((o) => {
          ...
          function D(m, d) {
            m.walk((o) => {
              ...
              if (!!x) {
                ...
                for (let F of x)
                  F.isLeadingSpaceSensitive = h(F, d), F.isTrailingSpaceSensitive = g(F, d);
...
` + i.replace(/^\s*\n/, "");
          ...
          "use strict";
          ae();
          var t = Ut(), { isNonEmptyArray: s } = Ge(), { builders: { indent: i, join: r, line: u, softline: a, hardline: c }, utils: { replaceTextEndOfLine: l } } = Le(), { locStart: h, locEnd: g } = Yn(), { isTextLikeNode: y, getLastDescendant: p, isPreLikeNode: f, hasPrettierIgnore: C, shouldPreserveContent: N } = Ot();
          function T(_, G) {
            return [_.isSelfClosing ? "" : A(_, G), b(_, G)];
          }
          function A(_, G) {
            return _.lastChild && d(_.lastChild) ? "" : [v(_, G), w(_, G)];
          }
          function b(_, G) {
            return (_.next ? D(_.next) : m(_.parent)) ? "" : [I(_, G), B(_, G)];
          }
          function v(_, G) {
            return m(_) ? I(_.lastChild, G) : "";
          }
          function B(_, G) {
            return d(_) ? w(_.parent, G) : o(_) ? M(_.next) : "";
          }
          function w(_, G) {
            if (t(!_.isSelfClosing), E(_, G))
              return "";
            switch (_.type) {
              case "ieConditionalComment":
                return "<!";
          ...
          function E(_, G) {
            return !_.isSelfClosing && !_.endSourceSpan && (C(_) || N(_.parent, G));
          }
          function D(_) {
            return _.prev && _.prev.type !== "docType" && !y(_.prev) && _.isLeadingSpaceSensitive && !_.hasLeadingSpaces;
          }
          function m(_) {
            return _.lastChild && _.lastChild.isTrailingSpaceSensitive && !_.lastChild.hasTrailingSpaces && !y(p(_.lastChild)) && !f(_);
          }
          function d(_) {
          ...
          function x(_) {
            let G = _.trim().match(/^prettier-ignore-attribute(?:\s+(.+))?$/s);
          ...
          function S(_, G, re) {
            ...
            let W = $.prev && $.prev.type === "comment" && x($.prev.value), ee = typeof W == "boolean" ? () => W : Array.isArray(W) ? (oe) => W.includes(oe.rawName) : () => false, U = _.map((oe) => {
              let K = oe.getValue();
              return ee(K) ? l(G.originalText.slice(h(K), g(K))) : re();
            ...
            return $.firstChild && F($.firstChild) || $.isSelfClosing && m($.parent) || ne ? V.push($.isSelfClosing ? " " : "") : V.push(G.bracketSameLine ? $.isSelfClosing ? " " : "" : $.isSelfClosing ? u : a), V;
          }
          function k(_) {
            return _.firstChild && F(_.firstChild) ? "" : H(_);
          }
          function P(_, G, re) {
            let $ = _.getValue();
            return [O($, G), S(_, G, re), $.isSelfClosing ? "" : k($)];
          }
          function O(_, G) {
            return _.prev && o(_.prev) ? "" : [R(_, G), M(_)];
          }
          function R(_, G) {
            return F(_) ? H(_.parent) : D(_) ? I(_.prev, G) : "";
          }
          function M(_) {
            switch (_.type) {
              case "ieConditionalComment":
...
` || I === "\f" || I === "\r";
              ...
              for (var a = t.length, c = /^[ \t\n\r\u000c]+/, l = /^[, \t\n\r\u000c]+/, h = /^[^ \t\n\r\u000c]+/, g = /[,]+$/, y = /^\d+$/, p = /^-?(?:[0-9]+|[0-9]*\.[0-9]+)(?:[eE][+-]?[0-9]+)?$/, f, C, N, T, A, b = 0, v = []; ; ) {
                if (u(l), b >= a)
                  return v;
                f = u(h), C = [], f.slice(-1) === "," ? (f = f.replace(g, ""), w()) : B();
              }
              function B() {
                for (u(c), N = "", T = "in descriptor"; ; ) {
                  if (A = t.charAt(b), T === "in descriptor")
                    if (r(A))
                      N && (C.push(N), N = "", T = "after descriptor");
                    else if (A === ",") {
                      b += 1, N && C.push(N), w();
                      return;
                    } else if (A === "(")
              ...
              function w() {
                var I = false, E, D, m, d, o = {}, x, F, S, k, P;
                for (d = 0; d < C.length; d++)
                  x = C[d], F = x[x.length - 1], S = x.substring(0, x.length - 1), k = parseInt(S, 10), P = parseFloat(S), y.test(S) && F === "w" ? ((E || D) && (I = true), k === 0 ? I = true : E = k) : p.test(S) && F === "x" ? ((E || D || m) && (I = true), P < 0 ? I = true : D = P) : y.test(S) && F === "h" ? ((m || D) && (I = true), k === 0 ? I = true : m = k) : I = true;
                I ? i && i.error && i.error("Invalid srcset descriptor found in '" + t + "' at '" + x + "'.") : (o.url = f, E && (o.w = E), D && (o.d = D), m && (o.h = m), v.push(o));
              }
            };
          });
          ...
          function u(c) {
            ...
            let p = h ? "w" : g ? "h" : "d", f = h ? "w" : g ? "h" : "x", C = (B) => Math.max(...B), N = l.map((B) => B.url), T = C(N.map((B) => B.length)), A = l.map((B) => B[p]).map((B) => B ? B.toString() : ""), b = A.map((B) => {
              let w = B.indexOf(".");
            ...
            return i([",", r], N.map((B, w) => {
              let I = [B], E = A[w];
              if (E) {
                let D = T - B.length + 1, m = v - b[w], d = " ".repeat(D + m);
                I.push(s(d, " "), E + f);
              }
              return I;
            }));
          ...
          function s(a, c) {
            let { left: l, operator: h, right: g } = i(a);
            return [t(c("function _(".concat(l, ") {}"), { parser: "babel", __isVueForBindingLeft: true })), " ", h, " ", c(g, { parser: "__js_expression" }, { stripTrailingHardline: true })];
          }
          function i(a) {
            let c = /(.*?)\s+(in|of)\s+(.*)/s, l = /,([^,\]}]*)(?:,([^,\]}]*))?$/, h = /^\(|\)$/g, g = a.match(c);
            if (!g)
              return;
            let y = {};
            if (y.for = g[3].trim(), !y.for)
              return;
            let p = g[1].trim().replace(h, ""), f = p.match(l);
            f ? (y.alias = p.replace(l, ""), y.iterator1 = f[1].trim(), f[2] && (y.iterator2 = f[2].trim())) : y.alias = p;
            let C = [y.alias, y.iterator1, y.iterator2];
            if (!C.some((N, T) => !N && (T === 0 || C.slice(T + 1).some(Boolean))))
              return { left: C.filter(Boolean).join(","), operator: g[2], right: y.for };
          }
          function r(a, c) {
            return c("function _(".concat(a, ") {}"), { parser: "babel", __isVueBindings: true });
          }
          function u(a) {
            let c = /^(?:[\w$]+|\([^)]*\))\s*=>|^function\s*\(/, l = /^[$A-Z_a-z][\w$]*(?:\.[$A-Z_a-z][\w$]*|\['[^']*']|\["[^"]*"]|\[\d+]|\[[$A-Z_a-z][\w$]*])*$/, h = a.trim();
            return c.test(h) || l.test(h);
          }
          ...
          function c(l, h) {
            let g = l.startSourceSpan.end.offset;
            l.firstChild && u(l.firstChild) && (g -= a(l).length);
            let y = l.endSourceSpan.start.offset;
            return l.lastChild && t(l.lastChild) ? y += s(l, h).length : i(l) && (y -= r(l.lastChild, h).length), h.originalText.slice(g, y);
          }
          n.exports = c;
        } }), Hd = Z({ "src/language-html/embed.js"(e, n) {
          "use strict";
          ae();
          var { builders: { breakParent: t, group: s, hardline: i, indent: r, line: u, fill: a, softline: c }, utils: { mapDoc: l, replaceTextEndOfLine: h } } = Le(), g = Xn(), { printClosingTag: y, printClosingTagSuffix: p, needsToBorrowPrevClosingTagEndMarker: f, printOpeningTagPrefix: C, printOpeningTag: N } = Qt(), { printImgSrcset: T, printClassNames: A } = Wd(), { printVueFor: b, printVueBindings: v, isVueEventBindingExpression: B } = $d(), { isScriptLikeTag: w, isVueNonHtmlBlock: I, inferScriptParser: E, htmlTrimPreserveIndentation: D, dedentString: m, unescapeQuoteEntities: d, isVueSlotAttribute: o, isVueSfcBindingsAttribute: x, getTextValueParts: F } = Ot(), S = mo();
          function k(O, R, M) {
            let H = (ne) => new RegExp(ne.join("|")).test(O.fullName), _ = () => d(O.value), G = false, re = (ne, se) => {
            ...
            if (M.parser === "vue") {
              ...
              if (H(se))
                return ee(U(_(), { parser: "__vue_expression" }));
              if (H(V))
                return ee(U(_(), { parser: "__js_expression" }));
            }
            if (M.parser === "angular") {
              ...
              if (H(V))
                return ee(ne(_(), { parser: "__ng_action" }));
              if (H(oe))
                return ee(ne(_(), { parser: "__ng_binding" }));
              if (H(K)) {
                let le = _().trim();
                return W(a(F(O, le)), !le.includes("@@"));
              }
              if (H(se))
                return ee(ne(_(), { parser: "__ng_directive" }));
              let Ee = /{{(.+?)}}/s, q = _();
              if (Ee.test(q)) {
                let le = [];
          ...
          function P(O, R, M, H) {
            ...
            switch (_.type) {
              case "element": {
                if (w(_) || _.type === "interpolation")
                  return;
                if (!_.isSelfClosing && I(_, H)) {
                  let G = E(_, H);
                  if (!G)
                    return;
                  let re = S(_, H), $ = /^\s*$/.test(re), W = "";
                  return $ || (W = M(D(re), { parser: G, __embeddedInHtml: true }, { stripTrailingHardline: true }), $ = W === ""), [C(_, H), s(N(O, H, R)), $ ? "" : i, W, $ ? "" : i, y(_, H), p(_, H)];
                }
                break;
              }
              case "text": {
                if (w(_.parent)) {
                  let G = E(_.parent);
                  if (G) {
                    let re = G === "markdown" ? m(_.value.replace(/^[^\S\n]*\n/, "")) : _.value, $ = { parser: G, __embeddedInHtml: true };
                    if (H.parser === "html" && G === "babel") {
                      let W = "script", { attrMap: ee } = _.parent;
                      ee && (ee.type === "module" || ee.type === "text/babel" && ee["data-type"] === "module") && (W = "module"), $.__babelSourceType = W;
                    }
                    return [t, C(_, H), M(re, $, { stripTrailingHardline: true }), p(_, H)];
                  }
                } else if (_.parent.type === "interpolation") {
                  let G = { __isInHtmlInterpolation: true, __embeddedInHtml: true };
                  return H.parser === "angular" ? (G.parser = "__ng_interpolation", G.trailingComma = "none") : H.parser === "vue" ? G.parser = "__vue_expression" : G.parser = "__js_expression", [r([u, M(_.value, G, { stripTrailingHardline: true })]), _.parent.next && f(_.parent.next) ? " " : u];
                }
                break;
              }
              case "attribute": {
                if (!_.value)
                  break;
                if (/^PRETTIER_HTML_PLACEHOLDER_\d+_\d+_IN_JS$/.test(H.originalText.slice(_.valueSpan.start.offset, _.valueSpan.end.offset)))
                  return [_.rawName, "=", _.value];
                if (H.parser === "lwc" && /^{.*}$/s.test(H.originalText.slice(_.valueSpan.start.offset, _.valueSpan.end.offset)))
                  return [_.rawName, "=", _.value];
                let G = k(_, (re, $) => M(re, Object.assign({ __isInHtmlAttribute: true, __embeddedInHtml: true }, $), { stripTrailingHardline: true }), H);
                if (G)
                  return [_.rawName, '="', s(l(G, (re) => typeof re == "string" ? re.replace(/"/g, "&quot;") : re)), '"'];
                break;
              }
              case "front-matter":
                return g(_, M);
          ...
          "use strict";
          ae();
          var { builders: { breakParent: t, group: s, ifBreak: i, line: r, softline: u, hardline: a }, utils: { replaceTextEndOfLine: c } } = Le(), { locStart: l, locEnd: h } = Yn(), { forceBreakChildren: g, forceNextEmptyLine: y, isTextLikeNode: p, hasPrettierIgnore: f, preferHardlineAsLeadingSpaces: C } = Ot(), { printOpeningTagPrefix: N, needsToBorrowNextOpeningTagStartMarker: T, printOpeningTagStartMarker: A, needsToBorrowPrevClosingTagEndMarker: b, printClosingTagEndMarker: v, printClosingTagSuffix: B, needsToBorrowParentClosingTagStartMarker: w } = Qt();
          function I(m, d, o) {
            let x = m.getValue();
            return f(x) ? [N(x, d), ...c(d.originalText.slice(l(x) + (x.prev && T(x.prev) ? A(x).length : 0), h(x) - (x.next && b(x.next) ? v(x, d).length : 0))), B(x, d)] : o();
          }
          function E(m, d) {
            return p(m) && p(d) ? m.isTrailingSpaceSensitive ? m.hasTrailingSpaces ? C(d) ? a : r : "" : C(d) ? a : u : T(m) && (f(d) || d.firstChild || d.isSelfClosing || d.type === "element" && d.attrs.length > 0) || m.type === "element" && m.isSelfClosing && b(d) ? "" : !d.isLeadingSpaceSensitive || C(d) || b(d) && m.lastChild && w(m.lastChild) && m.lastChild.lastChild && w(m.lastChild.lastChild) ? a : d.hasLeadingSpaces ? r : u;
          }
          function D(m, d, o) {
            let x = m.getValue();
            if (g(x))
              return [t, ...m.map((S) => {
                let k = S.getValue(), P = k.prev ? E(k.prev, k) : "";
                return [P ? [P, y(k.prev) ? a : ""] : "", I(S, d, o)];
              }, "children")];
            ...
            return m.map((S, k) => {
              ...
              if (p(P)) {
                if (P.prev && p(P.prev)) {
                  let re = E(P.prev, P);
                  if (re)
                    return y(P.prev) ? [a, a, I(S, d, o)] : [re, I(S, d, o)];
                }
                return I(S, d, o);
              }
              let O = [], R = [], M = [], H = [], _ = P.prev ? E(P.prev, P) : "", G = P.next ? E(P, P.next) : "";
              return _ && (y(P.prev) ? O.push(a, a) : _ === a ? O.push(a) : p(P.prev) ? R.push(_) : R.push(i("", u, { groupId: F[k - 1] }))), G && (y(P) ? p(P.next) && H.push(a, a) : G === a ? p(P.next) && H.push(a) : M.push(G)), [...O, s([...R, s([I(S, d, o), ...M], { id: F[k] })]), ...H];
            }, "children");
          }
          ...
          "use strict";
          ae();
          var { builders: { breakParent: t, dedentToRoot: s, group: i, ifBreak: r, indentIfBreak: u, indent: a, line: c, softline: l }, utils: { replaceTextEndOfLine: h } } = Le(), g = mo(), { shouldPreserveContent: y, isScriptLikeTag: p, isVueCustomBlock: f, countParents: C, forceBreakContent: N } = Ot(), { printOpeningTagPrefix: T, printOpeningTag: A, printClosingTagSuffix: b, printClosingTag: v, needsToBorrowPrevClosingTagEndMarker: B, needsToBorrowLastChildClosingTagEndMarker: w } = Qt(), { printChildren: I } = go();
          function E(D, m, d) {
            let o = D.getValue();
            if (y(o, m))
              return [T(o, m), i(A(D, m, d)), ...h(g(o, m)), ...v(o, m), b(o, m)];
            let x = o.children.length === 1 && o.firstChild.type === "interpolation" && o.firstChild.isLeadingSpaceSensitive && !o.firstChild.hasLeadingSpaces && o.lastChild.isTrailingSpaceSensitive && !o.lastChild.hasTrailingSpaces, F = Symbol("element-attr-group-id"), S = (R) => i([i(A(D, m, d), { id: F }), R, v(o, m)]), k = (R) => x ? u(R, { groupId: F }) : (p(o) || f(o, m)) && o.parent.type === "root" && m.parser === "vue" && !m.vueIndentScriptAndStyle ? R : a(R), P = () => x ? r(l, "", { groupId: F }) : o.firstChild.hasLeadingSpaces && o.firstChild.isLeadingSpaceSensitive ? c : o.firstChild.type === "text" && o.isWhitespaceSensitive && o.isIndentationSensitive ? s(l) : l, O = () => (o.next ? B(o.next) : w(o.parent)) ? o.lastChild.hasTrailingSpaces && o.lastChild.isTrailingSpaceSensitive ? " " : "" : x ? r(l, "", { groupId: F }) : o.lastChild.hasTrailingSpaces && o.lastChild.isTrailingSpaceSensitive ? c : (o.lastChild.type === "comment" || o.lastChild.type === "text" && o.isWhitespaceSensitive && o.isIndentationSensitive) && new RegExp("\\n[\\t ]{".concat(m.tabWidth * C(D, (M) => M.parent && M.parent.type !== "root"), "}$")).test(o.lastChild.value) ? "" : l;
            return o.children.length === 0 ? S(o.hasDanglingSpaces && o.isDanglingSpaceSensitive ? c : "") : S([N(o) ? t : "", k([P(), I(D, m, d)]), O()]);
          }
          n.exports = { printElement: E };
        } }), Jd = Z({ "src/language-html/printer-html.js"(e, n) {
          "use strict";
          ae();
          var { builders: { fill: t, group: s, hardline: i, literalline: r }, utils: { cleanDoc: u, getDocParts: a, isConcat: c, replaceTextEndOfLine: l } } = Le(), h = Pd(), { countChars: g, unescapeQuoteEntities: y, getTextValueParts: p } = Ot(), f = Md(), { insertPragma: C } = Rd(), { locStart: N, locEnd: T } = Yn(), A = Hd(), { printClosingTagSuffix: b, printClosingTagEnd: v, printOpeningTagPrefix: B, printOpeningTagStart: w } = Qt(), { printElement: I } = Gd(), { printChildren: E } = go();
          function D(m, d, o) {
            let x = m.getValue();
            switch (x.type) {
              case "front-matter":
                return l(x.raw);
              case "root":
                return d.__onHtmlRoot && d.__onHtmlRoot(x), [s(E(m, d, o)), i];
              case "element":
              case "ieConditionalComment":
                return I(m, d, o);
              case "ieConditionalStartComment":
              case "ieConditionalEndComment":
                return [w(x), v(x)];
              case "interpolation":
                return [w(x, d), ...m.map(o, "children"), v(x, d)];
              case "text": {
                if (x.parent.type === "interpolation") {
                  let S = /\n[^\S\n]*$/, k = S.test(x.value), P = k ? x.value.replace(S, "") : x.value;
                  return [...l(P), k ? i : ""];
                }
                let F = u([B(x, d), ...p(x), b(x, d)]);
                return c(F) || F.type === "fill" ? t(a(F)) : F;
              }
              case "docType":
                return [s([w(x, d), " ", x.value.replace(/^html\b/i, "html").replace(/\s+/g, " ")]), v(x, d)];
              case "comment":
                return [B(x, d), ...l(d.originalText.slice(N(x), T(x)), r), b(x, d)];
              case "attribute": {
                if (x.value === null)
                  return x.rawName;
                let F = y(x.value), S = g(F, "'"), k = g(F, '"'), P = S < k ? "'" : '"';
                return [x.rawName, "=", P, ...l(P === '"' ? F.replace(/"/g, "&quot;") : F.replace(/'/g, "&apos;")), P];
              }
              default:
...
`.concat(r);
          ...
          function u(E, D, m) {
            return D("children" in E ? Object.assign(Object.assign({}, E), {}, { children: E.children.map((d) => u(d, D, E)) }) : E, m);
          }
          function a(E, D, m) {
            Object.defineProperty(E, D, { get: m, enumerable: false });
          }
          function c(E, D) {
            let m = 0, d = D.length;
            for (let o = E.position.end.offset - 1; o < d; o++) {
              let x = D[o];
              if (x === `
` && m++, m === 1 && /\S/.test(x))
                return false;
          ...
          function l(E) {
            ...
            let m = E.stack.length;
            for (let d = 1; d < m; d++) {
              let o = E.stack[d], x = E.stack[d - 1];
          ...
          function y(E) {
            ...
            if (D.type === "documentBody") {
              ...
              return b(m.head) && g(t(m.head.endComments));
            }
            return C(D) && g(t(D.leadingComments));
          }
          function p(E) {
            return !s(E.children) && !f(E);
          }
          function f(E) {
            return C(E) || N(E) || T(E) || A(E) || b(E);
          }
          function C(E) {
          ...
          function v(E) {
            ...
            for (let d of E.split(/( +)/))
              d !== " " ? m === " " ? D.push(d) : D.push((D.pop() || "") + d) : m === void 0 && D.unshift(""), m = d;
...
`).map((o, x, F) => x === 0 && x === F.length - 1 ? o : x !== 0 && x !== F.length - 1 ? o.trim() : x === 0 ? o.trimEnd() : o.trimStart());
            return m.proseWrap === "preserve" ? d.map((o) => o.length === 0 ? [] : [o]) : d.map((o) => o.length === 0 ? [] : v(o)).reduce((o, x, F) => F !== 0 && d[F - 1].length > 0 && x.length > 0 && !(E === "quoteDouble" && t(t(o)).endsWith("\\")) ? [...o.slice(0, -1), [...t(o), ...x]] : [...o, x], []).map((o) => m.proseWrap === "never" ? [o.join(" ")] : o);
          }
          function w(E, D) {
            let { parentIndent: m, isLastDescendant: d, options: o } = D, x = E.position.start.line === E.position.end.line ? "" : o.originalText.slice(E.position.start.offset, E.position.end.offset).match(/^[^\n]*\n(.*)$/s)[1], F;
            if (E.indent === null) {
              let P = x.match(/^(?<leadingSpace> *)[^\n\r ]/m);
              F = P ? P.groups.leadingSpace.length : Number.POSITIVE_INFINITY;
            } else
              F = E.indent - 1 + m;
            let S = x.split(`
`).map((P) => P.slice(F));
            if (o.proseWrap === "preserve" || E.type === "blockLiteral")
              return k(S.map((P) => P.length === 0 ? [] : [P]));
            return k(S.map((P) => P.length === 0 ? [] : v(P)).reduce((P, O, R) => R !== 0 && S[R - 1].length > 0 && O.length > 0 && !/^\s/.test(O[0]) && !/^\s|\s$/.test(t(P)) ? [...P.slice(0, -1), [...t(P), ...O]] : [...P, O], []).map((P) => P.reduce((O, R) => O.length > 0 && /\s$/.test(t(O)) ? [...O.slice(0, -1), t(O) + " " + R] : [...O, R], [])).map((P) => o.proseWrap === "never" ? [P.join(" ")] : P));
            function k(P) {
              if (E.chomping === "keep")
                return t(P).length === 0 ? P.slice(0, -1) : P;
              let O = 0;
              for (let R = P.length - 1; R >= 0 && P[R].length === 0; R--)
                O++;
              return O === 0 ? P : O >= 2 && !d ? P.slice(0, -(O - 1)) : P.slice(0, -O);
            }
          }
          function I(E) {
            if (!E)
          ...
          n.exports = { getLast: t, getAncestorCount: i, isNode: r, isEmptyNode: p, isInlineNode: I, mapNode: u, defineShortcut: a, isNextLineEmpty: c, isLastDescendantNode: l, getBlockValueLineContents: w, getFlowScalarLineContents: B, getLastDescendantNode: h, hasPrettierIgnore: y, hasLeadingComments: C, hasMiddleComments: N, hasIndicatorComment: T, hasTrailingComment: A, hasEndComments: b };
          ...
          function c(g, y) {
            let p = g.getValue(), f = g.stack[0], C;
            return a.has(f) ? C = a.get(f) : (C = /* @__PURE__ */ new Set(), a.set(f, C)), !C.has(p.position.end.line) && (C.add(p.position.end.line), r(p, y) && !l(g.getParentNode())) ? t : "";
          }
          function l(g) {
            return i(g) && !u(g, ["documentHead", "documentBody", "flowMapping", "flowSequence"]);
          }
          function h(g, y) {
            return s(" ".repeat(g), y);
          }
          n.exports = { alignWithSpaces: h, shouldPrintEndComments: l, printNextEmptyLine: c };
        } }), tg = Z({ "src/language-yaml/print/flow-mapping-sequence.js"(e, n) {
          "use strict";
          ae();
          var { builders: { ifBreak: t, line: s, softline: i, hardline: r, join: u } } = Le(), { isEmptyNode: a, getLast: c, hasEndComments: l } = jt(), { printNextEmptyLine: h, alignWithSpaces: g } = kr();
          function y(f, C, N) {
            ...
            return [b, g(N.tabWidth, [B, p(f, C, N), N.trailingComma === "none" ? "" : t(","), l(T) ? [r, u(r, f.map(C, "endComments"))] : ""]), I ? "" : B, v];
          }
          function p(f, C, N) {
            let T = f.getValue();
            return f.map((b, v) => [C(), v === T.children.length - 1 ? "" : [",", s, T.children[v].position.start.line !== T.children[v + 1].position.start.line ? h(b, N.originalText) : ""]], "children");
          }
          n.exports = { printFlowMapping: y, printFlowSequence: y };
        } }), rg = Z({ "src/language-yaml/print/mapping-item.js"(e, n) {
          "use strict";
          ae();
          var { builders: { conditionalGroup: t, group: s, hardline: i, ifBreak: r, join: u, line: a } } = Le(), { hasLeadingComments: c, hasMiddleComments: l, hasTrailingComment: h, hasEndComments: g, isNode: y, isEmptyNode: p, isInlineNode: f } = jt(), { alignWithSpaces: C } = kr();
          function N(v, B, w, I, E) {
            let { key: D, value: m } = v, d = p(D), o = p(m);
            if (d && o)
              return ": ";
            let x = I("key"), F = A(v) ? " " : "";
            if (o)
              return v.type === "flowMappingItem" && B.type === "flowMapping" ? x : v.type === "mappingItem" && T(D.content, E) && !h(D.content) && (!B.tag || B.tag.value !== "tag:yaml.org,2002:set") ? [x, F, ":"] : ["? ", C(2, x)];
            let S = I("value");
            if (d)
              return [": ", C(2, S)];
            if (c(m) || !f(D.content))
              return ["? ", C(2, x), i, u("", w.map(I, "value", "leadingComments").map((H) => [H, i])), ": ", C(2, S)];
            if (b(D.content) && !c(D.content) && !l(D.content) && !h(D.content) && !g(D) && !c(m.content) && !l(m.content) && !g(m) && T(m.content, E))
              return [x, F, ": ", S];
            let k = Symbol("mappingKey"), P = s([r("? "), s(C(2, x), { id: k })]), O = [i, ": ", C(2, S)], R = [F, ":"];
            c(m.content) || g(m) && m.content && !y(m.content, ["mapping", "sequence"]) || B.type === "mapping" && h(D.content) && f(m.content) || y(m.content, ["mapping", "sequence"]) && m.content.tag === null && m.content.anchor === null ? R.push(i) : m.content && R.push(a), R.push(S);
            let M = C(E.tabWidth, R);
            return T(D.content, E) && !c(D.content) && !l(D.content) && !g(D) ? t([[x, M]]) : t([[P, r(O, M, { groupId: k })]]);
          }
          function T(v, B) {
            if (!v)
              return true;
...
`);
          ...
          "use strict";
          ae();
          var { builders: { dedent: t, dedentToRoot: s, fill: i, hardline: r, join: u, line: a, literalline: c, markAsRoot: l }, utils: { getDocParts: h } } = Le(), { getAncestorCount: g, getBlockValueLineContents: y, hasIndicatorComment: p, isLastDescendantNode: f, isNode: C } = jt(), { alignWithSpaces: N } = kr();
          function T(A, b, v) {
            let B = A.getValue(), w = g(A, (d) => C(d, ["sequence", "mapping"])), I = f(A), E = [B.type === "blockFolded" ? ">" : "|"];
            B.indent !== null && E.push(B.indent.toString()), B.chomping !== "clip" && E.push(B.chomping === "keep" ? "+" : "-"), p(B) && E.push(" ", b("indicatorComment"));
            let D = y(B, { parentIndent: w, isLastDescendant: I, options: v }), m = [];
            for (let [d, o] of D.entries())
              d === 0 && m.push(r), m.push(i(h(u(a, o)))), d !== D.length - 1 ? m.push(o.length === 0 ? r : l(c)) : B.chomping === "keep" && I && m.push(s(o.length === 0 ? r : c));
            return B.indent === null ? E.push(t(N(v.tabWidth, m))) : E.push(s(N(B.indent - 1 + w, m))), E;
          }
          n.exports = T;
        } }), ug = Z({ "src/language-yaml/printer-yaml.js"(e, n) {
          "use strict";
          ae();
          var { builders: { breakParent: t, fill: s, group: i, hardline: r, join: u, line: a, lineSuffix: c, literalline: l }, utils: { getDocParts: h, replaceTextEndOfLine: g } } = Le(), { isPreviousLineEmpty: y } = Ge(), { insertPragma: p, isPragma: f } = Yd(), { locStart: C } = Qd(), N = Zd(), { getFlowScalarLineContents: T, getLastDescendantNode: A, hasLeadingComments: b, hasMiddleComments: v, hasTrailingComment: B, hasEndComments: w, hasPrettierIgnore: I, isLastDescendantNode: E, isNode: D, isInlineNode: m } = jt(), d = eg(), { alignWithSpaces: o, printNextEmptyLine: x, shouldPrintEndComments: F } = kr(), { printFlowMapping: S, printFlowSequence: k } = tg(), P = rg(), O = ng();
          function R(W, ee, U) {
            ...
            return I(W) ? se.push(g(ee.originalText.slice(ne.position.start.offset, ne.position.end.offset).trimEnd(), l)) : se.push(i(M(ne, Ee, W, ee, U))), B(ne) && !D(ne, ["document", "documentHead"]) && se.push(c([ne.type === "mappingValue" && !ne.content ? "" : " ", Ee.type === "mappingKey" && W.getParentNode(2).type === "mapping" && m(ne) ? "" : t, U("trailingComment")])), F(ne) && se.push(o(ne.type === "sequenceItem" ? 2 : 0, [r, u(r, W.map((q) => [y(ee.originalText, q.getValue(), C) ? r : "", U()], "endComments"))])), se.push(K), se;
          }
          function M(W, ee, U, ne, se) {
            switch (W.type) {
              case "root": {
                ...
                U.each((Ee, q) => {
                  let le = V[q], ue = V[q + 1];
                  q !== 0 && oe.push(r), oe.push(se()), _(le, ue) ? (oe.push(r, "..."), B(le) && oe.push(" ", se("trailingComment"))) : ue && !B(ue.head) && oe.push(r, "---");
                }, "children");
                let K = A(W);
          ...
          function G(W, ee, U, ne) {
            return U.children[0] === W && /---(?:\s|$)/.test(ne.originalText.slice(C(W), C(W) + 4)) || W.head.children.length > 0 || w(W.head) || B(W.head) ? "head" : _(W, ee) ? false : ee ? "root" : false;
          }
          function re(W, ee, U) {
            let ne = T(W, ee, U);
            return u(r, ne.map((se) => s(h(u(a, se)))));
          }
          function $(W, ee) {
            if (D(ee))
          ...
          n.exports = { preprocess: d, embed: N, print: R, massageAstNode: $, insertPragma: p };
        ...
        ae();
        var { version: lg } = gi(), Pt = om(), { getSupportInfo: pg } = Mn(), fg = cm(), Dg = cg(), mg = Le();
        function St(e) {
        ...
        var Sn = St(Pt.formatWithCursor);
        yo.exports = { formatWithCursor: Sn, format(e, n) {
          return Sn(e, n).formatted;
        }, check(e, n) {
          let { formatted: t } = Sn(e, n);
          return t === e;
        }, doc: mg, getSupportInfo: St(pg, 0), version: lg, util: fg, __debug: { parse: St(Pt.parse), formatAST: St(Pt.formatAST), formatDoc: St(Pt.formatDoc), printToDoc: St(Pt.printToDoc), printDocToString: St(Pt.printDocToString) } };
      });
      "use strict";
      return dg();
    });
