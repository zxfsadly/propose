...
declare function isRelative(name: string): boolean;
...
declare function createServer(options: ResolvedSlidevOptions, pluginConfig?: SlidevPluginOptions, viteConfig?: InlineConfig): Promise<vite.ViteDevServer>;

declare function ViteSlidevPlugin(options: ResolvedSlidevOptions, pluginOptions: SlidevPluginOptions): Promise<Plugin[]>;

declare function createWindiCSSPlugin({ themeRoots, clientRoot }: ResolvedSlidevOptions, { windicss: windiOptions }: SlidevPluginOptions): vite.Plugin[];

export { ResolvedSlidevOptions, SlidevEntryOptions, SlidevPluginOptions, ViteSlidevPlugin, createServer, createWindiCSSPlugin, getCLIRoot, getClientRoot, getThemeRoots, isRelative, resolveOptions };
