...
var require_chunk_JBT3DO44 = _chunkAV6ARAKLjs.__commonJS.call(void 0, (exports) => {
  "use strict";
...
var require_dist = _chunkAV6ARAKLjs.__commonJS.call(void 0, (exports) => {
  "use strict";
  Object.defineProperty(exports, "__esModule", {value: true});
...
// node/themes.ts
var import_ni = _chunkAV6ARAKLjs.__toModule.call(void 0, require_dist());
...
function getClientRoot() {
  return _path3.dirname.call(void 0, require.resolve("@slidev/client/package.json"));
}
function getCLIRoot() {
...
function getThemeRoots(name, entry) {
  ...
  if (isRelative(name)) {
    ...
    return [
      _path3.dirname.call(void 0, require.resolve(`${name}/package.json`))
    ];
  }
}
async function resolveOptions(options, mode, promptForInstallation = true) {
  ...
  return {
    data,
    mode,
    entry: _path3.resolve.call(void 0, userRoot, entry),
    theme,
    userRoot,
    clientRoot,
    cliRoot,
...
exports.packageExists = packageExists; exports.resolveThemeName = resolveThemeName; exports.getClientRoot = getClientRoot; exports.getCLIRoot = getCLIRoot; exports.isRelative = isRelative; exports.getThemeRoots = getThemeRoots; exports.resolveOptions = resolveOptions;
