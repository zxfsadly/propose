...
var CSSParser = /** @class */ (function () {
    ...
    CSSParser.prototype._removeComment = function (css) {
        if (!css)
            return css;
    ...
    CSSParser.prototype.parse = function (css, parent, parentType) {
        ...
        var _loop_1 = function () {
            ...
            if (propEnd === -1 || (nestStart !== -1 && propEnd > nestStart)) {
                ...
                index = nestEnd + 1;
                styleSheet.add(this_1._generateNestStyle(content.children, selector, css.charAt(firstLetter) === '@' ? 'atRule' : 'selector'));
            }
                        ...
                        if ('atrule' in directives_1) {
                            ...
                            styleSheet.add(result.styleSheet.clone().children.map(function (i) {
                                ...
                                if (!(i instanceof Keyframes)) {
                                    ...
                                    i.important = (_a = directives_1.important) !== null && _a !== void 0 ? _a : false;
                                }
                                return i;
                            }));
                        }
