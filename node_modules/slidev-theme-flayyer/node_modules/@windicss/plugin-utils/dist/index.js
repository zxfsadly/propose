...
async function resolveOptions(options = {}, utilsOptions = {}, loadConfigFile = false) {
  ...
  scanOptions.exclude = mergeArrays((_b = config.extract) == null ? void 0 : _b.exclude, scanOptions.exclude, ((_c = config.extract) == null ? void 0 : _c.exclude) ? [] : ["node_modules", ".git"]).map(resolveGlob);
