  ...
  return [
    {
      ...
      async load(id) {
        if (id === DEVTOOLS_PATH) {
          if (!clientCode) {
            clientCode = [
              await import_fs.default.promises.readFile(import_path.default.resolve(__dirname, "client.mjs"), "utf-8"),
...
function VitePluginWindicss(userOptions = {}, utilsOptions = {}) {
  ...
  plugins.push(__spreadValues({
    ...
    async configResolved(_config) {
      utils = (0, import_plugin_utils.createUtils)(userOptions, __spreadValues({
        name: NAME,
        root: _config.root,
